...
#define CA_SVC_SREG_ACTLR_SET		(SIP_SVC_CALL|CA_SVC_MISC|4)
#define CA_SVC_SREG_ACTLR_READ		(SIP_SVC_CALL|CA_SVC_MISC|5)
#define CA_SVC_GET_ROM_VERSION 		(SIP_SVC_CALL|CA_SVC_MISC|6)
/* 7 reserved for someone */
#define RTK_SVC_DDR_TREF_TUNING		(SIP_SVC_CALL|CA_SVC_MISC|8)
...
#define CA_SMC_CALL_ROM_VERSION()	ca_smc_call(CA_SVC_GET_ROM_VERSION, 0x12345678, 0, 0, 0)	/* Pass any address except 0 */
