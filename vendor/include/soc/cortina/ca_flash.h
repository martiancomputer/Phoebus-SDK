...
/* Serial flash register
#define FLASH_ID					0
#define FLASH_TIMEOUT				(4 + FLASH_ID )
#define FLASH_STATUS                (4 + FLASH_TIMEOUT )
#define FLASH_TYPE                  (4 + FLASH_STATUS )
#define FLASH_FLASH_ACCESS_START    (4 + FLASH_TYPE )
#define FLASH_FLASH_INTERRUPT       (4 + FLASH_FLASH_ACCESS_START )
#define FLASH_FLASH_MASK            (4 + FLASH_FLASH_INTERRUPT )
#define FLASH_FIFO_CONTROL          (4 + FLASH_FLASH_MASK )
#define FLASH_FIFO_STATUS           (4 + FLASH_FIFO_CONTROL )
#define FLASH_FIFO_ADDRESS          (4 + FLASH_FIFO_STATUS )
#define FLASH_FIFO_MATCH_ADDRESS    (4 + FLASH_FIFO_ADDRESS )
#define FLASH_FIFO_DATA             (4 + FLASH_FIFO_MATCH_ADDRESS )
#define FLASH_SF_ACCESS             (4 + FLASH_FIFO_DATA )
#define FLASH_SF_EXT_ACCESS         (4 + FLASH_SF_ACCESS )
#define FLASH_SF_ADDRESS            (4 + FLASH_SF_EXT_ACCESS )
#define FLASH_SF_DATA               (4 + FLASH_SF_ADDRESS )
#define FLASH_SF_TIMING             (4 + FLASH_SF_DATA )
*/
...
#define SF_BUSY_BIT_STATUS		         	(1<<16)
#define SF_START_BIT_ENABLE		         	(1<<1)
...
#define read_dma_glb_ctrl_reg(reg)			readl(dma_ctl_glb_base + (reg - DMA_SEC_DMA_GLB_DMA_LSO_CTRL))
#define write_dma_glb_ctrl_reg(reg, data)	writel(data, dma_ctl_glb_base + (reg - DMA_SEC_DMA_GLB_DMA_LSO_CTRL))

/* Macro to access DMA controller register */
#define read_dma_ctrl_reg(reg)			readl(dma_ctl_base + (reg - DMA_SEC_DMA_SSP_Q_RXQ_CONTROL))
#define write_dma_ctrl_reg(reg, data)	writel(data, dma_ctl_base + (reg - DMA_SEC_DMA_SSP_Q_RXQ_CONTROL))
