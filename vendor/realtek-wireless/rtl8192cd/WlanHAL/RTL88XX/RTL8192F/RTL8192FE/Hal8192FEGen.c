...
//    pHalFunc->ReleaseShortCutTxDescHandler  = ReleaseShortCutTxDesc88XX;
	...
	pHalFunc->C2HPacketHandler              = C2HPacketHandler_92F;
...
// V1
#if 0
static __always_inline void TXBF_timer_callback(unsigned long task_priv)
{
...
//				BeamformingInit(priv, pstat->cmn_info.mac_addr, pstat->cmn_info.aid);
	...
	rtk_mod_timer(&priv->txbf_timer, jiffies + priv->pshare->rf_ft_var.soundingPeriod);

}
DEFINE_TIMER_CALLBACK(TXBF_timer_callback);
#endif  // 0
