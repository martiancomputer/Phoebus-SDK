...
#define RX_Q_RXBD_NUM_8814B             (Adapter->pshare->wlandev_idx == (0^WLANIDX)?NUM_RX_DESC:NUM_RX_DESC_2G)
...
#define DATAQ_IDX_MIN   HCI_TX_DMA_QUEUE_BK_V2
#define DATAQ_IDX_MAX   HCI_TX_DMA_QUEUE_ACH13

#define TOTAL_NUM_TXBD_NO_BCN_PEOFLD_8814B  (TX_MGQ_TXBD_NUM_8814B + TX_HIQ_TXBD_NUM_8814B + TX_CMDQ_TXBD_NUM_8814B + TX_FWCMDQ_TXBD_NUM_8814B)
#define DESC_DMA_SIZE_NO_BCNQ_PEOFLD_8814B \
     (TOTAL_NUM_TXBD_NO_BCN_PEOFLD_8814B * (sizeof(TX_BUFFER_DESCRIPTOR) + SIZE_TXDESC_88XX_8814B))
     
#define DESC_DMA_SIZE_TX_MAX_PEOFLD_8814B    (DESC_DMA_SIZE_NO_BCNQ_PEOFLD_8814B + \
                                          (1+HAL_NUM_VWLAN) * TXBD_BEACON_OFFSET_MAX + \
                                          (1+HAL_NUM_VWLAN) * SIZE_TXDESC_88XX_8814B)

#define DESC_DMA_RXSIZE_PAGE_PEOFLD_8814B  0
#define DESC_DMA_TXSIZE_PAGE_PEOFLD_8814B  (DESC_DMA_SIZE_TX_MAX_PEOFLD_8814B + PAGE_SIZE)
...
#ifdef CONFIG_PE_ENABLE
#define DATAQ_IDX_DCOFLD_MIN   HCI_TX_DMA_QUEUE_MGT //0
#define DATAQ_IDX_DCOFLD_MAX   HCI_TX_DMA_QUEUE_HI0 //5

#define TOTAL_NUM_TXBD_NO_BCN_DCOFLD_PEOFLD_8814B (TX_MGQ_TXBD_NUM_8814B + TX_BCNQ_TXBD_NUM_OFLD_8814B + TX_CMDQ_TXBD_NUM_8814B + TX_HIQ_TXBD_NUM_8814B )
#define H2D_DESC_8814B_DCOFLD_PEOFLD_DMA_SIZE \
    (TOTAL_NUM_TXBD_NO_BCN_DCOFLD_PEOFLD_8814B * (sizeof(H2D_TX_BD) + (sizeof(H2D_TXDMA_INFO))) )

#define H2D_DESC_8814B_DCOFLD_PEOFLD_DMA_SIZE_MAX (H2D_DESC_8814B_DCOFLD_PEOFLD_DMA_SIZE /*+ HAL_PAGE_SIZE*/)
