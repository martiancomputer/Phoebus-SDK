...
#define HAL_CODE_BASE   (CODEBASE1|CODEBASE2|CODEBASE3|CODEBASE4|CODEBASE5|CODEBASE6|CODEBASE7|CODEBASE8|CODEBASE9|CODEBASE10|CODEBASE11)
...
#if IS_EXIST_RTL8192EE || IS_EXIST_RTL8192EU || IS_EXIST_RTL8814AE ||IS_EXIST_RTL8197FEM ||IS_EXIST_RTL8822BE || IS_EXIST_RTL8821CE || IS_EXIST_RTL8198FEM || IS_EXIST_RTL8814BE|| IS_EXIST_RTL8192FE || IS_EXIST_RTL8822CE  || IS_EXIST_RTL8812FE
#define TXBD_BEACON_OFFSET_V1       128 
#endif  //#if IS_EXIST_RTL8192EE || IS_EXIST_RTL8814AE ||IS_EXIST_RTL8197FEM ||IS_EXIST_RTL8197FEM || IS_EXIST_RTL8198FEM|| IS_EXIST_RTL8192FE
...
#if (IS_RTL8814A_SERIES || IS_RTL8822B_SERIES || IS_RTL8821C_SERIES || IS_RTL8198F_SERIES || IS_RTL8814B_SERIES || IS_RTL8822C_SERIES || IS_RTL8812F_SERIES)
...
//4 TRX Pktbuf
#if (IS_RTL8192E_SERIES || IS_RTL8881A_SERIES || IS_RTL8197F_SERIES || IS_RTL8198F_SERIES || IS_RTL8192F_SERIES)
...
#if  (IS_RTL8192F_SERIES || IS_RTL8198F_SERIES)
...
#define RETRY_LIMIT_SHORT_AP_2G       0x18
#define RETRY_LIMIT_LONG_AP         0x30
#define RETRY_LIMIT_LONG_AP_2G         0x18
#else
...
#if (IS_EXIST_RTL8192EE || IS_EXIST_RTL8814AE || IS_EXIST_RTL8197FEM || IS_EXIST_RTL8822BE || IS_EXIST_RTL8822CE || IS_EXIST_RTL8821CE || IS_EXIST_RTL8198FEM || IS_EXIST_RTL8814BE || IS_RTL8192F_SERIES || IS_EXIST_RTL8812FE)
#define TX_BCNQ_TXBD_NUM_V1 	(1+HAL_NUM_VWLAN)*(TXBD_BEACON_OFFSET_V1/sizeof(TX_BUFFER_DESCRIPTOR))  // Root + VAP Num
#endif //(IS_EXIST_RTL8192EE || IS_EXIST_RTL8814AE || IS_EXIST_RTL8197FEM ||IS_EXIST_RTL8822BE || IS_EXIST_RTL8821CE || IS_EXIST_RTL8198FEM || IS_RTL8192F_SERIES)
...
//direction
#define HAL_PCI_DMA_TODEVICE    DMA_TO_DEVICE
#define HAL_PCI_DMA_FROMDEVICE    DMA_FROM_DEVICE
...
#if (IS_RTL8814A_SERIES || IS_RTL8822B_SERIES || IS_RTL8821C_SERIES || IS_RTL8198F_SERIES || IS_RTL8822C_SERIES || IS_RTL8812F_SERIES || IS_RTL8814B_SERIES)
