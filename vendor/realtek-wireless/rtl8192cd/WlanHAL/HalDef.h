...
#if (IS_RTL8814A_SERIES || IS_RTL8192F_SERIES || IS_RTL8197F_SERIES || IS_RTL8822B_SERIES || IS_RTL8198F_SERIES || IS_RTL8822C_SERIES  || IS_RTL8812F_SERIES)
...
#define IS_HARDWARE_TYPE_MAC_V3(_Adapter)	    (IS_HARDWARE_TYPE_8198F(_Adapter))
