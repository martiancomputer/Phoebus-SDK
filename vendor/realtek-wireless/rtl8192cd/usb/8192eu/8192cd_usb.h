...
void _InitQueuePriority_8192EU(struct rtl8192cd_priv *priv);
void _init_UsbBusSetting_8192EU(struct rtl8192cd_priv *priv);
void _init_UsbAggregationSetting_8192EU(struct rtl8192cd_priv *priv);
