...
static __always_inline void pre_rtw_beacon_timer(unsigned long task_priv)
{
...
DEFINE_TIMER_CALLBACK(pre_rtw_beacon_timer);
...
#if 1//defined(CONFIG_RTL_92C_SUPPORT) || (!defined(CONFIG_SUPPORT_USB_INT) || !defined(CONFIG_INTERRUPT_BASED_TXBCN))
	rtk_timer_setup(&(priv->pshare->beacon_timer), pre_rtw_beacon_timer, (unsigned long)priv, 0);
