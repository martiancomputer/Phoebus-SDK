...
#define MAX_CONTINUAL_URB_ERR 10
...
#endif /* defined(CONFIG_USB_RX_AGGREGATION) */
...
void _init_UsbBusSetting(struct rtl8192cd_priv *priv);
void _init_UsbAggregationSetting(struct rtl8192cd_priv *priv);
