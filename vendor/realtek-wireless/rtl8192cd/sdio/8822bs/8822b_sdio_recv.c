...
int rtl8192es_init_recv_priv(struct rtl8192cd_priv *priv)
{
	...
	*precvpriv->recvbuf_mem_end = RECVBUF_POISON_END;
	...
	tasklet_init(&precvpriv->recv_tasklet,
	     (void(*)(unsigned long))rtl8822bs_recv_tasklet,
	     (unsigned long)priv);
...
#ifndef __LINUX_2_6_18__ // http://www.mail-archive.com/netdev@vger.kernel.org/msg17214.html
...
void rtl8822bs_recv_tasklet(void *p)
{
