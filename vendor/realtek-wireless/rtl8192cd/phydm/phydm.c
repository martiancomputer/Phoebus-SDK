...
#if (DM_ODM_SUPPORT_TYPE & (ODM_AP)) && defined(CONFIG_SHARE_XTAL)
	if(dm->priv->pmib->dot11RFEntry.phyBandSelect == PHY_BAND_2G)
		support_ability &= ~ODM_BB_CFO_TRACKING;
#endif
