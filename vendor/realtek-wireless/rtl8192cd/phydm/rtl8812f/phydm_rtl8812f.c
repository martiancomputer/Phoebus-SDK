...
void phydm_tx_collsion_th_init_8812f(void *dm_void)
{
...
void phydm_tx_collsion_th_set_8812f(void *dm_void, u8 val_r2t, u8 val_t2r)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	u32 reg_8f8 = 0;
	u32 reg_8fc = 0;
...
void phydm_tx_collsion_detect_8812f(void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	if (ra_tab->ra_tx_cls_th == 255)
		phydm_tx_collsion_th_set_8812f(dm, th_r2t, th_t2r);
}

void phydm_hwsetting_8812f(void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
#ifdef CONFIG_DYNAMIC_TXCOLLISION_TH
	phydm_tx_collsion_detect_8812f(dm);
#endif
