...
enum rt_spinlock_type {
	...
	#ifdef USE_RTK_TIMER_LIST
		#define phydm_timer_list	rtk_timer_list
	#else
	...
	// For old driver
	#ifndef GET_TIMER_CALLBACK
	#define GET_TIMER_CALLBACK(_timerCb)	(_timerCb)
	#endif

	#ifndef DECLARE_TIMER_CALLBACK
	#define DECLARE_TIMER_CALLBACK(_timerCb)
	#endif

	#ifndef DEFINE_TIMER_CALLBACK
