...
#if (DM_ODM_SUPPORT_TYPE == ODM_AP) && defined(PHYDM_TDMA_DIG_SUPPORT) && defined(IS_USE_NEW_TDMA)
DECLARE_TIMER_CALLBACK(phydm_tdma_dig_cbk);
#endif
...
#if (DM_ODM_SUPPORT_TYPE == ODM_AP)
DEFINE_TIMER_CALLBACK(pre_phydm_tdma_dig_cbk);
#endif
...
void phydm_tdma_dig_timers_usb(void *dm_void, u8 state)
{
	...
	if (state == INIT_TDMA_DIG_TIMMER) {
		...
		odm_initialize_timer(dm, &dm->tdma_dig_timer,
				     (void *)GET_TIMER_CALLBACK(pre_phydm_tdma_dig_cbk),
				     NULL, "phydm_tdma_dig_timer_usb");
#else
		odm_initialize_timer(dm, &dm->tdma_dig_timer,
				     (void *)pre_phydm_tdma_dig_cbk,
				     NULL, "phydm_tdma_dig_timer_usb");
#endif
...
#if (DM_ODM_SUPPORT_TYPE == ODM_AP)
		odm_initialize_timer(dm, &dm->tdma_dig_timer,
				     (void *)GET_TIMER_CALLBACK(phydm_tdma_dig_cbk),
...
#if (DM_ODM_SUPPORT_TYPE == ODM_AP)
DEFINE_TIMER_CALLBACK(phydm_tdma_dig_cbk);
#endif
#endif
/*@============================================================*/
/*@FASLE ALARM CHECK*/
