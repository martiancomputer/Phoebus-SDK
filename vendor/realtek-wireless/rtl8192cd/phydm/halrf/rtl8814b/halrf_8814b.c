...
void _halrf_parse_tssi_diff_from_efuse(
	void *dm_void,
	u16 address,
	u8 path,
	u16 tssi_diff_idx,
...
s8 _halrf_parse_tssi_diff_from_flash(
	void *dm_void,
	u8 diff_value,
	u8 high_low)
{
...
s32 _halrf_get_efuse_tssi_de_diff_offset_8814b(
	void *dm_void, u8 path)
{
...
void _halrf_driver_flash_to_tssi_de_diff_8814b(
	void *dm_void)
{
#if (DM_ODM_SUPPORT_TYPE & ODM_AP)
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	/*AP 2G 20M CH7*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][0] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_20BW1S_OFDM1T_A[6], high);
	tssi->tssi_de_diff_efuse[RF_PATH_B][0] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_20BW1S_OFDM1T_B[6], high);
	tssi->tssi_de_diff_efuse[RF_PATH_C][0] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_20BW1S_OFDM1T_C[6], high);
	tssi->tssi_de_diff_efuse[RF_PATH_D][0] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_20BW1S_OFDM1T_D[6], high);
	...
	/*AP 5G 20M CH36*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][1] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_A[35], high);
	tssi->tssi_de_diff_efuse[RF_PATH_B][1] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_B[35], high);
	tssi->tssi_de_diff_efuse[RF_PATH_C][1] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_C[35], high);
	tssi->tssi_de_diff_efuse[RF_PATH_D][1] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_D[35], high);
	...
	/*AP 5G 80M CH36*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][2] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_A[35], high);
	tssi->tssi_de_diff_efuse[RF_PATH_B][2] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_B[35], high);
	tssi->tssi_de_diff_efuse[RF_PATH_C][2] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_C[35], high);
	tssi->tssi_de_diff_efuse[RF_PATH_D][2] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_D[35], high);

	/*AP 5G 160M CH36*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][3] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_A[35], low);
	tssi->tssi_de_diff_efuse[RF_PATH_B][3] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_B[35], low);
	tssi->tssi_de_diff_efuse[RF_PATH_C][3] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_C[35], low);
	tssi->tssi_de_diff_efuse[RF_PATH_D][3] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_D[35], low);
	...
	/*AP 5G 20M CH100*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][4] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_A[99], high);
	tssi->tssi_de_diff_efuse[RF_PATH_B][4] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_B[99], high);
	tssi->tssi_de_diff_efuse[RF_PATH_C][4] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_C[99], high);
	tssi->tssi_de_diff_efuse[RF_PATH_D][4] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_D[99], high);
	...
	/*AP 5G 80M CH100*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][5] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_A[99], high);
	tssi->tssi_de_diff_efuse[RF_PATH_B][5] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_B[99], high);
	tssi->tssi_de_diff_efuse[RF_PATH_C][5] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_C[99], high);
	tssi->tssi_de_diff_efuse[RF_PATH_D][5] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_D[99], high);

	/*AP 5G 160M CH100*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][6] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_A[99], low);
	tssi->tssi_de_diff_efuse[RF_PATH_B][6] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_B[99], low);
	tssi->tssi_de_diff_efuse[RF_PATH_C][6] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_C[99], low);
	tssi->tssi_de_diff_efuse[RF_PATH_D][6] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_D[99], low);
	...
	/*AP 5G 20M CH149*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][7] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_A[148], high);
	tssi->tssi_de_diff_efuse[RF_PATH_B][7] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_B[148], high);
	tssi->tssi_de_diff_efuse[RF_PATH_C][7] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_C[148], high);
	tssi->tssi_de_diff_efuse[RF_PATH_D][7] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_20BW1S_OFDM1T_D[148], high);
	...
	/*AP 5G 80M CH149*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][8] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_A[148], high);
	tssi->tssi_de_diff_efuse[RF_PATH_B][8] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_B[148], high);
	tssi->tssi_de_diff_efuse[RF_PATH_C][8] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_C[148], high);
	tssi->tssi_de_diff_efuse[RF_PATH_D][8] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_D[148], high);

	/*AP 5G 160M CH149*/
	tssi->tssi_de_diff_efuse[RF_PATH_A][9] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_A[148], low);
	tssi->tssi_de_diff_efuse[RF_PATH_B][9] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_B[148], low);
	tssi->tssi_de_diff_efuse[RF_PATH_C][9] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_C[148], low);
	tssi->tssi_de_diff_efuse[RF_PATH_D][9] = _halrf_parse_tssi_diff_from_flash(dm, priv->pmib->dot11RFEntry.pwrdiff_5G_80BW1S_160BW1S_D[148], low);
...
void _halrf_tssi_set_de_by_thermal_8814b(void *dm_void, u8 rf_path)
{
	...
	tssi_de_tmp = tssi->tssi_efuse[rf_path][offset_index] +
			...
			_halrf_get_efuse_tssi_de_diff_offset_8814b(dm, rf_path) +
			cali_info->absolute_ofdm_swing_idx[rf_path];
	...
	odm_set_bb_reg(dm, addr_cck_d[rf_path], addr_cck_d_bitmask[rf_path],
		(tssi_de_tmp & 0xff));
	RF_DBG(dm, DBG_RF_TX_PWR_TRACK,
		"CCK 0x%x[%x] tssi_de_tmp(%d) = tssi->tssi_efuse[%d][%d](%d) + phydm_get_tssi_trim_de(dm, %d)(%d) + _halrf_get_efuse_tssi_de_diff_offset_8814b(dm, %d)(%d) + cali_info->absolute_ofdm_swing_idx[%d](%d)\n",
		...
		rf_path, _halrf_get_efuse_tssi_de_diff_offset_8814b(dm, rf_path),
		rf_path, cali_info->absolute_ofdm_swing_idx[rf_path]);
	...
	RF_DBG(dm, DBG_RF_TX_PWR_TRACK,
		"OFDM 0x%x[%x] tssi_de_tmp(%d) = tssi_offest_de(%d) + phydm_get_tssi_trim_de(dm, %d)(%d) + _halrf_get_efuse_tssi_de_diff_offset_8814b(dm, %d)(%d) + cali_info->absolute_ofdm_swing_idx[%d](%d)\n",
	...
	void *dm_void)
{
	...
	_halrf_driver_flash_to_tssi_de_diff_8814b(dm);
	...
	_halrf_parse_tssi_diff_from_efuse(dm, 0x1c, RF_PATH_A, 0, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x31, RF_PATH_A, 1, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x32, RF_PATH_A, 2, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x33, RF_PATH_A, 4, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x34, RF_PATH_A, 5, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x35, RF_PATH_A, 7, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x36, RF_PATH_A, 8, 2);
	...
	_halrf_parse_tssi_diff_from_efuse(dm, 0x46, RF_PATH_B, 0, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x5b, RF_PATH_B, 1, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x5c, RF_PATH_B, 2, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x5d, RF_PATH_B, 4, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x5e, RF_PATH_B, 5, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x5f, RF_PATH_B, 7, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x60, RF_PATH_B, 8, 2);
	...
	_halrf_parse_tssi_diff_from_efuse(dm, 0x70, RF_PATH_C, 0, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x85, RF_PATH_C, 1, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x86, RF_PATH_C, 2, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x87, RF_PATH_C, 4, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x88, RF_PATH_C, 5, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x89, RF_PATH_C, 7, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0x8a, RF_PATH_C, 8, 2);
	...
	_halrf_parse_tssi_diff_from_efuse(dm, 0x9a, RF_PATH_D, 0, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0xaf, RF_PATH_D, 1, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0xb0, RF_PATH_D, 2, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0xb1, RF_PATH_D, 4, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0xb2, RF_PATH_D, 5, 2);
	_halrf_parse_tssi_diff_from_efuse(dm, 0xb3, RF_PATH_D, 7, 1);
	_halrf_parse_tssi_diff_from_efuse(dm, 0xb4, RF_PATH_D, 8, 2);
#endif
	...
	void *dm_void)
{
	...
	for (i = 0; i < MAX_PATH_NUM_8814B; i++) {
		tmp = tssi->tssi_efuse[i][offset_index] + phydm_get_tssi_trim_de(dm, i)
			+ _halrf_get_efuse_tssi_de_diff_offset_8814b(dm, i);
		...
		RF_DBG(dm, DBG_RF_TX_PWR_TRACK,
			...
			_halrf_get_efuse_tssi_de_diff_offset_8814b(dm, i), i);

		tssi_offest_de = (s8)_halrf_get_efuse_tssi_offset_8814b(dm, i);
...
void halrf_dack_check_reset(struct dm_struct *dm, u8 path)
{
	u32 p, pr;
