...
const u32 array_mp_8710b_agc_tab[] = {
		0xC78, 0xFC000001,
		0xC78, 0xFB010001,
		0xC78, 0xFA020001,
		0xC78, 0xF9030001,
...
odm_read_and_config_mp_8710b_agc_tab(struct dm_struct *dm)
{
	...
	u32	array_len =
			sizeof(array_mp_8710b_agc_tab) / sizeof(u32);
	u32	*array = (u32 *)array_mp_8710b_agc_tab;
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT(30))) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_bb_agc_8710b(dm, v1, MASKDWORD, v2);
		}
		i = i + 2;
	}
}
...
u32
odm_get_version_mp_8710b_agc_tab(void)
{
		return 20;
}
...
const u32 array_mp_8710b_phy_reg[] = {
		0x800, 0x80045700,
		0x804, 0x00000001,
		0x808, 0x00FC8000,
		0x80C, 0x0000000A,
...
odm_read_and_config_mp_8710b_phy_reg(struct dm_struct *dm)
{
	...
	boolean	is_matched = true, is_skipped = false;
	u32	array_len =
			sizeof(array_mp_8710b_phy_reg) / sizeof(u32);
	u32	*array = (u32 *)array_mp_8710b_phy_reg;
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT(30))) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_bb_phy_8710b(dm, v1, MASKDWORD, v2);
		}
		i = i + 2;
	}
}
...
u32
odm_get_version_mp_8710b_phy_reg(void)
{
		return 20;
}
...
#ifdef CONFIG_8710B
const u32 array_mp_8710b_phy_reg_pg[] = {
...
odm_read_and_config_mp_8710b_phy_reg_pg(struct dm_struct *dm)
{
	...
	u32	i = 0;
	u32	array_len =
			sizeof(array_mp_8710b_phy_reg_pg) / sizeof(u32);
	u32	*array = (u32 *)array_mp_8710b_phy_reg_pg;
	...
	for (i = 0; i < array_len; i += 6) {
		...
		odm_config_bb_phy_reg_pg_8710b(dm, v1, v2, v3, v4, v5, v6);
