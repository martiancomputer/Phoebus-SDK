...
const u32 array_mp_8710c_mac_reg[] = {
		0x421, 0x0000000F,
		0x422, 0x00000078,
		0x428, 0x0000000A,
		0x429, 0x00000010,
...
odm_read_and_config_mp_8710c_mac_reg(struct dm_struct *dm)
{
	...
	u32	array_len =
			sizeof(array_mp_8710c_mac_reg) / sizeof(u32);
	u32	*array = (u32 *)array_mp_8710c_mac_reg;
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT(30))) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_mac_8710c(dm, v1, (u8)v2);
		}
		i = i + 2;
	}
}
...
u32
odm_get_version_mp_8710c_mac_reg(void)
{
		return 9;
}
