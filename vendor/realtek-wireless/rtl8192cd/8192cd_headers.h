...
#define ACSDEBUG(fmt, args...) panic_printk("[ACS] "fmt"\n", ## args)
#else
...
#define SPRINTT_CONT(buf, fmt, args...) SPRINTT(buf, fmt, ##args)
#if defined(_DEBUG_RTL8192CD_) || defined(DEBUG_PSK)
#define printk diag_printf
#endif
#else
#define SPRINTT(buf, fmt, args...) panic_printk(fmt, ##args)
#define SPRINTT_CONT(buf, fmt, args...) panic_printk_cont(fmt, ##args)
#endif

#define IGNORE_DRIVER_STATUS  0
#define CHECK_DRIVER_STATUS   1
...
EXTERN unsigned char check_pkt_type(struct sk_buff *pskb);
EXTERN void syncMulticastCipher(struct rtl8192cd_priv *priv, struct bss_desc *bss_target);
#ifdef GBWC
EXTERN void init_GBWC_timer(struct rtl8192cd_priv *priv);
#endif
#ifdef SBWC
EXTERN void init_SBWC_timer(struct rtl8192cd_priv *priv);
#endif
#ifdef RTK_STA_BWC
EXTERN void init_sta_bwc_timer(struct rtl8192cd_priv *priv);
#endif
...
EXTERN void init_add_ps_timer(struct rtl8192cd_priv *priv);
...
EXTERN void rtk_txdata_queue_flush(struct rtl8192cd_priv *priv);
...
void pkt_dump(struct rtl8192cd_priv *priv, struct sk_buff *pskb, unsigned char *function);
#endif
...
EXTERN void init_RF_MIMO_check_timer(struct rtl8192cd_priv *priv);
...
EXTERN void init_cu_cntdwn_timer(struct rtl8192cd_priv *priv);
...
EXTERN void init_PktAging_timer(struct rtl8192cd_priv *priv);
#endif
#ifdef TX_SHORTCUT
...
EXTERN unsigned short get_80211frameVlanID(struct rtl8192cd_priv *priv, struct stat_info *pstat, struct rx_frinfo *pfrinfo);
...
EXTERN void init_ada_stats_timer(struct rtl8192cd_priv *priv);
#endif
...
#endif
#endif
EXTERN int check_si_mem(struct rtl8192cd_priv *priv);
...
EXTERN void hapd_rm_tx_nb_rpt_resp(struct rtl8192cd_priv *priv, struct stat_info *pstat, unsigned char *buf, int *len);
#endif
#endif
...
#ifdef SW_TX_QUEUE
#ifdef __OSK__
EXTERN void rtl8192cd_swq_timeout(unsigned long task_priv);  // For direct function call
#else
EXTERN void init_swq_sw_timer(struct rtl8192cd_priv *priv);
EXTERN void rtl8192cd_swq_timeout_tasklet_cb(unsigned long task_priv);  // Callback function for tasklet (priv->pshare->swq_tasklet)
#endif
#ifdef SW_TXQ_ATF
EXTERN void swq_atf_schedule(struct rtl8192cd_priv *priv);
EXTERN void swq_atf_calc_hwq_pktsz(struct tx_desc_info *pdescinfo, bool is_add);
#endif
EXTERN void rtl8192cd_swq_deltimer(struct rtl8192cd_priv *priv, struct stat_info* pstat, int qnum);
#endif

#ifdef RTK_ATM
EXTERN void rtl8192cd_atm_swq_timeout(unsigned long task_priv);  // For direct function call
EXTERN void init_atm_swq_sw_timer(struct rtl8192cd_priv *priv);
...
EXTERN void dc_query_seq(struct rtl8192cd_priv *priv, struct stat_info *pstat, unsigned char tid);
...
__MIPS16
#endif 
__IRAM_IN_865X unsigned int pri_to_qnum(struct rtl8192cd_priv *priv, int priority);
...
#ifdef TCP_ACK_ACC
EXTERN void init_tcpack_timer(struct rtl8192cd_priv *priv);
...
EXTERN int rtl8192cd_tx_gbwc(struct rtl8192cd_priv *priv, struct stat_info *pstat, struct sk_buff *skb, struct tx_insn *txcfg);
...
EXTERN void init_frag_to_filter_timer(struct rtl8192cd_priv *priv);
EXTERN void init_expire_timer(struct rtl8192cd_priv *priv);
#if defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI)
...
EXTERN unsigned int rtk_crc32(unsigned char *buf, int len);
#endif
...
EXTERN void init_ss_timer(struct rtl8192cd_priv *priv);
#ifdef AP_SWPS_OFFLOAD
...
EXTERN void issue_auth_req(struct rtl8192cd_priv *priv, struct stat_info *pstat, unsigned short status);
...
EXTERN void init_reauth_timer(struct rtl8192cd_priv *priv);
EXTERN void init_reassoc_timer(struct rtl8192cd_priv *priv);
EXTERN void init_idle_timer(struct rtl8192cd_priv *priv);
#ifdef DFS
EXTERN void init_dfs_cntdwn_timer(struct rtl8192cd_priv *priv);
#endif
...
EXTERN void issue_RTS(struct rtl8192cd_priv *priv, unsigned char *da);
#endif
#ifdef WIFI_WMM
...
EXTERN void reset_hangup_work(struct work_struct *work);
#endif
#ifdef CONFIG_USB_HCI
...
EXTERN void init_chan_switch_timer(struct rtl8192cd_priv *priv);
#endif
...
#endif // (UNIVERSAL_REPEATER || MBSSID) && (CLIENT_MODE)
...
EXTERN void issue_beacon_ibss_vxd(struct rtl8192cd_priv *priv);
EXTERN void init_vxd_ibss_beacon_timer(struct rtl8192cd_priv *priv);
...
#if (MU_BEAMFORMING_SUPPORT == 1)
EXTERN void requestTxRetry88XX_MU(struct rtl8192cd_priv *priv);
#endif
#endif
...
EXTERN void init_mclone_reauth_timer(struct rtl8192cd_priv *priv, int index);
EXTERN void init_mclone_reassoc_timer(struct rtl8192cd_priv *priv, int index);
...
EXTERN void check_unassoc_sta_match(struct rtl8192cd_priv *priv, struct rx_frinfo *pfrinfo);
EXTERN unsigned char isDualBandClient(struct rtl8192cd_priv *priv, unsigned char* addr);
#endif
#ifdef RTK_NL80211
EXTERN void read_noise_report(struct rtl8192cd_priv *priv, int idx);
#endif
#ifdef ENABLE_SAE_H2E
int construct_rsnxe_ie(u8 *tmp);
#endif
#ifdef CONFIG_CMCC_FEATURE_SUPPORT
EXTERN void update_sta_cap_table_due_to_disconnect(struct rtl8192cd_priv *priv, struct stat_info *pstat);
#endif
#undef EXTERN
...
#ifdef DFS
EXTERN void init_DFS_timer(struct rtl8192cd_priv *priv, int checkDriverStatus);
EXTERN void init_DFS_TXPAUSE_timer(struct rtl8192cd_priv *priv, int checkDriverStatus);
EXTERN void init_ch_avail_chk_timer(struct rtl8192cd_priv *priv, int checkDriverStatus);
EXTERN void init_dfs_det_chk_timer(struct rtl8192cd_priv *priv, int checkDriverStatus);
EXTERN void init_timer_for_each_DFS_channel(struct rtl8192cd_priv *priv);
EXTERN void reset_nop_channel(struct rtl8192cd_priv *priv);
#if defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8814CR)
EXTERN void phydm_dfs_segment_distinguish_for_8814b_14c(struct rtl8192cd_priv *priv, enum rf_syn syn_path);
#endif
...
EXTERN void process_netif_rxq(unsigned long task_priv);
#elif (SMP_RX_LB_LEVEL == 2)
EXTERN void __rtl_netif_rx(struct rtl8192cd_priv *priv, struct sk_buff *pskb, struct stat_info *pstat);
#endif
...
#endif
EXTERN unsigned char get_sta_nss(struct rtl8192cd_priv *priv, struct stat_info *pstat);
...
EXTERN u32 getUsedTXBD(struct rtl8192cd_priv * priv, unsigned int qNum);
...
EXTERN void init_PCIe_power_save_timer(struct rtl8192cd_priv *priv);
...
EXTERN void init_tpt_timer(struct rtl8192cd_priv *priv);
...
EXTERN UINT8 ss_trigger_clm_nhm(struct rtl8192cd_priv *priv, UINT8 action, UINT8 step);
EXTERN int calc_ch_ss_load(struct rtl8192cd_priv *priv, P_RT_CH_LOAD_SS_INFO ch_info, UINT32 idx);
#endif
...
#ifdef DPK_92D
EXTERN void init_DPKTimer(struct rtl8192cd_priv *priv);
...
EXTERN void init_MIC_check_timer(struct rtl8192cd_priv *priv);
EXTERN void init_assoc_reject_timer(struct rtl8192cd_priv *priv);
...
EXTERN void rtk_sha256_prf(const unsigned char *key, size_t key_len, const char *label,
...
EXTERN void init_sta_SA_query_timer(struct stat_info *pstat);
#endif
#undef EXTERN
...
#ifdef CTC_WIFI_DIAG
EXTERN void ctcwifi_proc_init(void);
EXTERN void ctcwifi_proc_remove(void);
EXTERN void ctcwifi_priv_set(struct rtl8192cd_priv *priv);
EXTERN void ctcwifi_conn_record(struct rtl8192cd_priv *priv, unsigned char *mac, const unsigned char *msg, unsigned int msg_type);
EXTERN void __ctcwifi_diag_log(struct rtl8192cd_priv *priv, unsigned char *mac, unsigned int direction, unsigned char *frame_type, unsigned char *frame_body, unsigned int frame_len);
DECLARE_TIMER_CALLBACK(ctcwifi_diag_tx_bcn_timer_func);
#endif
...
#endif
#ifdef ENABLE_SAE_H2E
int sae_check_imd_4way(struct rtl8192cd_priv *priv, struct stat_info *pstat, 
	unsigned char *pbuf, unsigned int limit, unsigned int *status);
#endif
#undef EXTERN
...
#ifdef ENABLE_SAE_H2E
EXTERN int sae_h2e_test(struct rtl8192cd_priv * priv);
#endif
...
EXTERN int peer_support_h2e(struct rtl8192cd_priv *priv, unsigned int t_stamp);
EXTERN int client_send_commit_to_peer(	struct rtl8192cd_priv *priv,unsigned char *da, u8 with_h2e);
...
#ifdef MESH_BOOTSEQ_AUTH
EXTERN void init_mesh_auth_timer(struct rtl8192cd_priv *priv);
#endif
...
EXTERN void init_mesh_peer_link_timer(struct rtl8192cd_priv *priv);
...
EXTERN void mesh_CSA_expire(DRV_PRIV *priv);
#endif
#undef EXTERN
...
EXTERN void TriggerBandTrans(struct rtl8192cd_priv *priv, struct BandTransNode *blockNode, char btm_accepted_expire);
...
EXTERN bool stactrl_chk_dualband(struct rtl8192cd_priv *priv, unsigned char *mac);
#endif
...
#else  // !(STA_CONTROL_ALGO == STA_CONTROL_ALGO3)
...
#endif // (STA_CONTROL_ALGO == STA_CONTROL_ALGO3)
...
EXTERN void set_CCK_swing_index(struct rtl8192cd_priv * priv, int CCK_index);
...
#ifdef CONFIG_RTL_NEW_AUTOCH
EXTERN void phydm_auto_channel_select_setting_ap(struct rtl8192cd_priv *priv, u4Byte setting);
EXTERN void nhm_trigger(struct rtl8192cd_priv *priv);
EXTERN void reset_fa_reg(struct rtl8192cd_priv *priv);
EXTERN void phydm_get_nhm_statistics_ap(struct rtl8192cd_priv *priv, u4Byte idx);
EXTERN void query_fa_static(struct rtl8192cd_priv *priv, int idx);
#endif
#undef EXTERN
...
EXTERN void init_MP_DIGTimer(struct rtl8192cd_priv *priv);
#endif
// Tx Power
#ifdef HIGH_POWER_EXT_PA
...
#ifdef CONFIG_PCI_HCI
EXTERN void init_add_RATid_timer(struct rtl8192cd_priv *priv);
EXTERN void init_add_rssi_timer(struct rtl8192cd_priv *priv);
#endif
#endif
...
// Antenna diversity
#ifdef SW_ANT_SWITCH
EXTERN void init_swAntennaSwitchTimer(struct rtl8192cd_priv *priv);
...
EXTERN void init_dnc_timer(struct rtl8192cd_priv *priv);
#endif
...
EXTERN void rtk_p2p_init_remain_on_ch_timer(struct rtl8192cd_priv *priv);
EXTERN void rtk_p2p_init_scan_deny_timer(struct rtl8192cd_priv *priv);
...
EXTERN void init_P2P_search_timer(struct rtl8192cd_priv *priv);
EXTERN void p2p_start_timer(unsigned long task_priv);
EXTERN void init_p2p_find_timer(struct rtl8192cd_priv *priv);
...
#if defined(DOT11K)
EXTERN unsigned char search_country_txpower_by_regdomain(struct rtl8192cd_priv *priv, unsigned char channel);
#endif
...
EXTERN void rtk_multi_ap_init_backhaul_steer_timer(struct rtl8192cd_priv *priv);
...
EXTERN void rtk_multi_ap_init_unassoc_sta_timer(struct rtl8192cd_priv *priv);
...
#if defined(DOT11K)
EXTERN int rtk_multi_ap_get_opclass_list(struct rtl8192cd_priv *priv, unsigned char *buf);
#endif
...
EXTERN void rtk_multi_ap_init_cac_process_timer(struct rtl8192cd_priv *priv);
...
EXTERN void rm_init_delay_measure_timer(struct rtl8192cd_priv *priv);
...
EXTERN void sm_cca_expire(struct stat_info *pstat);
EXTERN void sm_rpi_expire(struct stat_info *pstat);
EXTERN int sm_cca_measurement_request(struct rtl8192cd_priv *priv, unsigned char *macaddr, struct dot11k_cca_measurement_req* cca_req);
EXTERN int sm_get_cca_report(struct rtl8192cd_priv *priv, unsigned char *macaddr, unsigned char *result_buf);
EXTERN int sm_rpi_measurement_request(struct rtl8192cd_priv *priv, unsigned char *macaddr, struct dot11k_rpi_measurement_req* rpi_req);
EXTERN int sm_get_rpi_report(struct rtl8192cd_priv *priv, unsigned char *macaddr, unsigned char *result_buf);
EXTERN void OnSpectrumMgmtMeasurementReport(struct rtl8192cd_priv *priv, struct stat_info *pstat, unsigned char *pframe);
#ifdef CLIENT_MODE
...
EXTERN void rm_init_sta_beacon_expire_timer(struct stat_info *pstat);
...
#endif
EXTERN unsigned char * construct_temp_neighbor_report_ie(struct rtl8192cd_priv *priv, unsigned char *pbuf, unsigned int *frlen, unsigned char * hwaddr, unsigned char channel);
...
/*-----------------------------------------------------------------------------
								8192cd_band_steering.c
------------------------------------------------------------------------------*/
#ifndef _8192CD_BAND_STEERING_C_
#define EXTERN  extern
#else
#define EXTERN
#endif
...
#endif /* end CONFIG_RTK_BAND_STEERING */


#ifdef CONFIG_RTK_WLAN_MANAGER
/*-----------------------------------------------------------------------------
								8192cd_wlan_manager.c
------------------------------------------------------------------------------*/
...
#endif
struct nl_message;
EXTERN void rtk_wlan_manager_recv_msg(struct nl_message *msg);
EXTERN void rtk_wlan_manager_nl_send_del_sta_msg(struct rtl8192cd_priv *priv, u8 *mac);
EXTERN void rtk_wlan_manager_nl_send_new_sta_msg(struct rtl8192cd_priv *priv, u8 *mac);
EXTERN void rtk_wlan_manager_nl_send_intf_rpt_msg(struct rtl8192cd_priv *priv);
EXTERN void rtk_wlan_manager_nl_send_sta_rpt_msg(struct rtl8192cd_priv *priv, struct stat_info *pstat);
EXTERN void rtk_wlan_manager_nl_send_frame_rpt_msg(struct rtl8192cd_priv *priv, u16 frame_type, u8 *sa, u8 rssi);
EXTERN void rtk_wlan_manager_nl_send_time_tick_msg(struct rtl8192cd_priv *priv);
EXTERN void rtk_wlan_manager_nl_hook(struct rtl8192cd_priv *priv, u8 band, u8 iface_id);
EXTERN void rtk_wlan_manager_nl_init(void);
EXTERN void rtk_wlan_manager_nl_deinit(void);

#undef EXTERN

#endif /* end CONFIG_RTK_WLAN_MANAGER */
