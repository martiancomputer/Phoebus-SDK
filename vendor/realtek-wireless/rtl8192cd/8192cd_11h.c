...
#define MAX_CHANNEL_SET_NUMBER	25
...
static const BAND_TABLE_ELEMENT country_ie_channel_5g[] = {
	...
	/*(1) FCC */		  {25, {{36,1,30}, {40,1,30}, {44,1,30}, {48,1,30},
	...
	/* (3) ETSI */	  {24, {{36,1,30}, {40,1,30}, {44,1,30}, {48,1,30}, 
	                        {52,1,30}, {56,1,30}, {60,1,30}, {64,1,30}, 
    ...
    /* (18) SG */    {9, {{36,1,30}, {40,1,30}, {44,1,30}, {48,1,30}, 
                            {149,1,20},{153,1,20},{157,1,20},{161,1,20},{165,1,20}}
                      },
    /* (19) KR */     {20, {{36,1,30}, {40,1,30}, {44,1,30}, {48,1,30}, 
                            {52,1,30}, {56,1,30}, {60,1,30}, {64,1,30}, 
                            {100,1,20},{104,1,20},{108,1,20},{112,1,20},
                            {116,1,20},{136,1,20},{140,1,20},
                            {149,1,20},{153,1,20},{157,1,20},{161,1,20}, {165,1,20}}
                      },
    /* (20) MX */     {18, {{52,1,30}, {56,1,30}, {60,1,30}, {64,1,30}, 
                            {100,1,20},{104,1,20},{108,1,20},{112,1,20},
                            {116,1,20},
                            {132,1,20},{136,1,20},{140,1,20},{144,1,20},
                            {149,1,20},{153,1,20},{157,1,20},{161,1,20}, {165,1,20}}
                      },
};
...
#if defined(DOT11K)
unsigned char search_country_txpower_by_regdomain(struct rtl8192cd_priv *priv, unsigned char channel)
{
    const BAND_TABLE_ELEMENT * band_table = NULL;
    int i;
    int step;
    if ( priv->pmib->dot11RFEntry.phyBandSelect & PHY_BAND_2G)
    {
        if(priv->pmib->dot11StationConfigEntry.dot11RegDomain)
        {
            band_table = &(country_ie_channel_2_4g[priv->pmib->dot11StationConfigEntry.dot11RegDomain-1]);
            step = 1;
        }
    }
    else
    {
        if(priv->pmib->dot11StationConfigEntry.dot11RegDomain)
        {
            band_table = &(country_ie_channel_5g[priv->pmib->dot11StationConfigEntry.dot11RegDomain-1]);
            step = 4;
        }
    }
    if(band_table)
