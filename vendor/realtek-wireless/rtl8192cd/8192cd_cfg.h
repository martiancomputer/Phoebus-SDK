...
#if (CONFIG_NR_CPUS >= 4)
#define SMP_SKB_RECYCLE_OFFLOAD
#define SKB_RECYCLE_CPU 3
#endif
#define RX_BUFFER_GATHER_REORDER

//#define SMP_RX_LOAD_BALANCE		// MUST include RTL8190_DIRECT_RX
#ifdef SMP_RX_LOAD_BALANCE
#define RTL8190_DIRECT_RX
#define SMP_RX_LB_LEVEL	2		// Available values are 1 and 2
#define SMP_RX_LB_OFFLOAD_CPU	0
#endif

#if (defined(CONFIG_RG_WLAN_HWNAT_ACCELERATION)||defined(CONFIG_RTK_FC_WLAN_HWNAT_ACCELERATION)) && !defined(CONFIG_ARCH_LUNA_SLAVE) && !defined(SMP_RX_LOAD_BALANCE) && !defined(CONFIG_HWNAT_NETIF_RX_QUEUE_SUPPORT)
    #define CONFIG_HWNAT_NETIF_RX_QUEUE_SUPPORT
#endif

#endif // CONFIG_ARCH_CORTINA_G3 || CONFIG_ARCH_CORTINA_G3HGU || CONFIG_ARCH_CORTINA_VENUS || CONFIG_ARCH_REALTEK_TAURUS || CONFIG_ARCH_REALTEK_9607F
...
// Disable CONFIG_RTL_CUSTOM_PASSTHRU if using PCI_BIOS (CONFIG_NET_PCI).
// After registering PCI driver, rtl_wlan_customPassthru_init() is called but failed
// since pcie probe has not been executed and non of priv has been added to wlan_device.
#if !defined(__ECOS) && !(defined(CONFIG_OPENWRT_SDK) && defined(__LINUX_3_10__)) && !defined(__OSK__) && !defined(CONFIG_NET_PCI) /*eric-sync ??*/
...
//-------------------------------------------------------------
#define DRV_VERSION_H	4
#define DRV_VERSION_L	0
#define DRV_VERSION_SUBL	8
#define DRV_VERSION_SUBSUBL	5

#define DRV_RELDATE		"2023-08-09"
#define DRV_NAME		"Realtek WLAN driver"

//-------------------------------------------------------------
// Force QoS Value by skb->cb[0]
//-------------------------------------------------------------
#ifdef CONFIG_FORCE_QOS_SUPPORT
#define FORCE_QOS_SUPPORT
#if defined(CONFIG_CMCC) || defined(CONFIG_YUEME)
#define CMCC_CTC_QOS  // Support CMCC/CTC QoS Test Spec
#endif
#endif
...
#define CTC_ORIENTATION_REFINE
#define CTC_AP_COEXIST
#define CTC_FEATURE_SUPPORT
#define CTC_WIFI_DIAG
#define CTC_WMM_LATENCY
#define CTC_2G_ACS

// Workaround for CTC roaming test. Some STAs (e.g. Xiaomi9)
// send bss transition response management frames w/ to_ds = 1.
//#define ALLOW_MGNT_FRAME_WITH_TO_DS

#endif // CONFIG_CTC_FEATURE_SUPPORT
...
//-------------------------------------------------------------
#ifdef CONFIG_PCI_HCI
#if !defined(CONFIG_WLAN_HAL_8198F) //&& !defined(CONFIG_WLAN_HAL_8814BE) // charlie, disable CHECK_HANGUP temporarily
#define CHECK_HANGUP
#endif
...
#if defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8197F) || defined(CONFIG_WLAN_HAL_8192FE) || defined (CONFIG_WLAN_HAL_8812FE)
...
// NL80211
//-------------------------------------------------------------
#if defined(CONFIG_CFG80211) || defined(CONFIG_CFG80211_MODULE)
...
/* When driver is built in backport env with cfg80211 support */
#if defined(CONFIG_BACKPORTED_CFG80211) || defined(CONFIG_BACKPORTED_CFG80211_MODULE)
...
#define CLM_SAMPLE_SS   40       /*  CLM sample num(unit:ms), than SS_TIME(50) */
//-------------------------------------------------------------
...
/*wpa_supplicant mode SAE support(client mode)*/
#if defined(RTK_NL80211) && defined(CLIENT_MODE)
...
#endif
/* here is MUST!! */
#define log2(msg, ...) do {panic_printk("SAE:" msg "\n", ##__VA_ARGS__);} while(0)
//#define log2(msg, ...) NOP
...
// Support Tx AMSDU
//-------------------------------------------------------------
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8192FE) || defined(CONFIG_WLAN_HAL_8812FE)
...
#define TX_AMSDU_REFINE
#endif

#ifdef SUPPORT_TX_AMSDU
#if defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8192FE) || defined(CONFIG_WLAN_HAL_8814BE)
#define SUPPORT_TX_AMSDU_SMALL_PKTS_ONLY
#endif
#if defined(TX_SHORTCUT)
#if (!defined(CONFIG_RTL_8198C) && !defined(CONFIG_RTK_MESH)) || defined (CONFIG_RTL_OFFLOAD_DRIVER)
...
#define PKT_DUMP_DEBUG

//-------------------------------------------------------------
// Support Rx AMSDU
//-------------------------------------------------------------
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8822CE) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8821CE) || defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8812FE) || defined(CONFIG_WLAN_HAL_8192FE)
...
//-------------------------------------------------------------
#if !defined(CONFIG_RTL8196B_GW_8M) && !defined(CONFIG_WIRELESS_LAN_MODULE) && !defined(WIFI_LIMITED_MEM) && !defined(__OSK__) && !defined(NOT_RTK_BSP)// && !defined(CONFIG_WLAN_HAL_8198F)
#define PRIV_STA_BUF
#endif
...
//-------------------------------------------------------------
// Pre-allocate STA buffer for drivers built as module
//-------------------------------------------------------------
#if defined(CONFIG_WIRELESS_LAN_MODULE)
//#define PRE_ALLOC_STA_BUF
#endif
...
#define WIFI_LOGO_WPA3_MARVELL_STA_WKARD
#endif
...
#define STA_CONTROL
//#define STA_CONTROL_VAP_ALTERNATE
...
#endif
#if defined(CONFIG_RTK_MULTI_AP) && !defined(CONFIG_CTC_FEATURE_SUPPORT)
...
#define MU_BEAMFORMING_SUPPORT 0
#undef CONFIG_VERIWAVE_MU_CHECK
#endif
...
#define rtk_del_timer_sync rtk_del_timer
#endif
...
//-------------------------------------------------------------
// Issue RTS constructed by Software
//-------------------------------------------------------------
//#define ISSUE_RTS_BY_SW
...
//-------------------------------------------------------------
// Delete station information when station is expired
//-------------------------------------------------------------
#if defined(CONFIG_RTL8672) || defined(_CORTINA_)
#define DEL_EXPIRE_STA
#endif

//-------------------------------------------------------------
// Dynamic CPU arrangement
//-------------------------------------------------------------
#ifdef CONFIG_RG_WLAN_HWNAT_ACCELERATION
#define DYNAMIC_CPU_ARRANGEMENT
#endif
...
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8197F) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8821CE) || defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8822CE) || defined(CONFIG_WLAN_HAL_8812FE)
...
#if defined(WIFI_BUFFER_LIMITED)
...
#elif defined(_CORTINA_) || defined(NOT_RTK_BSP)
...
#else
#define WLAN_HAL_TX_AMSDU_MAX_NUM   16 // recommended value: 4, 6, 8,
#define WLAN_HAL_TX_AMSDU_NUM       16 // priv->pmib->dot11nConfigEntry.dot11nAMSDUSendNum
#endif
...
//-------------------------------------------------------------
#if defined(_LITTLE_ENDIAN_) && !defined(CONFIG_RTL_8197F) && !defined(CONFIG_RTL_8198F)
...
#ifdef __KERNEL__
#ifdef __LINUX_2_6_29__
#define NETDEV_NO_PRIV
#endif

#ifndef __LINUX_2_6_29__
...
#if defined(CONFIG_DEV_xDSL) || defined(CONFIG_SHARE_XTAL)
#define DONT_DISABLE_XTAL_ON_CLOSE
#endif

#if defined(CONFIG_DEV_xDSL) || defined(CONFIG_DONT_TURNOFF_MAC)
#define DONT_TURNOFF_MAC
#endif
...
#if defined(RTL8190_DIRECT_RX) && !defined(SMP_RX_LOAD_BALANCE) && defined(CONFIG_HWNAT_NETIF_RX_QUEUE_SUPPORT)
#error "DIRECT_RX+NETIF_RX_QUEUE combination does NOT support!!"
#endif
...
#if defined(USE_RLX_BSP) && !defined(__LINUX_2_6_22__)
	#undef USE_RLX_BSP
#endif
...
#define panic_printk_cont printk
...
#ifdef WIFI_WMM
//#define TRX_VI_DATA_LOG	// Huawei feature - Log VI pkts
#endif
...
#endif // CONFIG_WIRELESS_LAN_MODULE || CONFIG_RTL_ULINKER_WLAN_DELAY_INIT
	...
	#define NUM_TX_DESC		200
		...
		#define NUM_TX_DESC		1024
			...
			#define NUM_TX_DESC 	128
				...
				#define NUM_TX_DESC		480
			#elif (defined(CONFIG_RTL_8198C) && defined(CONFIG_WLAN_HAL_8814AE)) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8822CE)
				#ifdef WMM_DSCP_C42
					#define NUM_TX_DESC    2048
				#else
					#define NUM_TX_DESC    2048 //768
				#endif
...
#define dybw_thrd	3
	...
	#define NUM_RX_DESC		64
		...
		#define NUM_RX_DESC 	320
			...
			#define NUM_RX_DESC		480	//256
				...
				#define NUM_RX_DESC     512
			#elif defined(CONFIG_WLAN_HAL_8822BE) && defined(CONFIG_RTL9607C)
				#define NUM_RX_DESC	    3000 //2048
			#elif defined(CONFIG_WLAN_HAL_8812FE) && defined(CONFIG_RTL9607C)
				#define NUM_RX_DESC	    3000 //2048
			#else
	...
	#define NUM_RX_DESC_2G NUM_RX_DESC  /* wlan1 92E */
#elif defined(CONFIG_WLAN_HAL_8192FE) && defined(CONFIG_WLAN_HAL_8812FE)
	#define NUM_RX_DESC_2G NUM_RX_DESC  /* wlan1 92F */
#else
	#define NUM_RX_DESC_2G NUM_RX_DESC
#endif
...
#elif defined(CONFIG_RTK_MULTI_AP_R3)
#define PRE_ALLOCATED_MMPDU		128
#define PRE_ALLOCATED_BUFSIZE	((1024+128)/4)		// 1024 bytes long should be enough for DPP messages! Declare as unsigned int
#else
...
#define ACS_SS_IGI_RESUME  0x2c
#define ACS_STEP1_IGI      0x3e
#define ACS_STEP2_IGI      0x2c
#define SS_IGI_DEFAULT     0x30
#define SS_IGI             (priv->pmib->miscEntry.ss_igi)
...
//--------------------------------------------------------------------
// Decision Hapd base / Non-Hapd base 802.11K/V for Multi-AP
//---------------------------------------------------------------------
#if defined(CONFIG_RTK_MULTI_AP) && !(defined(CONFIG_HAPD_DOT11K_SUPPORT) && defined(CONFIG_HAPD_DOT11V_SUPPORT))
#undef CONFIG_HAPD_DOT11K_SUPPORT
#undef CONFIG_HAPD_DOT11V_SUPPORT
#define CONFIG_RTL_DOT11K_SUPPORT
#define CONFIG_RTL_11V_SUPPORT
#endif
...
#else /* !__OSK__ */
#ifdef CTC_2G_ACS
#define SS_AUTO_CHNL_NHM_TO_2G		RTL_MILISECONDS_TO_JIFFIES(SS_AUTO_CHNL_NHM_TO_VALUE + 20)
#define SS_AUTO_CHNL_NHM_TO_5G		RTL_MILISECONDS_TO_JIFFIES(SS_AUTO_CHNL_NHM_TO_VALUE)
#else
#define SS_AUTO_CHNL_NHM_TO		RTL_MILISECONDS_TO_JIFFIES(SS_AUTO_CHNL_NHM_TO_VALUE)
#endif /* CTC_2G_ACS */
#endif /* __OSK__ */
#endif /* CONFIG_RTL_NEW_AUTOCH */
...
#endif
#if defined(CONFIG_IEEE80211R) || defined(CONFIG_IEEE80211V) || defined(CONFIG_RTK_MULTI_AP)
...
#define RTL_LED_ON					0
#define RTL_LED_OFF					1
#define LED_0 					0
#define LED_1 					1
#define LED_2					2

#define LED_CUSTOM2_BLINK_FREQ_WPS		2	//0.5	// Hz
#define LED_CUSTOM2_INTERVAL_TIME_WPS	(unsigned long)(HZ/2/LED_CUSTOM2_BLINK_FREQ_WPS)
...
/*adjusted for support AMSDU*/
    ...
    #ifdef RX_BUFFER_GATHER
        #ifdef __LINUX_2_6__
            #if (defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8192FE)) && defined(SUPPORT_RX_AMSDU_AMPDU)
	...
	#undef MIN_RX_BUF_LEN
		...
		#define MAX_RX_BUF_LEN	3712
		#define MIN_RX_BUF_LEN	3712
	#elif defined(SUPPORT_RX_AMSDU_AMPDU) && !defined(CONFIG_RTL_OFFLOAD_DRIVER)
		#define MAX_RX_BUF_LEN	8800
		#define MIN_RX_BUF_LEN	4600
	#else
		#define MAX_RX_BUF_LEN	2600
...
#elif defined(CONFIG_WLAN_HAL_8192FE) && defined(CONFIG_WLAN_HAL_8812FE)
	#define MAX_RX_BUF_LEN_1 8800 //2600  //wlan1 92F
	#define MIN_RX_BUF_LEN_1 8800 //2600  //wlan1 92F
    #undef MAX_RX_BUF_LEN
    #undef MIN_RX_BUF_LEN
    #define MAX_RX_BUF_LEN  8800   // wlan0 8812F
    #define MIN_RX_BUF_LEN  8800   // wlan0 8812F
...
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8197F) || defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8822CE) || defined(CONFIG_WLAN_HAL_8812FE)
...
#define MAX_UNKNOWN_MC_ENTRY	16
...
#endif
#if defined(CONFIG_RTL8672) && defined(__LINUX_2_6_22__) && defined(WIFI_LIMITED_MEM)
	#undef NUM_STAT
	#define NUM_STAT	16
#endif
...
//-------------------------------------------------------------
				...
				#define MAX_SKB_NUM		100
					...
					#if defined(__LINUX_2_6_22__)
						#define MAX_SKB_NUM		96
					#else
						#define MAX_SKB_NUM		160
					#endif
				#else
					#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8812FE)
						#if defined(SMP_SYNC) && defined(CONFIG_WLAN_HAL_8814AE)
							#define MAX_SKB_NUM	 NUM_RX_DESC
						#elif defined(CONFIG_RTL9607C) && defined(CONFIG_WLAN_HAL_8822BE)
							#define MAX_SKB_NUM 3000
						#elif defined(CONFIG_RTL9607C) && defined(CONFIG_WLAN_HAL_8812FE)
							#define MAX_SKB_NUM 3000
						#else
...
#if (defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8822BE)) ||(defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8821CE))	||(defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8822CE)) ||(defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8812FE))
...
#endif
#define NUM_RX_DESC_2G      1024
#define MAX_RX_BUF_LEN_1    2600 // for 92FR
#define MIN_RX_BUF_LEN      MAX_RX_BUF_LEN
...
#else /* single band, NUM_RX_DESC and NUM_RX_DESC_2G should be the same*/
#define NUM_TX_DESC         768
...
#if defined(RTK_AC_SUPPORT) /* dual band & only 5G */
#if defined(CONFIG_RTL8192CD_MODULE)
#define NUM_TX_DESC         1024
#else
#define NUM_TX_DESC         2048
#endif
...
#if defined(CONCURRENT_MODE)
#if defined(CONFIG_WLAN_HAL_8814BE) && defined(CONFIG_RTL9607C)
#define MAX_SKB_NUM         NUM_RX_DESC      /* this could use (NUM_RX_DESC+xxx) to reserved skb to refill rxdesc*/
#define MAX_SKB_NUM_1       NUM_RX_DESC_2G   /* this could use (NUM_RX_DESC_2G+xxx) to reserved skb to refill rxdesc*/
#else
#define MAX_SKB_NUM         (NUM_RX_DESC+2048)      /* this could use (NUM_RX_DESC+xxx) to reserved skb to refill rxdesc*/
#define MAX_SKB_NUM_1       (NUM_RX_DESC_2G+1024)      /* this could use (NUM_RX_DESC_2G+xxx) to reserved skb to refill rxdesc*/
#endif

#else /* !CONCURRENT_MODE, single band */
#if defined(RTK_AC_SUPPORT)
#define MAX_SKB_NUM         (NUM_RX_DESC+2048)
#define MAX_SKB_NUM_1       MAX_SKB_NUM
#else
#define MAX_SKB_NUM         (NUM_RX_DESC_2G+1024)
#define MAX_SKB_NUM_1       MAX_SKB_NUM
#endif
#endif
...
#if defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_WLAN_HAL_8822BE)
#if defined(CONFIG_SLOT_0_RFE_TYPE_0)
#define CONFIG_8822B_RFE_TYPE_0
#elif defined(CONFIG_SLOT_0_RFE_TYPE_1)
#define CONFIG_8822B_RFE_TYPE_1
#elif defined(CONFIG_SLOT_0_RFE_TYPE_2)
#define CONFIG_8822B_RFE_TYPE_2
#elif defined(CONFIG_SLOT_0_RFE_TYPE_3)
#define CONFIG_8822B_RFE_TYPE_3
#elif defined(CONFIG_SLOT_0_RFE_TYPE_4)
#define CONFIG_8822B_RFE_TYPE_4
#elif defined(CONFIG_SLOT_0_RFE_TYPE_5)
#define CONFIG_8822B_RFE_TYPE_5
#elif defined(CONFIG_SLOT_0_RFE_TYPE_6)
#define CONFIG_8822B_RFE_TYPE_6
#elif defined(CONFIG_SLOT_0_RFE_TYPE_7)
#define CONFIG_8822B_RFE_TYPE_7
#elif defined(CONFIG_SLOT_0_RFE_TYPE_8)
#define CONFIG_8822B_RFE_TYPE_8
#elif defined(CONFIG_SLOT_0_RFE_TYPE_9)
#define CONFIG_8822B_RFE_TYPE_9
#elif defined(CONFIG_SLOT_0_RFE_TYPE_10)
#define CONFIG_8822B_RFE_TYPE_10
#elif defined(CONFIG_SLOT_0_RFE_TYPE_11)
#define CONFIG_8822B_RFE_TYPE_11
#elif defined(CONFIG_SLOT_0_RFE_TYPE_12)
#define CONFIG_8822B_RFE_TYPE_12
#elif defined(CONFIG_SLOT_0_RFE_TYPE_13)
#define CONFIG_8822B_RFE_TYPE_13
#endif
#endif
...
#ifdef CONFIG_WLAN_HAL
#define PRE_ALLOCATED_HDR		(NUM_TX_DESC<<1)
#else
...
//-------------------------------------------------------------
#if defined(ROAMING_SUPPORT) || defined(BEACON_VS_IE) || defined(CONFIG_CTC_FEATURE_SUPPORT)
...
#define RTK_SMART_ROAMING_VERSION "Realtek Smart Roaming v3.7.0"
...
#endif
#ifdef CONFIG_RTK_MULTI_AP_R4
#define RTK_MULTI_AP_R4
...
#if defined(CONFIG_NETDEV_MULTI_TX_QUEUE) && !defined(__LINUX_2_6_27__)
...
#define NUM_STAT 64 //support 64 STA for OpenWrt sdk
	...
	#elif defined(CONFIG_RTK_SMART_ROAMING)
		#define RTL8192CD_NUM_VWLAN  (4+1) //eric-vap, add one more for open-wrt scan iface
	#elif defined(CONFIG_RTL_MULTI_WIFI_MODULES)
		#ifdef CONFIG_WLAN_MBSSID_NUM
			#define RTL8192CD_NUM_VWLAN  (CONFIG_WLAN_MBSSID_NUM) /* depends on CONFIG_YUEME (=7) */
		#else
			#ifdef CONFIG_OPENWRT_SDK
				#define RTL8192CD_NUM_VWLAN  (3+1+1) // add one more for open-wrt scan iface : tmp.phy1
			#else
				#define RTL8192CD_NUM_VWLAN  (3+1)
			#endif
		#endif
	#else
...
// Number of STA buffer to be pre-allocated
#ifdef PRE_ALLOC_STA_BUF
#define PRE_ALLOC_NUM_STAT	NUM_STAT
...
#define PHYDM_SUPPORT_8822_CUT_VERSION 2
...
#ifdef CONFIG_NET_PCI
	// If using PCI_BIOS, the chip on PCIe slot 0 will be brought up first
	...
	#endif
#else  // !(CONFIG_NET_PCI)
	// If using PCI_DIRECT, the sequence of bring-up is determined by the
	// present of CONFIG_BAND_2G_ON_WLAN0 macro
...
//#define THERMAL_CONTROL_DEFAULT_VALUE
#endif
#if defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8192FE)
...
#endif
#if defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8812FE)
...
//-------------------------------------------------------------
#if defined(SMP_SYNC) && (defined(CONFIG_RTL9607C) || defined(_CORTINA_))
	#define WIFI_RX_PROCESS_ALL_QUEUE_OFFLOAD
	#define RX_DATA_OFFLOAD_DEFAULT_CPU 255 // disabled by default
...
#if defined(WIFI_RX_PROCESS_ALL_QUEUE_OFFLOAD) && defined(CONFIG_HWNAT_NETIF_RX_QUEUE_SUPPORT)
    #undef CONFIG_HWNAT_NETIF_RX_QUEUE_SUPPORT
#endif
...
#define POWER_PERCENT_ADJUSTMENT
#define DOT11D
#endif // CONFIG_RTL_MULTI_WIFI_MODULES
