...
static char rtw_dfs_regd_mapping_by_regd[] = { /* enum rtw_regd & enum rtw_dfs_regd */
	...
	/* RTW_REGD_KCC = 5 */ RTW_DFS_REGD_KCC,
...
static const struct country_chplan country_chplan_map[] = {
	...
	COUNTRY_CHPLAN_ENT("DE", 0x3A, 0x00, DEF    , 1, 1), /* Germany */
	...
	COUNTRY_CHPLAN_ENT("TH", 0x76, 0x00, DEF    , 1, 1), /* Thailand */
