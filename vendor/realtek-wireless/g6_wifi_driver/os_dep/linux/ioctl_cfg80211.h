...
#endif
	u32 configured_antennas_tx;
	u32 configured_antennas_rx;
};
...
#ifdef CONFIG_OPENSYNC
u8 rtw_cfg80211_radar_detected_event(_adapter *adapter, u8 ch, u8 bw, u8 offset, u8 ht);
u8 rtw_cfg80211_cac_event(_adapter *adapter, u8 ch, u8 bw, u8 offset, u8 ht, int event);
#endif
...
void rtw_cfg80211_indicate_wapi_key_update(_adapter *padapter, u8 *mac_addr, enum nl80211_key_type key_type);
#endif
