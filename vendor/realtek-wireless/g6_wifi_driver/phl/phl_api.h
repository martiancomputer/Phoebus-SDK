...
#ifdef CONFIG_RTL_WIFI_OFFLOAD
void
rtw_phl_update_stainfo_by_macid(void *phl, u8 user_cnt,
		struct rtw_r_meta_data *meta, struct rtl_wfo_rx_sts *users);

enum rtw_phl_status
phl_wfo_add_txsc(void *phl_info, struct rtw_xmit_req *tx_req,
...
rtw_phl_cmd_set_tx_retry_limit(void *phl, struct rtw_wifi_role_t *wifi_role,
								u8 limit, enum phl_cmd_type cmd_type,
								u32 cmd_timeout);
...
enum rtw_phl_status
rtw_phl_set_pwr_lmt_en(void *phl, bool en_val);
...
enum rtw_phl_status
rtw_phl_get_cur_freeruncnt(void *phl,
		struct rtw_wifi_role_t *wifi_role,
...
enum rtw_phl_status rtw_phl_set_dig_mode(void *phl, struct rtw_wifi_role_t *wifi_role,
								u8 dig_op_mode);

u8 rtw_phl_antdiv_get_targetant(void *phl);

enum rtw_phl_status
rtw_phl_antdiv_pause(void *phl, u8 target_ant, u8 pause);

enum rtw_phl_status
rtw_phl_sr_enable(void *phl, u8 sr_en);
