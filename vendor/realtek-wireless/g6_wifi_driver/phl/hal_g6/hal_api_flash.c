...
enum rtw_hal_status rtw_hal_flash_set_info(void *hal, u8 *cmd, u8 *data, u8 *ic_name)
{
	...
	else if (((strcmp(ic_name, "rtl8852c") == 0) || (strcmp(ic_name, "rtl8832brh") == 0)) && flash_id_table == NULL){
	...
	if(query_id != FLASH_INFO_ID_ERROR){
		...
		case FLASH_INFO_RF_2G_CCK_TSSI_CW_DIFF_D_1 ... FLASH_INFO_RF_2G_CCK_TSSI_CW_DIFF_D_6:
			if (strlen(data) != 12)
				...
				rtw_flash_set_tssi_slp_info(hal_info->flash, query_id, data, TSSI_2G_CCK_SIZE);
			break;
		...
		case FLASH_INFO_RF_2G_TSSI_CW_DIFF_D_1 ... FLASH_INFO_RF_2G_TSSI_CW_DIFF_D_5:
			if (strlen(data) != 10)
				...
				rtw_flash_set_tssi_slp_info(hal_info->flash, query_id, data, TSSI_2G_SIZE);
			break;
		...
		case FLASH_INFO_RF_5G_TSSI_CW_DIFF_D_1 ... FLASH_INFO_RF_5G_TSSI_CW_DIFF_D_14:
			if (strlen(data) != 28)
				...
				rtw_flash_set_tssi_slp_info(hal_info->flash, query_id, data, TSSI_5G_SIZE);
			break;
