...
#define RTW_MAC_MAX_H2C_PKT_NUM (RTW_MAC_H2CB_CMD_QLEN + RTW_MAC_H2CB_DATA_QLEN + \
	RTW_MAC_H2CB_LONG_DATA_QLEN)
 ...
 * @brief rtw_mac_ax_sr_info
 *
 * @var rtw_mac_ax_sr_info::sr_en
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::sr_field_v15_allowed
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::srg_obss_pd_min
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::srg_obss_pd_max
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::non_srg_obss_pd_min
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::non_srg_obss_pd_max
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::srg_bsscolor_bitmap_0
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::srg_bsscolor_bitmap_1
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::srg_partbsid_bitmap_0
 * Please Place Description here.
 * @var rtw_mac_ax_sr_info::srg_partbsid_bitmap_1
 * Please Place Description here.
 */
struct rtw_mac_ax_sr_info {
	u8 sr_en;
