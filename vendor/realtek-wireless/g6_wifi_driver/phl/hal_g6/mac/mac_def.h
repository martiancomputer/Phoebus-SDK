...
/**
 * @struct mac_ax_txbd_realloc_info
 * @brief mac_ax_txbd_realloc_info
 *
 * @var mac_ax_txbd_realloc_info::txbd_buf
 * Please Place Description here.
 * @var mac_ax_txbd_realloc_info::txch_map
 * Please Place Description here.
 */
struct mac_ax_txbd_realloc_info {
	u8 *txbd_buf;
...
/**
 * @struct mac_ax_rxbd_realloc_info
 * @brief mac_ax_rxbd_realloc_info
 *
 * @var mac_ax_rxbd_realloc_info::rxbd_buf
 * Please Place Description here.
 * @var mac_ax_rxbd_realloc_info::rxch_map
 * Please Place Description here.
 */
struct mac_ax_rxbd_realloc_info {
	u8 *rxbd_buf;
...
struct mac_ax_intf_ops {
	 ...
	 * may cause system crash or segmentation fault.
	 */
	u32 (*tx_bd_reallocate)(struct mac_ax_adapter *adapter,
	 ...
	 * may cause system crash or segmentation fault.
	 */
	u32 (*rx_bd_reallocate)(struct mac_ax_adapter *adapter,
...
struct mac_ax_ops {
	...
	u32 (*trx_mode_switch)(struct mac_ax_adapter *adapter,
			       enum mac_ax_trx_mode trx_mode);
	u32 (*txmode_switch)(struct mac_ax_adapter *adapter,
			     struct mac_tx_mode_switch *info);
