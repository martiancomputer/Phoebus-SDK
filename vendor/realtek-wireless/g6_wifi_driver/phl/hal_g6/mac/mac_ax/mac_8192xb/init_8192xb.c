...
static struct mac_ax_intf_ops mac8192xb_sdio_ops = {
	...
	sdio_tx_bd_reallocate, /* tx_bd_reallocate */
	sdio_rx_bd_reallocate, /* rx_bd_reallocate */
};
#endif
...
static struct mac_ax_intf_ops mac8192xb_usb_ops = {
	...
	usb_tx_bd_reallocate, /* tx_bd_reallocate */
	usb_rx_bd_reallocate, /* rx_bd_reallocate */
};
#endif
...
static struct mac_ax_intf_ops mac8192xb_pcie_ops = {
	...
	pcie_tx_bd_reallocate, /* tx_bd_reallocate */
	pcie_rx_bd_reallocate, /* rx_bd_reallocate */
};
#endif
...
static struct mac_ax_ops mac8192xb_ops = {
	...
	mac_txmode_switch, /*sw mode settings */
...
static struct mac_ax_adapter mac_8192xb_adapter = {
	...
	{0}, /* dbg_info */
	{0, 0}, /* test_l12_info */
	{0, 0, ERR_FLAG_REV_8192XB}, /* mac_auto_gen_info */
#if MAC_AX_SDIO_SUPPORT
