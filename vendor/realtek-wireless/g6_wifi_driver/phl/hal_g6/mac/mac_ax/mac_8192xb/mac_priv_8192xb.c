...
static struct mac_ax_priv_ops mac8192xb_priv_ops = {
	...
	/* ERROR FLAG CHECKER */
	err_flag_cmac_8192xb,
	err_flag_dmac_8192xb,
	err_flag_rst_cmac_8192xb,
	err_flag_rst_dmac_8192xb,
	err_flag_chk,
	...
	pcie_set_oobs_8192xb, /* pcie_set_oobs */
	set_dmaok_imr_ch_pcie_8192xb, /* set_dmaok_imr_ch_pcie */
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	read_sdio_cccr_8192xb, /* read_sdio_cccr */
#endif
#if MAC_AX_USB_SUPPORT
...
#endif
	/* QC */
	get_check_reg_8192xb, /* get_check_reg */
	/* WOWLAN */
