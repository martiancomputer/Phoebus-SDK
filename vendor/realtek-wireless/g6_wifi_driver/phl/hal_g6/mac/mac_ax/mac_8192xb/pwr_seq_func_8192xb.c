...
u32 mac_pwr_on_ap_pcie_8192xb(struct mac_ax_adapter *adapter)
{
	...
	/*Disable GPIO11 internal PU for EFEM Control Request, 0x2E0*/
	val32 = MAC_REG_R32(R_AX_GPIO0_15_EECS_EESK_LED1_PULL_HIGH_EN);
	MAC_REG_W32(R_AX_GPIO0_15_EECS_EESK_LED1_PULL_HIGH_EN, val32 & ~B_AX_GPIO11_PULL_HIGH_EN);

	/*enable GPIO16/GPIO17/GPIO18 internal PD for Internal Floatiing Leakage, 0x2E4*/
	/*enable GPIO1/GPIO11 internal PD for EFEM Control Request, 0x2E4*/
	val32 = MAC_REG_R32(R_AX_GPIO0_15_EECS_EESK_LED1_PULL_LOW_EN);
	MAC_REG_W32(R_AX_GPIO0_15_EECS_EESK_LED1_PULL_LOW_EN,
		    val32 | B_AX_MAC_FUNC_EN |
		    B_AX_GPIO1_PULL_LOW_EN |
		    B_AX_GPIO11_PULL_LOW_EN |
		    B_AX_GPIO16_PULL_LOW_EN |
		    B_AX_GPIO17_PULL_LOW_EN |
		    B_AX_GPIO18_PULL_LOW_EN);
