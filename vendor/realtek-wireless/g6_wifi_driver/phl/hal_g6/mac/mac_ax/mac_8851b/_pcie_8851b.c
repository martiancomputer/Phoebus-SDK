...
u32 pcie_set_oobs_8851b(struct mac_ax_adapter *adapter)
{
	return MACSUCCESS;
}

u32 set_dmaok_imr_ch_pcie_8851b(struct mac_ax_adapter *adapter,
				struct mac_ax_txdma_ch_map *txch_map,
				struct mac_ax_rxdma_ch_map *rxch_map)
{
	struct mac_ax_intf_ops *ops = adapter_to_intf_ops(adapter);
	u32 reg_imr_trx = R_AX_PCIE_HIMR00;
	u32 reg_imr_tx1 = R_AX_PCIE_HIMR10;
	u32 val32 = 0;
