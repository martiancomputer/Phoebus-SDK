...
static struct mac_ax_priv_ops mac8852a_priv_ops = {
	...
	err_flag_cmac_8852a,
	err_flag_dmac_8852a,
	err_flag_rst_cmac_8852a,
	err_flag_rst_dmac_8852a,
	err_flag_chk,
	...
	pcie_set_oobs_8852a, /* pcie_set_oob */
	set_dmaok_imr_ch_pcie_8852a, /* set_dmaok_imr_ch_pcie */
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	read_sdio_cccr_8852a, /* read_sdio_cccr */
#endif
#if MAC_AX_USB_SUPPORT
...
#endif
	/* QC */
	get_check_reg_8852a, /* get_check_reg */
	/* WOWLAN */
