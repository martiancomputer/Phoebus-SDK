...
static struct mac_ax_priv_ops mac1115e_priv_ops = {
	...
	pcie_set_oobs_1115e, /* pcie_set_oobs */
	set_dmaok_imr_ch_pcie_1115e, /* set_dmaok_imr_ch_pcie */
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	read_sdio_cccr_1115e, /* read_sdio_cccr */
#endif
#if MAC_AX_USB_SUPPORT
...
#endif
	/* QC */
	get_check_reg_1115e, /* get_check_reg */
};
