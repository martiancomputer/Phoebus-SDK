...
/*The number of Rx channels for receiving TB*/
#define RX_CH_1_USER	0x1
#define RX_CH_4_USER	0xf
#define RX_CH_8_USER	0xff
...
/**
 * @brief mac_trx_mode_switch
 *
 * @param *adapter
 * @return Please Place Description here.
 * @retval bool
 */
u32 mac_trx_mode_switch(struct mac_ax_adapter *adapter, enum mac_ax_trx_mode trx_mode);
