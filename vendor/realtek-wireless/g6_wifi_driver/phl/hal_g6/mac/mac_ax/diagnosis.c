	...
	*check_number = 0;
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_CMAC_MACID_DROP_0_C1 => %x, CMAC MACID_DROP_0 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_CMAC_MACID_DROP_1_C1 => %x, CMAC MACID_DROP_1 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_CMAC_MACID_DROP_2_C1 => %x, CMAC MACID_DROP_2 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_CMAC_MACID_DROP_3_C1 => %x, CMAC MACID_DROP_3 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0x1FFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_MBSSID_DROP_0_C1 => %x, MBSSID_DROP has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_DROP_0 => %x, CMAC MACID_DROP_0 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_DROP_1 => %x, CMAC MACID_DROP_1 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_DROP_2 => %x, CMAC MACID_DROP_2 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_DROP_3 => %x, CMAC MACID_DROP_3 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0x1FFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_MBSSID_DROP_0 => %x, MBSSID_DROP has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0x1FFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_MBSSID_DROP_0_C1 => %x, MBSSID_DROP has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_MACID_SLEEP_0_C1 => %x, MACID_SLEEP_0 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_MACID_SLEEP_1_C1 => %x, MACID_SLEEP_1 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_MACID_SLEEP_2_C1 => %x, MACID_SLEEP_2 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
		...
		if (!check_mac_en(adapter, MAC_AX_BAND_1, MAC_AX_CMAC_SEL)) {
			*check_number += 1;
			...
			if ((reg1 & 0xFFFFFFFF) != 0) {
				MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_AX_MACID_SLEEP_3_C1 => %x, MACID_SLEEP_3 has been setted\n", __func__, reg1);
				cnt += 1;
			}
		}
	}
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_SLEEP_0 => %x, MACID_SLEEP_0 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_SLEEP_1 => %x, MACID_SLEEP_1 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_SLEEP_2 => %x, MACID_SLEEP_2 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
	...
	if (is_chip_id(adapter, MAC_BE_CHIP_ID_8922A) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0xFFFFFFFF) != 0) {
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: R_BE_SHARE_MACID_SLEEP_3 => %x, MACID_SLEEP_3 has been setted\n", __func__, reg1);
			cnt += 1;
		}
	}
#endif // End of IC compile flag
