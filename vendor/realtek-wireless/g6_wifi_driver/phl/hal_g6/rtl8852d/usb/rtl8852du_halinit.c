 ...
 *
 *****************************************************************************/
#define _RTL8852DU_HALINIT_C_
#include "../rtl8852d_hal.h"

static void _hal_pre_init_8852du(struct rtw_phl_com_t *phl_com,
				 struct hal_info_t *hal_info,
				 struct hal_init_info_t *init_52du)
{
	struct mac_ax_trx_info *trx_info = &init_52du->trx_info;
	...
	init_52du->ic_name = "rtl8852du";
}

void init_hal_spec_8852du(struct rtw_phl_com_t *phl_com,
					struct hal_info_t *hal)
{
	...
	bus_hw_cap->rx_buf_align_size = 0;
...
enum rtw_hal_status hal_get_efuse_8852du(struct rtw_phl_com_t *phl_com,
					 struct hal_info_t *hal_info)
{
	struct hal_init_info_t init_52du;

	_os_mem_set(hal_to_drvpriv(hal_info), &init_52du, 0, sizeof(init_52du));
	_hal_pre_init_8852du(phl_com, hal_info, &init_52du);

	return hal_get_efuse_8852d(phl_com, hal_info, &init_52du);
}

enum rtw_hal_status hal_init_8852du(struct rtw_phl_com_t *phl_com,
				    struct hal_info_t *hal_info)
{
...
void hal_deinit_8852du(struct rtw_phl_com_t *phl_com,
		       struct hal_info_t *hal_info)
{
	/* free memory for hal */
...
enum rtw_hal_status hal_start_8852du(struct rtw_phl_com_t *phl_com,
				    struct hal_info_t *hal_info)
{
	struct hal_init_info_t init_52du;
	...
	return hal_start_8852d(phl_com, hal_info, &init_52du);
}

static void hal_deinit_misc_8852du(struct hal_info_t *hal)
{

}
#ifdef CONFIG_WOWLAN
enum rtw_hal_status
hal_wow_init_8852du(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal_info,
						struct rtw_phl_stainfo_t *sta)
{
	...
	*/
	...
	return hal_wow_init_8852d(phl_com, hal_info, sta, &init_52du);
}

enum rtw_hal_status
hal_wow_deinit_8852du(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal_info,
							struct rtw_phl_stainfo_t *sta)
{
	struct hal_init_info_t init_52du;
	struct mac_ax_trx_info *trx_info = &init_52du.trx_info;
	...
	*/
	...
	return hal_wow_deinit_8852d(phl_com, hal_info, sta, &init_52du);
}
#endif /* CONFIG_WOWLAN */


enum rtw_hal_status hal_stop_8852du(struct rtw_phl_com_t *phl_com,
				      struct hal_info_t *hal)
{
	enum rtw_hal_status hal_status = RTW_HAL_STATUS_FAILURE;
...
u32 hal_hci_cfg_8852du(struct rtw_phl_com_t *phl_com,
...
bool hal_recognize_int_8852du(struct hal_info_t *hal)
{
	struct rtw_hal_com_t *hal_com = hal->hal_com;
...
static u32 hal_halt_c2h_handler_8852du(struct hal_info_t *hal, u32 *handled)
{
	u32 ret = 0;
	struct rtw_hal_com_t *hal_com = hal->hal_com;
...
static u32 hal_watchdog_timer_handler_8852du(struct hal_info_t *hal, u32 *handled)
{
	u32 ret = 0;
	struct rtw_hal_com_t *hal_com = hal->hal_com;
...
u32 hal_int_hdler_8852du(struct hal_info_t *hal)
{
	...
	/* <4> Halt C2H related */
	int_hdler_msk |= (hal_halt_c2h_handler_8852du(hal, generalhandled) << 4);

	/* <4>watchdog timer related */
	int_hdler_msk |= (hal_watchdog_timer_handler_8852du(hal, generalhandled) << 5);
...
enum rtw_hal_status
hal_mp_init_8852du(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal_info)
{
	enum rtw_hal_status hal_status = RTW_HAL_STATUS_FAILURE;
	struct hal_init_info_t init_52du;
	...
	hal_status = hal_mp_init_8852d(phl_com, hal_info, &init_52du);
...
enum rtw_hal_status
hal_mp_deinit_8852du(struct rtw_phl_com_t *phl_com, struct hal_info_t *hal_info)
{
	enum rtw_hal_status hal_status = RTW_HAL_STATUS_FAILURE;
	struct hal_init_info_t init_52du;
	...
	hal_status = hal_mp_deinit_8852d(phl_com, hal_info, &init_52du);

	if (RTW_HAL_STATUS_SUCCESS != hal_status) {

		PHL_ERR("hal_mp_deinit_8852du: status = %u\n", hal_status);
		return hal_status;
	}
...
bool
hal_mp_path_chk_8852du(struct rtw_phl_com_t *phl_com, u8 ant_tx, u8 cur_phy)
{
