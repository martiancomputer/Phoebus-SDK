 ...
 *
 *****************************************************************************/
#define _RTL8852D_OPS_C_
#include "../hal_headers.h"
#include "rtl8852d_hal.h"

static void read_chip_version_8852d(struct rtw_phl_com_t *phl_com,
					...
					struct hal_info_t *hal)
{
	...
	/*** initialize section ***/
	ops->read_chip_version = read_chip_version_8852d;
	ops->hal_cfg_fw = hal_cfg_fw_8852d;
...
#ifdef RTW_PHL_BCN
	ops->cfg_bcn = hal_config_beacon_8852d;
	ops->upt_bcn = hal_update_beacon_8852d;
#endif
	...
	ops->dbg_tx_rpt = hal_debug_tx_report_8852d;
...
void hal_set_trx_ops_8852d(struct hal_info_t *hal)
{
	...
	ops->get_txdesc_len = get_txdesc_len_8852d;
	ops->fill_txdesc_h2c = fill_txdesc_h2c_8852d;
	ops->fill_txdesc_fwdl = fill_txdesc_fwdl_8852d;
	ops->fill_txdesc_pkt = fill_txdesc_pkt_8852d;
}
#endif
