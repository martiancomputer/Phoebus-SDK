...
rtw_hal_set_ch_bw(void *hal, u8 band_idx,
		struct rtw_chan_def *chdef, enum rfk_tri_type rt_type, bool frc_switch);
...
enum rtw_phl_status rtw_hal_set_tx_retry_limit(void *phl, u8 limit);

enum rtw_hal_status rtw_hal_set_ref_power(void *hal, u8 band, u16 txagc_ref);

enum rtw_hal_status rtw_hal_set_pwr_lmt_en_val(void *hal, u8 band, bool en_val);
#endif

enum rtw_hal_status rtw_hal_set_edcca_mode_en_val(void *hal, u8 band, u8 en_val);
...
/**
 * rtw_hal_update_pe_txbd - update PE tx bd for xmit packet
 * @hal: see struct hal_info_t
 ...
 */
enum rtw_hal_status
rtw_hal_update_pe_txbd(void *hal, void *txbd, void *wd);
...
#ifdef CONFIG_RTW_HW_RX_AMSDU_CUT
enum rtw_hal_status rtw_hal_enable_rx_amsdu_cut(struct rtw_phl_com_t *phl_com, void *hal);
enum rtw_hal_status rtw_hal_disable_rx_amsdu_cut(struct rtw_phl_com_t *phl_com, void *hal);
#endif /* CONFIG_RTW_HW_RX_AMSDU_CUT */
