...
#define BB_PDP_HIST_SIZE 6
#define BB_PDP_HIST_TH_SIZE (BB_PDP_HIST_SIZE - 1)
...
struct bb_physts_hist_info {
	...
	u16 tmax_idx_sts_path_hist[HALBB_MAX_PATH][HALBB_MAX_PATH][BB_PDP_HIST_SIZE]; /*nonlegecy : [sts][path][hist] */
	s16 snr_sts_path_hist[HALBB_MAX_PATH][HALBB_MAX_PATH][BB_HIST_SIZE]; /*nonlegecy : [sts][path][hist] */
	u16 sig_val_path_hist[HALBB_MAX_PATH][BB_HIST_SIZE];
	u16 evm_1ss_mu_hist[MU_USER_MAX][BB_HIST_SIZE];
	u16 evm_min_mu_hist[MU_USER_MAX][BB_HIST_SIZE];
	u16 evm_max_mu_hist[MU_USER_MAX][BB_HIST_SIZE];
	u16 snr_mu_hist[MU_USER_MAX][BB_HIST_SIZE];
	u16 cn_mu_hist[MU_USER_MAX][BB_HIST_SIZE];
};
...
struct bb_physts_hist_th_info {
	...
	u8 tmax_idx_hist_th[BB_PDP_HIST_TH_SIZE];
	s8 sig_val_path_hist_th[BB_HIST_TH_SIZE];
};
...
struct bb_physts_acc_info {
	...
	u32 snr_per_path_acc[HALBB_MAX_PATH];
	u32 cn_avg_acc;  /*U(7,1)*/
	s32 cfo_avg_acc; /*U(8,2)*/
	u16 pkt_cnt_cn_valid;
	s32 snr_sts_path_acc[HALBB_MAX_PATH][HALBB_MAX_PATH]; /*nonlegecy : [sts][path] */
	s32 sig_val_path_acc[HALBB_MAX_PATH];

	u16 pkt_cnt_cn_mu_valid;
	u32 evm_1ss_mu_acc[MU_USER_MAX];
	u32 evm_min_mu_acc[MU_USER_MAX];
	u32 evm_max_mu_acc[MU_USER_MAX];
	u32 snr_mu_acc[MU_USER_MAX];
	u32 cn_mu_acc[MU_USER_MAX];
};
