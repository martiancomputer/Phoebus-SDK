...
void halrf_txa_lctk_cmd(struct rf_info *rf, char input[][16], u32 *_used, char *output, u32 *_out_len);
...
void halrf_xtal_dbg_cmd(struct rf_info *rf, char input[][16], u32 *_used, char *output, u32 *_out_len);
