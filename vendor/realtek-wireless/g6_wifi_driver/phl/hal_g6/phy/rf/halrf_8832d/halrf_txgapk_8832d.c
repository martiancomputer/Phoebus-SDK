	...
	(struct rf_info *rf, enum phl_phy_idx phy, enum rf_path path)
{
	...
	u32 gain_stage_5g[3] = {0x6aa8, 0xd554, 0xd554};
	u32 gain_stage_5g_efem = 0x2aa8;
	
	//u32 gain_stage_6g[4] = {0x10aaa, 0x11554, 0x11554, 0x10aaa}; //LB MB HB UHB
	u32 gain_stage_6g[2][4] = {{0x9554, 0x9554, 0x9554, 0x9554}, 
							    {0x9554, 0x9554, 0x9554, 0x9554}}; //LB MB HB UHB

	if (rfe_type <50) { //NIC 
		gain_stage_5g[0] = 0x6aa8;
		gain_stage_5g[0] = 0xd554;
		gain_stage_5g[0] = 0xd554;
		
		gain_stage_6g[0][0] = 0x9554;
		gain_stage_6g[0][1] = 0x9554;
		gain_stage_6g[0][2] = 0x9554;
		gain_stage_6g[0][3] = 0x9554;
		
		gain_stage_6g[1][0] = 0x9554;
		gain_stage_6g[1][1] = 0x9554;
		gain_stage_6g[1][2] = 0x9554;
		gain_stage_6g[1][3] = 0x9554;
	} else { //ifem or efem
		gain_stage_5g[0] = 0x6aa8;
		gain_stage_5g[0] = 0xd550;
		gain_stage_5g[0] = 0xd550;
		
		gain_stage_6g[0][0] = 0xd4d0;
		gain_stage_6g[0][1] = 0xd550;
		gain_stage_6g[0][2] = 0xd4d0;
		gain_stage_6g[0][3] = 0x6a68;
		
		gain_stage_6g[1][0] = 0xd4d0;
		gain_stage_6g[1][1] = 0xd550;
		gain_stage_6g[1][2] = 0xd250;
		gain_stage_6g[1][3] = 0x6964;
	}
	...
	(struct rf_info *rf, enum phl_phy_idx phy, enum rf_path path)
{
	...
	u32 gain_stage_5g = 0x02;
	u32 gain_stage_6g = 0x02;
	
	if (rf->phl_com->dev_cap.rfe_type < 50) { //NIC
		gain_stage_5g = 0x02;
		gain_stage_6g = 0x02;	
	} else {//ifem or efem
		gain_stage_5g = 0x0;
