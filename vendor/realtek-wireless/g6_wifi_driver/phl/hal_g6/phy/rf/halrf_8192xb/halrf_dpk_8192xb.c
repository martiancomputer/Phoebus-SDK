...
//				halrf_wreg(rf, 0x5890, MASKDWORD, 0x00000840);
				...
				halrf_inn_set_ant_main_or_aux(rf, path, true);
			} else {
...
//				halrf_wreg(rf, 0x5884, MASKDWORD, 0x77770777);
				halrf_inn_set_ant_main_or_aux(rf, path, false);
			} else {
	...
	enum rf_path path)
{
	...
	halrf_wreg(rf, 0x81d4 + (path << 8), MASKDWORD, 0x100000);	/*rpt_sel*/
	...
	struct rf_info *rf)
{
	...
	for (path = 0; path < DPK_RF_PATH_MAX_8192XB; path++) {
		...
		/*rpt from KIP*/
		halrf_wreg(rf, 0x81d4 + (path << 8), MASKDWORD, 0xf0000);	/*rpt_sel*/
