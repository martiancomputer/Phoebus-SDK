...
#define RF_AX_1SS		0
#define RF_AX_2SS		(RF_RTL8852A | RF_RTL8852B | RF_RTL8852C | RF_RTL8852D | RF_RTL8832D |\
				 RF_RTL8832BR | RF_RTL8192XB | RF_RTL8852BP | RF_RTL8832CR_VU | RF_RTL8832BR_VT)
#define RF_AX_3SS		0
...
#define RF_AX_SERIES	(RF_AX_1SS | RF_AX_2SS |\
				 RF_AX_3SS | RF_AX_4SS)
/*@==========================================================================*/
#if (defined (RF_8852C_SUPPORT) || defined (RF_8852D_SUPPORT) || defined (RF_8832D_SUPPORT) )
#define KIP_REG 3136
...
#define KPATH 4
       ...
       defined(RF_8852C_SUPPORT) || defined(RF_8852D_SUPPORT) || defined(RF_8832D_SUPPORT) || defined(RF_8832BR_SUPPORT) ||\
