...
ifeq ($(findstring y, $(CONFIG_RTL8852C) $(CONFIG_RTL8832BRH)), y)
rf_ic := 8852c
...
halrf-y += $(path_halrf_8852c)/halrf_8852c.o \
			...
			$(path_halrf_8852c)/halrf_edpk_8852c.o \
...
# Level 2 directory
path_halrf_8832d := $(path_halrf_d1)/halrf_$(rf_ic)
...
halrf-y += $(path_halrf_8192xb)/halrf_8192xb.o \
			...
			$(path_halrf_8192xb)/halrf_edpk_8192xb.o \
