...
struct phl_acs_info {
	...
	u8 nhm_cca_ratio[MAX_ACS_INFO];
	u8 nhm_tx_ratio[MAX_ACS_INFO];
	u8 nhm_ratio[MAX_ACS_INFO];
	u8 nhm_idle_ratio[MAX_ACS_INFO];
	u8 nhm_rpt[MAX_ACS_INFO][NHM_RPT_NUM];
	u16 nhm_tx_cnt[MAX_ACS_INFO];
	u16 nhm_cca_cnt[MAX_ACS_INFO];
	u16 nhm_idle_cnt[MAX_ACS_INFO];
	u8 clm_fa_ratio[MAX_ACS_INFO];
};
