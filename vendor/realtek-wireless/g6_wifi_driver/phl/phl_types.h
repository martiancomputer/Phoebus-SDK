...
enum lock_type {
	...
	#ifdef CONFIG_EXT_FW_CONFIG_PATH
	#define FW_FILE_CONFIG_PATH	CONFIG_EXT_FW_CONFIG_PATH
	#elif defined(CONFIG_FIRMWARE_PATH)
	#define FW_FILE_CONFIG_PATH	CONFIG_FIRMWARE_PATH
	#else
	#define FW_FILE_CONFIG_PATH	""
	#endif

	#ifdef CONFIG_EXT_FW_ROOTFS_PATH
	#define FW_FILE_ROOTFS_PATH	CONFIG_EXT_FW_ROOTFS_PATH
	#else
	#define FW_FILE_ROOTFS_PATH	FW_FILE_CONFIG_PATH
	#endif
