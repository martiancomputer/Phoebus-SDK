...
#define COMP_PHL_TWT BIT11
#define COMP_PHL_OFDMA BIT12
#define COMP_PHL_GROUP BIT13
#define COMP_PHL_BB BIT14
#define COMP_PHL_RF BIT15
#define COMP_PHL_LED BIT16
#define COMP_PHL_MCC BIT17
#define COMP_PHL_P2PPS BIT18
#define COMP_PHL_ECSA BIT19
#define COMP_PHL_CMDDISP BIT20
#define COMP_PHL_BTC BIT21
...
#define PHL_PRINT(fmt, ...)     \
	do {\
			PHL_TRACE(0xffffffff, _PHL_ALWAYS_, fmt, ##__VA_ARGS__);\
	} while (0)
...
void debug_dump_data_header(u8 *buf, u32 buf_len, const char *prefix);
