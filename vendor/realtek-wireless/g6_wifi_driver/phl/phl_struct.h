...
struct hci_info_t {
	...
	u8 fixed_mitigation; /* 0: dynamic setting, 1: no watchdog dynamic setting */
#endif
...
struct phl_hci_trx_ops {
	...
	enum rtw_phl_status (*pe_rx)(struct phl_info_t *phl_info,
...
struct phl_info_t {
...
#ifdef CONFIG_RTL_WIFI_OFFLOAD
	struct rtw_phl_handler phl_pe_isr_handler;
#endif /* CONFIG_RTL_WIFI_OFFLOAD */
	...
	/* RX offload */
	u8 rxq_offload;
	struct rtw_phl_pe_rx_ring phl_pe_rx_ring;
	struct rtw_phl_pe_rx_ring phl_pe_rp_ring;
	/* TX offload */
	u8 txq_offload;
	struct rtw_phl_pe_tx_ring phl_pe_tx_ring;
#endif /* CONFIG_RTL_WIFI_OFFLOAD */
	void *led_ctrl;
