	...
	struct mp_context *mp, struct mp_tx_arg *arg)
{
	...
	struct mp_mac_ax_f2p_test_para f2p_test_para_struct ;
	struct mp_mac_ax_f2p_wd f2p_wd_struct ;
	struct mp_mac_ax_f2p_tx_cmd f2p_tx_cmd_struct  ;
	_rtw_memset(&f2p_test_para_struct, 0, sizeof(struct mp_mac_ax_f2p_test_para));
	_rtw_memset(&f2p_wd_struct, 0, sizeof(struct mp_mac_ax_f2p_wd));
	_rtw_memset(&f2p_tx_cmd_struct, 0, sizeof(struct mp_mac_ax_f2p_tx_cmd));
