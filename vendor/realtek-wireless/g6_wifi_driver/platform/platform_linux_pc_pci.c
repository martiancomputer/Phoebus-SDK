...
#if defined(CONFIG_AX_SHARE_XTAL) || defined(CPTCFG_AX_SHARE_XTAL)
...
int dev_get_band_cap(void *dev)
{
	...
	#if defined(CONFIG_2G_ON_WLAN0) && defined(CONFIG_2G_ON_PCIE_SLOT0)
	static const char wlan_2_4g_dev[] = "0000:01:00.0";
	#else
