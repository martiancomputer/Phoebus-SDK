...
struct flash_dict flash_id_table_8852d[] = {
	/*MAC part*/
	...
	{EFUSE_INFO_RF_6G_BW40M_A_TSSI_DE_1, "6G_bw40_tssi_A", 0x300, 1},
	{EFUSE_INFO_RF_6G_BW40M_B_TSSI_DE_1, "6G_bw40_tssi_B", 0x32a, 1},
	{EFUSE_INFO_RF_6G_BW40M_C_TSSI_DE_1, "6G_bw40_tssi_C", 0x354, 1},
	{EFUSE_INFO_RF_6G_BW40M_D_TSSI_DE_1, "6G_bw40_tssi_D", 0x37e, 1},
	...
	{EFUSE_INFO_RF_RX_GAIN_K_A_5GM, "5G_rx_gain_mid", 0x2da, 1},
	{EFUSE_INFO_RF_RX_GAIN_K_A_5GH, "5G_rx_gain_high", 0x2dc, 1},
	{EFUSE_INFO_RF_RX_GAIN_K_A_6GL1, "6G_rx_gain_AB", 0x3a8, 1},
...
struct flash_dict flash_id_table_8192xb[] = {
	...
	{EFUSE_INFO_COSTUM_PARA_PATH, "para_path", 0x0, 0},

	{EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_A_1, "2G_CCK_GAIN_DIFF_A", 0x0, 1},
	{EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_B_1, "2G_CCK_GAIN_DIFF_B", 0x0, 1},
	{EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_C_1, "2G_CCK_GAIN_DIFF_C", 0x0, 1},
	{EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_D_1, "2G_CCK_GAIN_DIFF_D", 0x0, 1},
	{EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_A_1, "2G_CCK_CW_DIFF_A", 0x0, 1},
	{EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_B_1, "2G_CCK_CW_DIFF_B", 0x0, 1},
	{EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_C_1, "2G_CCK_CW_DIFF_C", 0x0, 1},
	{EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_D_1, "2G_CCK_CW_DIFF_D", 0x0, 1},

	{EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_A_1, "2G_GAIN_DIFF_A", 0x0, 1},
	{EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_B_1, "2G_GAIN_DIFF_B", 0x0, 1},
	{EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_C_1, "2G_GAIN_DIFF_C", 0x0, 1},
	{EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_D_1, "2G_GAIN_DIFF_D", 0x0, 1},
	{EFUSE_INFO_RF_2G_TSSI_CW_DIFF_A_1, "2G_CW_DIFF_A", 0x0, 1},
	{EFUSE_INFO_RF_2G_TSSI_CW_DIFF_B_1, "2G_CW_DIFF_B", 0x0, 1},
	{EFUSE_INFO_RF_2G_TSSI_CW_DIFF_C_1, "2G_CW_DIFF_C", 0x0, 1},
	{EFUSE_INFO_RF_2G_TSSI_CW_DIFF_D_1, "2G_CW_DIFF_D", 0x0, 1},

	{EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_A_1, "5G_GAIN_DIFF_A", 0x0, 1},
	{EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_B_1, "5G_GAIN_DIFF_B", 0x0, 1},
	{EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_C_1, "5G_GAIN_DIFF_C", 0x0, 1},
	{EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_D_1, "5G_GAIN_DIFF_D", 0x0, 1},
	{EFUSE_INFO_RF_5G_TSSI_CW_DIFF_A_1, "5G_CW_DIFF_A", 0x0, 1},
	{EFUSE_INFO_RF_5G_TSSI_CW_DIFF_B_1, "5G_CW_DIFF_B", 0x0, 1},
	{EFUSE_INFO_RF_5G_TSSI_CW_DIFF_C_1, "5G_CW_DIFF_C", 0x0, 1},
	{EFUSE_INFO_RF_5G_TSSI_CW_DIFF_D_1, "5G_CW_DIFF_D", 0x0, 1},
};
                   ...
                   void *value, u8 size)
{
	...
	if (info_type <= EFUSE_INFO_BTCOEX_MAX) {
		phl_status = rtw_phl_extract_efuse_info(flash_info->dvobj->phl,
						...
						size,
						1);
		status = (phl_status == RTW_PHL_STATUS_SUCCESS) ? _SUCCESS : _FAIL;
	}
	else if (info_type <= EFUSE_INFO_RF_TSSI_MAX)
		status = rtw_flash_get_tssi_slp_info(flash_info,
						info_type,
						value,
						size);
...
u32 rtw_flash_efuse_init(struct dvobj_priv *dvobj)
{
	...
	if (strncmp(ic_name, "rtl8852a", 8) == 0)
		flash_info->dict = flash_id_table_8852a;
	else if (strncmp(ic_name, "rtl8852c", 8) == 0 ||
		strncmp(ic_name, "rtl8832brh", 10) == 0)
		flash_info->dict = flash_id_table_8852c;
	else if (strncmp(ic_name, "rtl8852d", 8) == 0)
		flash_info->dict = flash_id_table_8852d;
	else if (strncmp(ic_name, "rtl8192xb", 9) == 0 ||
		strncmp(ic_name, "rtl8832br", 9) == 0)
		flash_info->dict = flash_id_table_8192xb;
	else {
		RTW_ERR(FUNC_DEVID_FMT" Unknown ic name: %s\n",
...
{
	enum rtw_efuse_info ret = FLASH_INFO_ID_ERROR;
	int i;
...
u32 rtw_flash_set_tssi_slp_info(void *flash, enum rtw_efuse_info info_type, u8 *input_data, u8 len)
{
	struct flash_t *flash_info = flash;
	u8 i = 0, value = 0;
	u8 temp[3] = {0};
...
u32 rtw_flash_get_tssi_slp_info(void *flash, enum rtw_efuse_info info_type, void *value, u8 size)
{
	struct flash_t *flash_info = flash;
	u8 offset = 0;
	...
	switch (info_type) {
		case EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_A_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_A_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_A_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_gain_diff_A[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_B_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_B_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_B_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_gain_diff_B[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_C_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_C_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_C_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_gain_diff_C[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_D_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_D_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_GAIN_DIFF_D_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_gain_diff_D[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_A_1 ... EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_A_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_A_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_gain_diff_A[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_B_1 ... EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_B_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_B_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_gain_diff_B[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_C_1 ... EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_C_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_C_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_gain_diff_C[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_D_1 ... EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_D_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_GAIN_DIFF_D_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_gain_diff_D[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_A_1 ... EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_A_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_A_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_gain_diff_A[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_B_1 ... EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_B_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_B_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_gain_diff_B[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_C_1 ... EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_C_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_C_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_gain_diff_C[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_D_1 ... EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_D_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_GAIN_DIFF_D_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_gain_diff_D[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_A_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_A_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_A_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_cw_diff_A[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_B_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_B_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_B_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_cw_diff_B[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_C_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_C_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_C_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_cw_diff_C[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_D_1 ... EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_D_6:
			offset = info_type - EFUSE_INFO_RF_2G_CCK_TSSI_CW_DIFF_D_1;
			if (offset < TSSI_2G_CCK_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cck_cw_diff_D[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_CW_DIFF_A_1 ... EFUSE_INFO_RF_2G_TSSI_CW_DIFF_A_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_CW_DIFF_A_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cw_diff_A[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_CW_DIFF_B_1 ... EFUSE_INFO_RF_2G_TSSI_CW_DIFF_B_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_CW_DIFF_B_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cw_diff_B[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_CW_DIFF_C_1 ... EFUSE_INFO_RF_2G_TSSI_CW_DIFF_C_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_CW_DIFF_C_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cw_diff_C[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_2G_TSSI_CW_DIFF_D_1 ... EFUSE_INFO_RF_2G_TSSI_CW_DIFF_D_5:
			offset = info_type - EFUSE_INFO_RF_2G_TSSI_CW_DIFF_D_1;
			if (offset < TSSI_2G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_2g_cw_diff_D[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_CW_DIFF_A_1 ... EFUSE_INFO_RF_5G_TSSI_CW_DIFF_A_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_CW_DIFF_A_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_cw_diff_A[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_CW_DIFF_B_1 ... EFUSE_INFO_RF_5G_TSSI_CW_DIFF_B_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_CW_DIFF_B_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_cw_diff_B[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_CW_DIFF_C_1 ... EFUSE_INFO_RF_5G_TSSI_CW_DIFF_C_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_CW_DIFF_C_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_cw_diff_C[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		case EFUSE_INFO_RF_5G_TSSI_CW_DIFF_D_1 ... EFUSE_INFO_RF_5G_TSSI_CW_DIFF_D_14:
			offset = info_type - EFUSE_INFO_RF_5G_TSSI_CW_DIFF_D_1;
			if (offset < TSSI_5G_SIZE)
				_rtw_memcpy(value, &(flash_info->tssi_slp_info.tssi_5g_cw_diff_D[offset]), size);
			else
				RTW_ERR ("info_type error, info_type=%d\n", info_type);
			break;
		default:
