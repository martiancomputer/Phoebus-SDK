...
#define CONFIG_PHL_THREAD_CPU_BALANCE
#define CONFIG_SMP_SWQ_TX
#endif
...
#ifdef CONFIG_PHL_THREAD_CPU_BALANCE
	#define CPU_ID_PHL_THREAD	0
#endif
...
#define CONFIG_TXSC_AMSDU_TCP_ACK_REFINE
#endif
...
/* WFO_DYNAMIC_RXBUF is verified based on
   CONFIG_DYNAMIC_RX_BUF=y (defined in autoconf_rtlxxxx_pci_linux.h)
   and CONFIG_RTW_RX_BUF_SHARING=n (rtw_pltfm_preconf.h) */
#define WFO_DYNAMIC_RXBUF
#endif /* CONFIG_RTL_WIFI_OFFLOAD */
//#define DEBUG_REORDER_STAT
...
#define CONFIG_VW_NO_WDINFO
#define WKARD_SWQ_MAP_ONE_STA
#define CONFIG_SWQ_SKB_ARRAY
#ifdef CONFIG_RTL_WIFI_OFFLOAD
	#ifdef CONFIG_PON_VW_FULL_MEM
		#define VW_SWQ_SKB_NR 2048
	#else
		#define VW_SWQ_SKB_NR 1024
	#endif /* CONFIG_PON_VW_FULL_MEM */
#else  /* !CONFIG_RTL_WIFI_OFFLOAD */
		#define VW_SWQ_SKB_NR 4096
#endif /* CONFIG_RTL_WIFI_OFFLOAD */
#define CONFIG_SWQ_SKB_ARRAY_LIMIT
#ifdef CONFIG_ETHER_PKT_AGG
#define SWQ_SKB_ARRAY_LEN 2048
#else
#define SWQ_SKB_ARRAY_LEN 32768
#endif
#define CONFIG_LMT_TXREQ
#define CONFIG_DYN_ALLOC_XMITFRAME
#define CONFIG_DYN_FW_UPDATE
#if defined(CONFIG_DYN_FW_UPDATE) || !defined(CONFIG_RTW_FW_BUILTIN)
...
#define RXQ_0_BASE_BUF_SIZE		(12288 + SKB_OVERHEAD)
...
#define RXQ_1_BASE_BUF_SIZE		(4096 + SKB_OVERHEAD)
#ifdef CONFIG_RTW_RX_BUF_SHARING
...
#define RTW_BEACON_HOLD_TIME	(16 * 1000 / 32)
#define RTW_WKARD_HW_WMM_FORCE_0
...
#define BW160M_EXTREME_THROUGHPUT_TX_THRESHOLD 1300
#endif
#endif
...
#define CONFIG_RTW_AP_BS_DECT

/* Spatial reuse support */
#define CONFIG_RTW_SR_SUPPORT

#define CONFIG_WIFI_DIAGNOSIS

/* Tx time measurement based on tsf */
#define CONFIG_DELAY_MEASUREMENT
#define CONFIG_PHL_FREERUNCNT_DBG

/* Spare scan list for RM */
//#define RADIO_MEASUREMENT_SPARE_SCAN_LIST

/* Load rfe type and fem name from module parameter */
#ifdef CONFIG_LOAD_PHY_PARA_FROM_MODULE_PARA
#define CONFIG_RTW_ENABLE_SUB_TYPE
#define WKARD_EFEM_POWER_NULLDATA
#else
/* RF FEM config*/
	...
	defined(CONFIG_WLAN0_RFE_TYPE_94) || defined(CONFIG_WLAN1_RFE_TYPE_94)
...
#endif
#define CTC_QOS_DSCP
#define RECORD_ENV_STAINFO
#define REPORT_RADAR_DETECT
#endif
...
#define CMCC_OCTOSCOPE_DYNAMIC_ADD_POWER
#define CMCC_SHOW_STA_UNAMBIGUOUS_RX_RATE
#define CMCC_AUTO_DETECTION
#define RECORD_ENV_STAINFO
#define REPORT_RADAR_DETECT
#undef CONFIG_AUTOTEST_DETECT
#endif
...
#define SBWC
#endif
#endif /* CONFIG_AUTOTEST_DETECT */

/* Leverage FC SW shaping to achieve bandwidth control on 9607F + WFO */
#if (defined(SBWC) || defined(RTW_STA_BWC)) && \
	defined(CONFIG_RTL_WIFI_OFFLOAD) && defined(CONFIG_RTL9607F_SERIES)
#define FC_SBWC
#endif
