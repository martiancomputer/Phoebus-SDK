...
enum wlan_bw_2_web {
	WLAN_WEB_BW_20	  = 0,
	WLAN_WEB_BW_40	  = BIT0,
	/* BIT1 indicat shortGI for compatibility */
	WLAN_WEB_BW_80	  = BIT2,
	WLAN_WEB_BW_160	  = BIT3,
	WLAN_WEB_BW_80_80 = BIT4,
};
...
struct dot11k_beacon_measurement_report
{
	...
	unsigned char subelements[MAX_BEACON_LEN];
};
#pragma pack()
...
enum{
	...
	SIOCROSSBANDINFOREQ = 0x8CFC,
#endif

#ifdef BEACON_VS_IE
	SIOCGISETBCNVSIE = 0x9003,
	SIOCGISETPRBVSIE = 0x9004,
	SIOCGISETPRBRSPVSIE = 0x900E,
#endif

#ifdef CONFIG_IEEE80211V
	SIOCGICTCBSSTRANSREQ = 0x9007,
#endif
	RTL8192CD_IOCTL_BLOCK_STA = 0x9010,
#ifdef CONFIG_RTW_MULTI_AP
	SIOCMAP_GETWLANIFSTATE = 0x9011,
	SIOCMAP_GETRTLSTAMAC = 0x9012,
	SIOCMAP_GETRTLSTAINFO = 0x9013,
	SIOCMAP_SETRADIOCHANNEL = 0x9014,
#endif
};
