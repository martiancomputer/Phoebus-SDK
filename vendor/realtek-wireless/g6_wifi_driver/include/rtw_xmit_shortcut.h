...
#define AMSDU_1_SIZE (7991 - 192)
#define AMSDU_2_SIZE (11454 - 192)

#define AMSDU_0_MAX_NUM 2
#define AMSDU_1_MAX_NUM 5
#define AMSDU_2_MAX_NUM 7

#define HW_TIMER_TOL 500 /* us */
#define HW_TIMER_MIN 1000 /* us */
#define HW_TIMER_MAX 500000 /* us */
#define HW_TIMER_DELAY 50 /* us */
#define N_TIMEOUT 2
...
static inline void print_txreq_pklist(struct xmit_frame *pxframe, struct rtw_xmit_req *ptxreq, struct sk_buff *pskb, const char *func)
{
	extern u8 DBG_PRINT_TXREQ_ONCE;
	if(DBG_PRINT_TXREQ_ONCE == 1) {
		_print_txreq_pklist(pxframe, ptxreq, pskb, func);
