...
/* About USB VENDOR REQ */
	...
	//#define CONFIG_TX_BCAST2UNI /* AP mode support IP broadcast->unicast */
...
#define CONFIG_RTW_DEFAULT_EFEM_VALUE	0xFF
#define CONFIG_RTW_USING_IFEM		0x11
#define CONFIG_RTW_USING_EFEM		0xEE
#endif
...
#define MACID_NUM_SW_LIMIT (NUM_STA_TOTAL_LIMIT + CONFIG_IFACE_NUMBER)
#define SEC_CAM_ENT_NUM_SW_LIMIT (NUM_STA_TOTAL_LIMIT + CONFIG_IFACE_NUMBER)
