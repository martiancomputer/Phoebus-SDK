...
struct rtw_ieee80211_hdr_3addr_qos_htc {
	u16 frame_ctl;
	u16 duration_id;
	u8 addr1[ETH_ALEN];
	u8 addr2[ETH_ALEN];
...
#define WLAN_EID_EXTENDED_CHANNEL_SWITCH 60
...
#define WLAN_EID_INTER_AC_PRIO 184
...
/* EID Extension */
#ifdef CONFIG_HAPD_OWE
#define WLAN_EID_EXTENSION_OWE_DH_PARAM	32	// Diffie-Hellman Parameter element for OWE
#endif
#define WLAN_EID_EXTENSION_HE_CAPABILITY	35
#define WLAN_EID_EXTENSION_HE_OPERATION	36
#define WLAN_EID_EXTENSION_MU_EDCA	38
#define WLAN_EID_EXTENSION_MSCS_DESCRIPTOR 88
#define WLAN_EID_EXTENSION_TCLAS_MASK 89
#ifdef CONFIG_RTW_AP_BS_DECT
#define WLAN_EID_EXTENSION_BCC_ANOCE  42
#endif
...
const char *rate_section_str(u32 section);
...
enum rtw_ieee80211_category {
	...
	#ifdef CONFIG_QOS_MANAGEMENT
	RTW_WLAN_CATEGORY_ROBUST_AV = 19,
	#endif
	...
	RTW_WLAN_CATEGORY_VENDOR_SPECIFIC_PROTECTED = 126,
	RTW_WLAN_CATEGORY_P2P = 0x7f,/* P2P action frames */
};

#define QOS_MGMT_OUI_TYPE 0x1a
...
#define CATEGORY_IS_NON_ROBUST(cat) \
	...
	|| cat == RTW_WLAN_CATEGORY_UNPROTECTED_S1G \
...
#ifdef CONFIG_QOS_MANAGEMENT   /* Robust action code */
enum rtw_ieee80211_robust_av_actioncode {
	RTW_WLAN_ACTION_SCS_REQUEST = 0,
	RTW_WLAN_ACTION_SCS_RESPONSE = 1,
	RTW_WLAN_ACTION_GROUP_MEMBER_REQUEST = 2,
	RTW_WLAN_ACTION_GROUP_MEMBER_RESPONSE = 3,
	RTW_WLAN_ACTION_MSCS_REQUEST = 4,
	RTW_WLAN_ACTION_MSCS_RESPONSE = 5,
};
#endif
...
#define RTW_WLAN_SA_QUERY_REQUEST 0
#define RTW_WLAN_SA_QUERY_RESPONSE 1
#endif /* CONFIG_IEEE80211W */

#ifdef CONFIG_RTW_WNM
enum rtw_ieee80211_wnm_actioncode {
#ifdef CONFIG_RTW_AP_BS_DECT
	RTW_WLAN_ACTION_WNM_EVT_RPT = 1,
#endif
...
#ifdef CONFIG_RTW_AP_BS_DECT
#define RTW_WNM_IE_EVT_REQ 78
#define RTW_WNM_IE_EVT_RPT 79
#endif
...
enum rtw_ieee80211_vsp_qos_ouisubtype {
	RTW_WLAN_ACTION_VSP_QOS_DSCP_POLICY_QUERY = 0,
	RTW_WLAN_ACTION_VSP_QOS_DSCP_POLICY_REQ = 1,
	RTW_WLAN_ACTION_VSP_QOS_DSCP_POLICY_RESP = 2,
	_RTW_WLAN_ACTION_VSP_QOS_DSCP_POLICY_MAX
};
...
#ifdef CONFIG_RTW_AP_BS_DECT
u8 *rtw_set_ie_ex_bcc(u8 *buf, u32 *buf_len, u8 new_color, u8 countdown);
u8 *rtw_set_ie_ex_bc_change(u8 *buf, u32 *buf_len, u8 new_color, u8 countdown);
#endif
...
int rtw_parse_wpa2_ie(u8 *wpa_ie, int wpa_ie_len, int *group_cipher, int *pairwise_cipher, int *gmcs, u32 *akm, u8 *mfp_opt, u16 *pmkid_cnt);

#if defined(CONFIG_RTL_CFG80211_WAPI_SUPPORT)
int rtw_parse_wapi_ie(u8 *wapi_ie, int wapi_ie_len, int *group_cipher, int *pairwise_cipher, int *gmcs, u32 *akm, u16 *cap);
#endif
...
u8 *rtw_get_owe_transition_ie(const u8 *in_ie, uint in_len, u8 *owe_ie, uint *owe_ielen);
#endif
...
const char *action_public_str(u32 action);
