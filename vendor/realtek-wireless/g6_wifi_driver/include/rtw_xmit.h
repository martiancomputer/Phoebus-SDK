...
#define ATM_MODE_THROUGHPUT 0
#define ATM_MODE_PRECISE 1
#endif
...
struct xmit_frame_ack_rpt {
	...
	u32 ctx_buf_len;
	struct submit_ctx sctx; /* For wait for ack */
...
#ifdef CONFIG_ETHER_PKT_AGG
#define AMSDU_SUBFRAME_DIST_LEN		20
#endif
...
struct sta_xmit_priv {
	...
	_list tx_pending;
	_list ps_trigger;
	u8 ps_trigger_type;		/* BIT0: PS-Poll, BIT1 ~ 4: UAPSD trigger frame */
#ifdef CONFIG_ONE_TXQ
...
struct	xmit_priv	{
	...
	u64	tx_bytes;
	//RT_TRX_TRAFFIC
	u64	tx_bytes_per_band;
	u64	tx_bytes_per_band_last;
	u64	tx_pkts;
	u64	tx_uc_pkts;
	u64	tx_bc_pkts;
	u64	tx_mc_pkts;
...
#define MAX_AGG_PKT_NUM 256 /* Max tx ampdu coounts		 */
	...
	u32 cnt_txsc_amsdu_enq[8];
	u32 cnt_txsc_amsdu_enq_abort[8];
	u32 cnt_txsc_amsdu_deq[8];
	...
	u32 cnt_txsc_amsdu_timeout_ok[8];
	u32 cnt_txsc_amsdu_timeout_fail[8];
...
#ifdef CONFIG_ETHER_PKT_AGG
	u32 pe_ofld_tx_amsdu_subframes;
	u32 pe_ofld_tx_amsdus;
	u32 pe_ofld_tx_non_amsdu;
	u64 pe_ofld_tx_amsdu_bytes; /* sum of length of total amsdus in byte */
	u64 pe_ofld_tx_msdu_bytes; /* sum of length of total msdus included in amsdus in byte */
	u64 pe_ofld_tx_non_amsdu_bytes; /* sum of length of total non-amsdus in byte */
	u32 pe_ofld_tx_amsdu_subframe_dist[AMSDU_SUBFRAME_DIST_LEN]; /* distribution of number of amsdu subframes */
	u32 pe_ofld_tx_mismatch_amsdus; /* mismatch amsdu: amsdu length != total length of amsdu subframes included in amsdu */
	u32 pe_ofld_tx_broken_amsdus; /* broken amsdu: amsdu length <= 0 */
	u32 pe_ofld_tx_amsdu_priority_dist[8]; /* distribution of priorities of amsdus */
...
#define DELAY_RECORD_NUM 5
static const u32 DELAY_RECORD_SLOT[DELAY_RECORD_NUM] = {10, 30, 50, 100, 200};
#endif
...
enum rtw_phl_status rtw_count_pe_tx_stats(void *drv_priv, void *app);
u32 rtw_core_pe_trx_pause(void *drv_priv);
u32 rtw_core_pe_trx_resume(void *drv_priv);
