...
#define WLAN_EXT_CAP_MAXLEN	12
#define _WKARD_EXT_CAP_LENGTH_  8
...
/* HT control field */
#define SetVHTSupport(htc, vht)	SET_BITS_TO_LE_2BYTE(((u32 *)(htc)), 0, 1, vht)
#define SetHESupport(htc, he)	SET_BITS_TO_LE_2BYTE(((u32 *)(htc)), 1, 1, he)
#define SetControlID(htc, ctrl_id)	SET_BITS_TO_LE_2BYTE(((u32 *)(htc)), 2, 4, ctrl_id)
#define SetRxNSS(htc, rx_nss)	SET_BITS_TO_LE_2BYTE(((u32 *)(htc)), 6, 3, rx_nss)
#define SetChBw(htc, chbw)	SET_BITS_TO_LE_2BYTE(((u32 *)(htc)), 9, 2, chbw)
#define SetUlMuDisable(htc, ul_mu_disable)	SET_BITS_TO_LE_2BYTE(((u32 *)(htc)), 11, 1, ul_mu_disable)
#define SetTxNSTS(htc, tx_nsts)	SET_BITS_TO_LE_2BYTE(((u32 *)(htc)), 12, 3, tx_nsts)
...
#define MacAddr_isEqual(lhs,rhs) ((((unsigned long)(lhs)|(unsigned long)(rhs)) & 0x01) ? \
...
#define _QBSS_LOAD_ELEMENT_IE_		11
