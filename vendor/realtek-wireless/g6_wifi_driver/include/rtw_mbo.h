...
struct mbo_priv {
	...
	_timer disassoc_imminent_timer;
	u16 disassoc_imminent_step;
};

#define DISASSOC_IMMINENT_TIMEOUT_WKARD 500
enum {
	DISASSOC_IMMINENT_STEP_NONE = 0,
	DISASSOC_IMMINENT_STEP_SENT = 1,
	DISASSOC_IMMINENT_STEP_DONE = 2
};
