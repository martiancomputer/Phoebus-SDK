...
extern sint _rtw_init_recv_com_priv(struct recv_com_priv *precvpriv);
extern void _rtw_free_recv_com_priv(struct recv_com_priv *precvpriv);
...
extern sint rtw_os_rx_init(struct dvobj_priv *dvobj);
