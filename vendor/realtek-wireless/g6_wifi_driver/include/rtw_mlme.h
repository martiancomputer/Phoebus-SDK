...
/* Reasons to use association response generated by hostapd */
#define	ASSOC_REQ_DEFAULT_VALUE		0	// Use assoc rsp generated by driver
#define	ASSOC_REQ_HAS_PMKID		BIT0
#define	ASSOC_REQ_HAS_MOBILITY_DOMAIN	BIT1	// For 802.11r
#define	ASSOC_REQ_HAS_DH_PARAMS_IE	BIT2	// For OWE
...
enum STATUS_ENQ_SLEEP {
	STATUS_ENQ_SLEEP_NONE = 0,
	STATUS_ENQ_SLEEP_SUCCESS = 1,
	STATUS_ENQ_SLEEP_DROP = 2
};
...
#define RTW_WNM_EVT_BTM             0
#define RTW_WNM_EVT_RSNA            1
#define RTW_WNM_EVT_P2P_LINK        2
#define RTW_WNM_EVT_LOG             3
#define RTW_WNM_EVT_COLOR_COLLISION 4
#define RTW_WNM_EVT_COLOR_IN_USE    5

struct wnm_evt_rpt_elem {
...
struct mlme_priv {
	...
	u8 scan_deny_bypass; /* 0: disable bypass, 1: force bypass */
	u8 scan_deny_bypass_chk_cnt;
	u8 scan_deny_bypass_ready;
#endif
	...
	u8 ext_capab_ie_data[WLAN_EXT_CAP_MAXLEN];/*currently for ap mode only*/
	u8 ext_capab_ie_len;
	...
	u8 vendor_ie[WLAN_MAX_VENDOR_IE_NUM][WLAN_MAX_VENDOR_IE_LEN + 2];
	...
	systime vendor_ie_settime[WLAN_MAX_VENDOR_IE_NUM];
...
extern bool rtw_update_scanned_network(_adapter *adapter, WLAN_BSSID_EX *target, enum SCAN_LIST_TYPE scan_list_type);
...
extern void free_scanqueue(struct mlme_priv *pmlmepriv, enum SCAN_LIST_TYPE scan_list_type);
...
bool rtw_is_scan_deny_bypass(_adapter *adapter);
void rtw_clear_scan_deny(_adapter *adapter);
void rtw_set_scan_deny_timer_hdl(void *ctx);
void rtw_set_scan_deny(_adapter *adapter, u32 ms);
#else
#define rtw_is_scan_deny(adapter) _FALSE
#define rtw_is_scan_deny_bypass(adapter) _FALSE
...
extern struct wlan_network *_rtw_alloc_network(struct mlme_priv *pmlmepriv, enum SCAN_LIST_TYPE scan_list_type);
