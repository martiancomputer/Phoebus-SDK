...
#define GET_ROBUST_AV_ACTION_1BYTE(_pStart) \
		LE_BITS_TO_1BYTE(_pStart, 0, 8)
#define GET_ROBUST_AV_ACTION_2BYTE(_pStart) \
		LE_BITS_TO_2BYTE(_pStart, 0, 16)
#define GET_ROBUST_AV_ACTION_4BYTE(_pStart) \
		LE_BITS_TO_4BYTE(_pStart, 0, 32)

/************************************************************
GET Intra-Access Priority: _pStart = start of Intra-Access Category Priority
************************************************************/
#define GET_INTRA_ACCESS_UP(_pStart) \
	LE_BITS_TO_1BYTE(_pStart, 0, 3)
#define GET_INTRA_ACCESS_ALTERNATE_QUEUE(_pStart) \
	LE_BITS_TO_1BYTE(_pStart, 3, 1)
#define GET_INTRA_ACCE_DROP_ELIGIBILITY(_pStart) \
...
#else
#define GET_ROBUST_AV_ACTION_1BYTE(_pStart) \
		BE_BITS_TO_1BYTE(_pStart, 0, 8)
#define GET_ROBUST_AV_ACTION_2BYTE(_pStart) \
		BE_BITS_TO_2BYTE(_pStart, 0, 16)
#define GET_ROBUST_AV_ACTION_4BYTE(_pStart) \
		BE_BITS_TO_4BYTE(_pStart, 0, 32)
/************************************************************
GET Intra-Access Priority: _pStart = start of Intra-Access Category Priority
************************************************************/
#define GET_INTRA_ACCESS_UP(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 0, 3)
#define GET_INTRA_ACCESS_ALTERNATE_QUEUE(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 3, 1)
#define GET_INTRA_ACCE_DROP_ELIGIBILITY(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 4, 1)
/************************************************************
GET QoS Characteristics - Control Info subfield: _pStart = start of Control Info subfield
************************************************************/
#define GET_QOS_CONTROL_INFO_DIRECTION(_pStart) \
		BE_BITS_TO_4BYTE(_pStart, 0, 2)
#define GET_QOS_CONTROL_INFO_TID(_pStart) \
		BE_BITS_TO_4BYTE(_pStart, 2, 4)
#define GET_QOS_CONTROL_INFO_USER_PRIORITY(_pStart) \
		BE_BITS_TO_4BYTE(_pStart, 6, 3)
#define GET_QOS_CONTROL_INFO_BITMAP(_pStart) \
		BE_BITS_TO_4BYTE(_pStart, 9, 16)
#define GET_QOS_CONTROL_INFO_LINKID(_pStart) \
		BE_BITS_TO_4BYTE(_pStart, 25, 4)
/************************************************************
SET QoS Characteristics - Control Info subfield: _pStart = start of Control Info subfield
************************************************************/
#define SET_QOS_CONTROL_INFO_DIRECTION(_pStart, _val) \
		SET_BITS_TO_BE_4BYTE(_pStart, 0, 2, _val)
#define SET_QOS_CONTROL_INFO_TID(_pStart, _val) \
		SET_BITS_TO_BE_4BYTE(_pStart, 2, 4, _val)
#define SET_QOS_CONTROL_INFO_USER_PRIORITY(_pStart, _val) \
		SET_BITS_TO_BE_4BYTE(_pStart, 6, 3, _val)
#define SET_QOS_CONTROL_INFO_BITMAP(_pStart, _val) \
		SET_BITS_TO_BE_4BYTE(_pStart, 9, 16, _val)
#define SET_QOS_CONTROL_INFO_LINKID(_pStart, _val) \
		SET_BITS_TO_BE_4BYTE(_pStart, 25, 4, _val)

/************************************************************
GET QoS Characteristics Presence: _pStart = start of Control Info subfield
************************************************************/
#define GET_QOS_ELE_MAX_MSDU_SIZE_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 9, 1)
#define GET_QOS_ELE_SERVICE_START_TIME_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 10, 1)
#define GET_QOS_ELE_MEAN_DATA_RATE_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 11, 1)
#define GET_QOS_ELE_BURST_SIZE_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 12, 1)
#define GET_QOS_ELE_MSDU_LIFETIME_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 13, 1)
#define GET_QOS_ELE_MSDU_DELIVERY_RATIO_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 14, 1)
#define GET_QOS_ELE_MSDU_COUNT_EXPONENT_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 15, 1)
#define GET_QOS_ELE_MEDIUM_TIME_PRESENT(_pStart) \
	BE_BITS_TO_4BYTE(_pStart, 16, 1)
/************************************************************
GET QoS Characteristics subfield: _pStart = start of QoS Characteristics subfield
************************************************************/
#define GET_QOS_ELE_LENGTH(_pStart) \
...
************************************************************/
#define SET_QOS_ELE_MINIMUM_SERVICE_INTERVAL(_pStart, _val) \
	SET_BITS_TO_BE_4BYTE(_pStart, 0, 32, _val)
#define SET_QOS_ELE_MAXIMUM_SERVICE_INTERVAL(_pStart, _val) \
	SET_BITS_TO_BE_4BYTE(_pStart, 0, 32, _val)
#define SET_QOS_ELE_MINIMUM_DATA_RATE(_pStart, _val) \
	SET_BITS_TO_BE_4BYTE(_pStart, 0, 24, _val)
#define SET_QOS_ELE_DELAY_BOUND(_pStart, _val) \
	SET_BITS_TO_BE_4BYTE(_pStart, 0, 24, _val)
#define SET_QOS_ELE_MAXIMUM_MSDU_SIZE(_pStart, _val) \
...
#define SET_QOS_ELE_MSDU_LIFETIME(_pStart, _val) \
	SET_BITS_TO_BE_2BYTE(_pStart, 0, 16, _val)
#define SET_QOS_ELE_MSDU_DELIVERY_RATIO(_pStart, _val) \
	SET_BITS_TO_BE_1BYTE(_pStart, 0, 8, _val)
#define SET_QOS_ELE_MSDU_COUNT_EXPONENT(_pStart, _val) \
	SET_BITS_TO_BE_1BYTE(_pStart, 0, 8, _val)
#define SET_QOS_ELE_MEDIUM_TIME(_pStart, _val) \
	SET_BITS_TO_BE_1BYTE(_pStart, 0, 8, _val)
...
************************************************************/
#define GET_TYPE_0_SOURCE_ADDRESS_PRESENT(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 0, 1)
#define GET_TYPE_0_DESTINATION_ADDRESS_PRESENT(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 1, 1)
#define GET_TYPE_0_TYPE_PRESENT(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 2, 1)
...
#define GET_TYPE_1_DESTINATION_PORT_PRESENT(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 4, 1)
#define GET_TYPE_1_DSCP_PRESENT(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 5, 1)
#define GET_TYPE_1_PROTOCOL_PRESENT(_pStart) \
	BE_BITS_TO_1BYTE(_pStart, 6, 1)
/************************************************************
GET TCLAS - Type 4 Presence: _pStart = start of Classifier Mask subfield
************************************************************/
#define GET_TYPE_4_VERSION_PRESENT(_pStart) \
...
#define GET_TYPE_4_PROTOCOL_OR_NEXTHEADR_PRESENT(_pStart) \
		BE_BITS_TO_1BYTE(_pStart, 6, 1)
#define GET_TYPE_4_FLOW_LABEL_PRESENT(_pStart) \
		BE_BITS_TO_1BYTE(_pStart, 7, 1)
/************************************************************
 SET Intra-Access Category Priority Elmement : _pStart = start of Intra-Access Priority subfield
 ************************************************************/
#define SET_IACP_USER_PRIORITY(_pStart, _val) \
		SET_BITS_TO_BE_1BYTE(_pStart, 0, 3, _val)
#define SET_IACP_ALTERNATE_QUEUE(_pStart, _val) \
		SET_BITS_TO_BE_1BYTE(_pStart, 3, 1, _val)
#define SET_IACP_DROP_ELIGIBILITY(_pStart, _val) \
		SET_BITS_TO_BE_1BYTE(_pStart, 4, 1, _val)
/************************************************************
 SET TCLAS Elmement (type 4) : _pStart = start of Classifier Parameters subfield
 ************************************************************/
#define SET_TYPE_4_VERSION(_pStart, _val) \
...
#define HE_CAP_ELE_PPE_RU_INDEX_BITMASK_242		BIT(0)
#define HE_CAP_ELE_PPE_RU_INDEX_BITMASK_484		BIT(1)
#define HE_CAP_ELE_PPE_RU_INDEX_BITMASK_996		BIT(2)
#define HE_CAP_ELE_PPE_RU_INDEX_BITMASK_2_996	BIT(3)

#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_BPSK			0x0
#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_QPSK			0x1
#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_16QAM		0x2
#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_64QAM		0x3
#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_256QAM		0x4
#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_1024QAM		0x5
#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_RESERVED		0x6
#define HE_CAP_ELE_PPE_CONSTELLATION_INDEX_NONE			0x7
