...
int wfo_dbgdump(const char *fmt, ...);
int wfo_seqdump(const char *fmt, ...);
	#define _dbgdump wfo_dbgdump //printk
...
int proc_get_rm_survey_info(struct seq_file *m, void *v);
#endif
#ifdef CONFIG_RTW_MULTI_AP
int proc_get_map_survey_info(struct seq_file *m, void *v);
int proc_get_map_block_list(struct seq_file *m, void *v);
#ifdef DEBUG_MAP_UNASSOC
int proc_get_map_unassoc_sta(struct seq_file *m, void *v);
#endif
#endif
