 ...
 */
extern rtksw_api_ret_t rtksw_cpu_enable_set(rtksw_enable_t enable);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_enable_get(rtksw_enable_t *pEnable);
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern rtksw_api_ret_t rtksw_cpu_tagPort_set(rtksw_port_t port, rtksw_cpu_insert_t mode);
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern rtksw_api_ret_t rtksw_cpu_tagPort_get(rtksw_port_t *pPort, rtksw_cpu_insert_t *pMode);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_awarePort_set(rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_awarePort_get(rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_tagPosition_set(rtksw_cpu_position_t position);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_tagPosition_get(rtksw_cpu_position_t *pPosition);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_tagLength_set(rtksw_cpu_tag_length_t length);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_tagLength_get(rtksw_cpu_tag_length_t *pLength);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_acceptLength_set(rtksw_cpu_rx_length_t length);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_acceptLength_get(rtksw_cpu_rx_length_t *pLength);
 ...
 */
extern rtksw_api_ret_t rtksw_cpu_priRemap_set(rtksw_pri_t int_pri, rtksw_pri_t new_pri);
 ...
 *      Priority of CPU tag assignment for internal asic priority, and it is used for queue usage and packet scheduling.
 */
extern rtksw_api_ret_t rtksw_cpu_priRemap_get(rtksw_pri_t int_pri, rtksw_pri_t *pNew_pri);
