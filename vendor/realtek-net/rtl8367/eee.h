 ...
 */
extern rtksw_api_ret_t rtksw_eee_init(void);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t rtksw_eee_portEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t rtksw_eee_portEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
