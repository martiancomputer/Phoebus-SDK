 ...
 */
rtksw_api_ret_t rtksw_ptp_init(void)
{
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_mac_set(rtksw_mac_t mac)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_mac_get(rtksw_mac_t *pMac)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_tpid_set(rtksw_ptp_tpid_t outerId, rtksw_ptp_tpid_t innerId)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_tpid_get(rtksw_ptp_tpid_t *pOuterId, rtksw_ptp_tpid_t *pInnerId)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_refTime_set(rtksw_ptp_timeStamp_t timeStamp)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_refTime_get(rtksw_ptp_timeStamp_t *pTimeStamp)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_ptp_refTimeAdjust_set(rtksw_ptp_sys_adjust_t sign, rtksw_ptp_timeStamp_t timeStamp)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_refTimeEnable_set(rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_refTimeEnable_get(rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_portEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_portEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_portTimestamp_get( rtksw_port_t port, rtksw_ptp_msgType_t type, rtksw_ptp_info_t *pInfo)
{
    rtksw_api_ret_t retVal;
 ...
 *          PTP_INT_TYPE_ALL,
 */
rtksw_api_ret_t rtksw_ptp_intControl_set(rtksw_ptp_intType_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *          PTP_INT_TYPE_RX_PDELAY_RESP,
 */
rtksw_api_ret_t rtksw_ptp_intControl_get(rtksw_ptp_intType_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_ptp_intStatus_get(rtksw_ptp_intStatus_t *pStatusMask)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_ptp_portIntStatus_set(rtksw_port_t port, rtksw_ptp_intStatus_t statusMask)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_ptp_portIntStatus_get(rtksw_port_t port, rtksw_ptp_intStatus_t *pStatusMask)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_portTrap_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_ptp_portTrap_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
