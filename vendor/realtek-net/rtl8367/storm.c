 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlMeterIdx_set(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_uint32 index)
{
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlMeterIdx_get(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlPortEnable_set(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlPortEnable_get(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - BYPASS_LLDP.
 */
rtksw_api_ret_t rtksw_storm_bypass_set(rtksw_storm_bypass_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - BYPASS_LLDP.
 */
rtksw_api_ret_t rtksw_storm_bypass_get(rtksw_storm_bypass_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtPortmask_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtPortmask_get(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtEnable_set(rtksw_rate_storm_group_t stormType, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtEnable_get(rtksw_rate_storm_group_t stormType, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtMeterIdx_set(rtksw_rate_storm_group_t stormType, rtksw_uint32 index)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_rate_stormControlExtMeterIdx_get(rtksw_rate_storm_group_t stormType, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
