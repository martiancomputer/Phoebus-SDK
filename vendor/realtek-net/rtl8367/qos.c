 ...
 */
rtksw_api_ret_t rtksw_qos_init(rtksw_queue_num_t queueNum)
{
 ...
 *      - PRIDEC_SA
 */
rtksw_api_ret_t rtksw_qos_priSel_set(rtksw_qos_priDecTbl_t index, rtksw_priority_select_t *pPriDec)
{
    rtksw_api_ret_t retVal;
 ...
 *      - PRIDEC_SA,
 */
rtksw_api_ret_t rtksw_qos_priSel_get(rtksw_qos_priDecTbl_t index, rtksw_priority_select_t *pPriDec)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_1pPriRemap_set(rtksw_pri_t dot1p_pri, rtksw_pri_t int_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_1pPriRemap_get(rtksw_pri_t dot1p_pri, rtksw_pri_t *pInt_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_dscpPriRemap_set(rtksw_dscp_t dscp, rtksw_pri_t int_pri)
{
    rtksw_api_ret_t retVal;
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
rtksw_api_ret_t rtksw_qos_dscpPriRemap_get(rtksw_dscp_t dscp, rtksw_pri_t *pInt_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_portPri_set(rtksw_port_t port, rtksw_pri_t int_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_portPri_get(rtksw_port_t port, rtksw_pri_t *pInt_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_queueNum_set(rtksw_port_t port, rtksw_queue_num_t queue_num)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_queueNum_get(rtksw_port_t port, rtksw_queue_num_t *pQueue_num)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_priMap_set(rtksw_queue_num_t queue_num, rtksw_qos_pri2queue_t *pPri2qid)
{
    rtksw_api_ret_t retVal;
 ...
 *      The queue number is from 1 to 8.
 */
rtksw_api_ret_t rtksw_qos_priMap_get(rtksw_queue_num_t queue_num, rtksw_qos_pri2queue_t *pPri2qid)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_schedulingQueue_set(rtksw_port_t port, rtksw_qos_queue_weights_t *pQweights)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_schedulingQueue_get(rtksw_port_t port, rtksw_qos_queue_weights_t *pQweights)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t rtksw_qos_1pRemarkEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t rtksw_qos_1pRemarkEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_1pRemark_set(rtksw_pri_t int_pri, rtksw_pri_t dot1p_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_1pRemark_get(rtksw_pri_t int_pri, rtksw_pri_t *pDot1p_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_1pRemarkSrcSel_set(rtksw_qos_1pRmkSrc_t type)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_qos_1pRemarkSrcSel_get(rtksw_qos_1pRmkSrc_t *pType)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t rtksw_qos_dscpRemarkEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t rtksw_qos_dscpRemarkEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_dscpRemark_set(rtksw_pri_t int_pri, rtksw_dscp_t dscp)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_dscpRemark_get(rtksw_pri_t int_pri, rtksw_dscp_t *pDscp)
{
    rtksw_api_ret_t retVal;
 ...
 *      priority to TX DSCP value.
 */
rtksw_api_ret_t rtksw_qos_dscpRemarkSrcSel_set(rtksw_qos_dscpRmkSrc_t type)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t rtksw_qos_dscpRemarkSrcSel_get(rtksw_qos_dscpRmkSrc_t *pType)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_dscpRemark2Dscp_set(rtksw_dscp_t dscp, rtksw_dscp_t rmkDscp)
{
    rtksw_api_ret_t retVal;
 ...
 *      None.
 */
rtksw_api_ret_t rtksw_qos_dscpRemark2Dscp_get(rtksw_dscp_t dscp, rtksw_dscp_t *pDscp)
{
    rtksw_api_ret_t retVal;
 ...
 *      The API can set priority of port assignments for queue usage and packet scheduling.
 */
rtksw_api_ret_t rtksw_qos_portPriSelIndex_set(rtksw_port_t port, rtksw_qos_priDecTbl_t index)
{
    rtksw_api_ret_t retVal;
 ...
 *      The API can get priority of port assignments for queue usage and packet scheduling.
 */
rtksw_api_ret_t rtksw_qos_portPriSelIndex_get(rtksw_port_t port, rtksw_qos_priDecTbl_t *pIndex)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_schedulingType_set(rtksw_qos_scheduling_type_t queueType)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_qos_schedulingType_get(rtksw_qos_scheduling_type_t *pQueueType)
{
    rtksw_api_ret_t retVal;
