 ...
 */
rtksw_api_ret_t rtksw_trap_unknownUnicastPktAction_set(rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action)
{
 ...
 *          - UCAST_ACTION_FLOODING
 */
rtksw_api_ret_t rtksw_trap_unknownUnicastPktAction_get(rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t rtksw_trap_unknownMacPktAction_set(rtksw_trap_ucast_action_t ucast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_trap_unknownMacPktAction_get(rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t rtksw_trap_unmatchMacPktAction_set(rtksw_trap_ucast_action_t ucast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t rtksw_trap_unmatchMacPktAction_get(rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 * Note:
 */
rtksw_api_ret_t rtksw_trap_unmatchMacMoving_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 * Note:
 */
rtksw_api_ret_t rtksw_trap_unmatchMacMoving_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_trap_unknownMcastPktAction_set(rtksw_port_t port, rtksw_mcast_type_t type, rtksw_trap_mcast_action_t mcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t rtksw_trap_unknownMcastPktAction_get(rtksw_port_t port, rtksw_mcast_type_t type, rtksw_trap_mcast_action_t *pMcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_trap_lldpEnable_set(rtksw_enable_t enabled)
{
    rtksw_api_ret_t retVal;
 ...
 *      - 01:80:c2:00:00:00 ethertype = 0x88CC
 */
rtksw_api_ret_t rtksw_trap_lldpEnable_get(rtksw_enable_t *pEnabled)
{
    rtksw_api_ret_t retVal;
 ...
 *      - TRAP_REASON_IGMPMLD
 */
rtksw_api_ret_t rtksw_trap_reasonTrapToCpuPriority_set(rtksw_trap_reason_type_t type, rtksw_pri_t priority)
{
    rtksw_api_ret_t retVal;
 ...
 *      - TRAP_REASON_IGMPMLD
 */
rtksw_api_ret_t rtksw_trap_reasonTrapToCpuPriority_get(rtksw_trap_reason_type_t type, rtksw_pri_t *pPriority)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_trap_rmaAction_set(rtksw_trap_type_t type, rtksw_trap_rma_action_t rma_action)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
rtksw_api_ret_t rtksw_trap_rmaAction_get(rtksw_trap_type_t type, rtksw_trap_rma_action_t *pRma_action)
{
    rtksw_api_ret_t retVal;
 ...
 *      - TRAP_LLDP.
 */
rtksw_api_ret_t rtksw_trap_rmaKeepFormat_set(rtksw_trap_type_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - TRAP_LLDP.
 */
rtksw_api_ret_t rtksw_trap_rmaKeepFormat_get(rtksw_trap_type_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t rtksw_trap_portUnknownMacPktAction_set(rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t rtksw_trap_portUnknownMacPktAction_get(rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t rtksw_trap_portUnmatchMacPktAction_set(rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t rtksw_trap_portUnmatchMacPktAction_get(rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
