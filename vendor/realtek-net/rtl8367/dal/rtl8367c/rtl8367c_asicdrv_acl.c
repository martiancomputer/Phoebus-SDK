...
rtksw_uint16 Rtl8370sVirtualAclActTable[RTL8367C_ACLRULENO][RTL8367C_ACL_ACT_TABLE_LEN];
#endif
...
static void _rtl8367c_aclRuleStSmi2User( rtl8367c_aclrule *pAclUser, rtl8367c_aclrulesmi *pAclSmi)
{
    ...
    care_ptr = (rtksw_uint8*)&pAclSmi->care_bits_ext;
    data_ptr = (rtksw_uint8*)&pAclSmi->data_bits_ext;
...
/*
    Exchange structure type define with MMI and SMI
*/
static void _rtl8367c_aclActStSmi2User(rtl8367c_acl_act_t *pAclUser, rtksw_uint16 *pAclSmi)
{
...
/*
    Exchange structure type define with MMI and SMI
*/
static void _rtl8367c_aclActStUser2Smi(rtl8367c_acl_act_t *pAclUser, rtksw_uint16 *pAclSmi)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicAcl(rtksw_uint32 port, rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicAcl(rtksw_uint32 port, rtksw_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclUnmatchedPermit(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclUnmatchedPermit(rtksw_uint32 port, rtksw_uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 */
ret_t rtl8367c_setAsicAclRule(rtksw_uint32 index, rtl8367c_aclrule* pAclRule)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclRule(rtksw_uint32 index, rtl8367c_aclrule *pAclRule)
{
    rtl8367c_aclrulesmi aclRuleSmi;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclNot(rtksw_uint32 index, rtksw_uint32 not)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclNot(rtksw_uint32 index, rtksw_uint32* pNot)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 */
ret_t rtl8367c_setAsicAclTemplate(rtksw_uint32 index, rtl8367c_acltemplate_t* pAclType)
{
    ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 regAddr, regData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclTemplate(rtksw_uint32 index, rtl8367c_acltemplate_t *pAclType)
{
    ret_t retVal;
    rtksw_uint32 i;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclAct(rtksw_uint32 index, rtl8367c_acl_act_t* pAclAct)
{
    rtksw_uint16 aclActSmi[RTL8367C_ACL_ACT_TABLE_LEN];
    ret_t retVal;
    rtksw_uint32 regAddr, regData;
    rtksw_uint16* tableAddr;
    rtksw_uint32 i;
    ...
    memset(aclActSmi, 0x00, sizeof(rtksw_uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
...
#ifdef CONFIG_RTL8367C_ASICDRV_TEST
    memcpy(&Rtl8370sVirtualAclActTable[index][0], aclActSmi, sizeof(rtksw_uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
#endif
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclAct(rtksw_uint32 index, rtl8367c_acl_act_t *pAclAct)
{
    rtksw_uint16 aclActSmi[RTL8367C_ACL_ACT_TABLE_LEN];
    ret_t retVal;
    rtksw_uint32 regAddr, regData;
...
#ifdef CONFIG_RTL8367C_ASICDRV_TEST
    memcpy(aclActSmi, &Rtl8370sVirtualAclActTable[index][0], sizeof(rtksw_uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
#endif
 ...
 */
ret_t rtl8367c_setAsicAclActCtrl(rtksw_uint32 index, rtksw_uint32 aclActCtrl)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclActCtrl(rtksw_uint32 index, rtksw_uint32 *pAclActCtrl)
{
    ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclPortRange(rtksw_uint32 index, rtksw_uint32 type, rtksw_uint32 upperPort, rtksw_uint32 lowerPort)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclPortRange(rtksw_uint32 index, rtksw_uint32* pType, rtksw_uint32* pUpperPort, rtksw_uint32* pLowerPort)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclVidRange(rtksw_uint32 index, rtksw_uint32 type, rtksw_uint32 upperVid, rtksw_uint32 lowerVid)
{
    ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclVidRange(rtksw_uint32 index, rtksw_uint32* pType, rtksw_uint32* pUpperVid, rtksw_uint32* pLowerVid)
{
    ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclIpRange(rtksw_uint32 index, rtksw_uint32 type, ipaddr_t upperIp, ipaddr_t lowerIp)
{
    ret_t retVal;
    rtksw_uint32 regData;
    ipaddr_t ipData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclIpRange(rtksw_uint32 index, rtksw_uint32* pType, ipaddr_t* pUpperIp, ipaddr_t* pLowerIp)
{
    ret_t retVal;
    rtksw_uint32 regData;
    ipaddr_t ipData;
 ...
 *      none
 */
ret_t rtl8367c_setAsicAclGpioPolarity(rtksw_uint32 polarity)
{
 ...
 *      none
 */
ret_t rtl8367c_getAsicAclGpioPolarity(rtksw_uint32* pPolarity)
{
