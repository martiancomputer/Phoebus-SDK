 ...
 *      None
 */
ret_t rtl8367c_getAsicDebugInfo(rtksw_uint32 port, rtksw_uint32 *pDebugifo)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortJamMode(rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortJamMode(rtksw_uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMaxLengthCfg(rtksw_uint32 cfgId, rtksw_uint32 maxLength)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMaxLengthCfg(rtksw_uint32 cfgId, rtksw_uint32 *pMaxLength)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMaxLength(rtksw_uint32 port, rtksw_uint32 type, rtksw_uint32 cfgId)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMaxLength(rtksw_uint32 port, rtksw_uint32 type, rtksw_uint32 *pCfgId)
{
    ret_t retVal;
