 ...
 */
ret_t rtl8367c_getAsicGreenPortPage(rtksw_uint32 port, rtksw_uint32* pPage)
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 pageMeter;
 ...
 *      None
 */
ret_t rtl8367c_setAsicGreenTrafficType(rtksw_uint32 priority, rtksw_uint32 traffictype)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicGreenTrafficType(rtksw_uint32 priority, rtksw_uint32* pTraffictype)
{
    if(priority > RTL8367C_PRIMAX)
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 *      None
 */
ret_t rtl8367c_setAsicGreenHighPriorityTraffic(rtksw_uint32 port)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicGreenHighPriorityTraffic(rtksw_uint32 port, rtksw_uint32* pIndicator)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
...
/*
@func rtksw_int32 | rtl8367c_setAsicGreenEthernet | Set green ethernet function.
@parm rtksw_uint32 | green | Green feature function usage 1:enable 0:disable.
...
*/
ret_t rtl8367c_setAsicGreenEthernet(rtksw_uint32 port, rtksw_uint32 green)
{
    ret_t retVal;
    rtksw_uint32 checkCounter;
    rtksw_uint32 regData;
    rtksw_uint32 phy_status;
    rtksw_uint32 patchData[6][2] = { {0x809A, 0x8911}, {0x80A3, 0x9233}, {0x80AC, 0xA444}, {0x809F, 0x6B20}, {0x80A8, 0x6B22}, {0x80B1, 0x6B23} };
    rtksw_uint32 idx;
    rtksw_uint32 data;
...
/*
@func rtksw_int32 | rtl8367c_getAsicGreenEthernet | Get green ethernet function.
@parm rtksw_uint32 | *green | Green feature function usage 1:enable 0:disable.
@rvalue RT_ERR_OK | Success.
@rvalue RT_ERR_SMI | SMI access error.
@comm
 ...
 ports will enter power savining mode in 10 seconds after the cable disconnected if power saving function is enabled.
*/
ret_t rtl8367c_getAsicGreenEthernet(rtksw_uint32 port, rtksw_uint32* green)
{
    ret_t retVal;
    rtksw_uint32 regData;
...
@parm rtksw_uint32 | phy | phy number
@parm rtksw_uint32 | enable | enable power saving mode.
@rvalue RT_ERR_OK | Success.
@rvalue RT_ERR_SMI | SMI access error.
...
*/
ret_t rtl8367c_setAsicPowerSaving(rtksw_uint32 phy, rtksw_uint32 enable)
{
...
*/
ret_t rtl8367c_getAsicPowerSaving(rtksw_uint32 phy, rtksw_uint32* enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phyData;
