...
extern "C" {
#endif
extern ret_t rtl8367c_setAsicRegBit(rtksw_uint32 reg, rtksw_uint32 bit, rtksw_uint32 value);
extern ret_t rtl8367c_getAsicRegBit(rtksw_uint32 reg, rtksw_uint32 bit, rtksw_uint32 *pValue);

extern ret_t rtl8367c_setAsicRegBits(rtksw_uint32 reg, rtksw_uint32 bits, rtksw_uint32 value);
extern ret_t rtl8367c_getAsicRegBits(rtksw_uint32 reg, rtksw_uint32 bits, rtksw_uint32 *pValue);

extern ret_t rtl8367c_setAsicReg(rtksw_uint32 reg, rtksw_uint32 value);
extern ret_t rtl8367c_getAsicReg(rtksw_uint32 reg, rtksw_uint32 *pValue);
