 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_init(void)
{
    ...
    if ((retVal = rtl8367c_setAsicLutIpMulticastLookup(RTKSW_DISABLED)) != RT_ERR_OK)
        return retVal;

    /*Enable CAM Usage*/
    if ((retVal = rtl8367c_setAsicLutCamTbUsage(RTKSW_ENABLED)) != RT_ERR_OK)
        return retVal;
    ...
    {
        if ((retVal = rtl8367c_setAsicLutLearnLimitNo(rtksw_switch_port_L2P_get(port), rtksw_switch_maxLutAddrNumber_get())) != RT_ERR_OK)
            return retVal;
    }
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_addr_add(rtksw_mac_t *pMac, rtksw_l2_ucastAddr_t *pL2_data)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    ...
    if (pL2_data->sa_block>= RTKSW_ENABLE_END)
        return RT_ERR_INPUT;

    if (pL2_data->da_block>= RTKSW_ENABLE_END)
        return RT_ERR_INPUT;

    if (pL2_data->auth>= RTKSW_ENABLE_END)
        return RT_ERR_INPUT;
    ...
    if (pL2_data->sa_pri_en >= RTKSW_ENABLE_END)
        return RT_ERR_INPUT;

    if (pL2_data->fwd_pri_en >= RTKSW_ENABLE_END)
        return RT_ERR_INPUT;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_addr_get(rtksw_mac_t *pMac, rtksw_l2_ucastAddr_t *pL2_data)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_addr_next_get(rtksw_l2_read_method_t read_method, rtksw_port_t port, rtksw_uint32 *pAddress, rtksw_l2_ucastAddr_t *pL2_data)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      method;
    rtl8367c_luttb  l2Table;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_addr_del(rtksw_mac_t *pMac, rtksw_l2_ucastAddr_t *pL2_data)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_mcastAddr_add(rtksw_l2_mcastAddr_t *pMcastAddr)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      method;
    rtl8367c_luttb  l2Table;
    ...
    if(pMcastAddr->fwd_pri_en >= RTKSW_ENABLE_END)
        return RT_ERR_INPUT;
 ...
 *      the mac is learned. Otherwise, it will return a RT_ERR_L2_ENTRY_NOTFOUND error.
 */
rtksw_api_ret_t dal_rtl8367c_l2_mcastAddr_get(rtksw_l2_mcastAddr_t *pMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_mcastAddr_next_get(rtksw_uint32 *pAddress, rtksw_l2_mcastAddr_t *pMcastAddr)
{
    rtksw_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
 ...
 *      If the mac has existed in the LUT, it will be deleted. Otherwise, it will return RT_ERR_L2_ENTRY_NOTFOUND.
 */
rtksw_api_ret_t dal_rtl8367c_l2_mcastAddr_del(rtksw_l2_mcastAddr_t *pMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastAddr_add(rtksw_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    if(pIpMcastAddr->fwd_pri_en >= RTKSW_ENABLE_END)
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastAddr_get(rtksw_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastAddr_next_get(rtksw_uint32 *pAddress, rtksw_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtksw_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
    rtksw_uint32      tmpAddress;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastAddr_del(rtksw_l2_ipMcastAddr_t *pIpMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_add(rtksw_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    /* check port mask */
    RTKSW_CHK_PORTMASK_VALID(&pIpVidMcastAddr->portmask);
    ...
    /* Get Physical port mask */
    if ((retVal = rtksw_switch_portmask_L2P_get(&pIpVidMcastAddr->portmask, &pmask)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_get(rtksw_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
    ...
    pIpVidMcastAddr->address = l2Table.address;
     ...
     /* Get Logical port mask */
    if ((retVal = rtksw_switch_portmask_P2L_get(l2Table.mbr, &pIpVidMcastAddr->portmask)) != RT_ERR_OK)
        return retVal;
 ...
 *      as pAddress to call this API again for dumping all IP multicast entries is LUT.
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_next_get(rtksw_uint32 *pAddress, rtksw_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtksw_api_ret_t   retVal;
    rtl8367c_luttb  l2Table;
    rtksw_uint32      tmpAddress;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipVidMcastAddr_del(rtksw_l2_ipVidMcastAddr_t *pIpVidMcastAddr)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_ucastAddr_flush(rtksw_l2_flushCfg_t *pConfig)
{
    rtksw_api_ret_t   retVal;
    ...
    if(pConfig->flushByVid == RTKSW_ENABLED)
    {
        ...
        if ((retVal = rtl8367c_setAsicLutFlushType((pConfig->flushStaticAddr == RTKSW_ENABLED) ? FLUSHTYPE_BOTH : FLUSHTYPE_DYNAMIC)) != RT_ERR_OK)
            return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_table_clear(void)
{
    rtksw_api_ret_t   retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_table_clearStatus_get(rtksw_l2_clearStatus_t *pStatus)
{
    rtksw_api_ret_t   retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutFlushAllStatus((rtksw_uint32 *)pStatus)) != RT_ERR_OK)
        return retVal;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367c_l2_flushLinkDownPortAddrEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367c_l2_flushLinkDownPortAddrEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_agingEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicLutDisableAging(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_agingEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutDisableAging(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 *      to 2112.
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitLearningCnt_set(rtksw_port_t port, rtksw_mac_cnt_t mac_cnt)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicLutLearnLimitNo(rtksw_switch_port_L2P_get(port), mac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitLearningCnt_get(rtksw_port_t port, rtksw_mac_cnt_t *pMac_cnt)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutLearnLimitNo(rtksw_switch_port_L2P_get(port), pMac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 *      to 2112.
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitSystemLearningCnt_set(rtksw_mac_cnt_t mac_cnt)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitSystemLearningCnt_get(rtksw_mac_cnt_t *pMac_cnt)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitLearningCntAction_set(rtksw_port_t port, rtksw_l2_limitLearnCntAction_t action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 data;
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitLearningCntAction_get(rtksw_port_t port, rtksw_l2_limitLearnCntAction_t *pAction)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 action;
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntAction_set(rtksw_l2_limitLearnCntAction_t action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 data;
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntAction_get(rtksw_l2_limitLearnCntAction_t *pAction)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 action;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntPortMask_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_limitSystemLearningCntPortMask_get(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_learningCnt_get(rtksw_port_t port, rtksw_mac_cnt_t *pMac_cnt)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicLutLearnNo(rtksw_switch_port_L2P_get(port), pMac_cnt)) != RT_ERR_OK)
        return retVal;
 ...
 *      - FLOOD_BC
 */
rtksw_api_ret_t dal_rtl8367c_l2_floodPortMask_set(rtksw_l2_flood_type_t floood_type, rtksw_portmask_t *pFlood_portmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
 ...
 *      - FLOOD_BC
 */
rtksw_api_ret_t dal_rtl8367c_l2_floodPortMask_get(rtksw_l2_flood_type_t floood_type, rtksw_portmask_t *pFlood_portmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_localPktPermit_set(rtksw_port_t port, rtksw_enable_t permit)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicPortBlockSpa(rtksw_switch_port_L2P_get(port), permit)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_localPktPermit_get(rtksw_port_t port, rtksw_enable_t *pPermit)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicPortBlockSpa(rtksw_switch_port_L2P_get(port), pPermit)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_aging_set(rtksw_l2_age_time_t aging_time)
{
    rtksw_uint32 i;
    CONST_T rtksw_uint32 agePara[10][3] = {
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_aging_get(rtksw_l2_age_time_t *pAging_time)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i,time, speed;
    CONST_T rtksw_uint32 agePara[10][3] = {
        {45, 0, 1}, {88, 0, 2}, {133, 0, 3}, {177, 0, 4}, {221, 0, 5}, {266, 0, 6}, {310, 0, 7},
        {354, 2, 6}, {413, 2, 7}, {458, 3, 7}};
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastAddrLookup_set(rtksw_l2_ipmc_lookup_type_t type)
{
    rtksw_api_ret_t retVal;
    ...
    else if(type == LOOKUP_IP)
    {
        ...
        if ((retVal = rtl8367c_setAsicLutIpMulticastVidLookup(RTKSW_DISABLED))!=RT_ERR_OK)
            return retVal;
    ...
    else if(type == LOOKUP_IP_VID)
    {
        ...
        if ((retVal = rtl8367c_setAsicLutIpMulticastVidLookup(RTKSW_ENABLED))!=RT_ERR_OK)
            return retVal;
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastAddrLookup_get(rtksw_l2_ipmc_lookup_type_t *pType)
{
    rtksw_api_ret_t       retVal;
    rtksw_uint32          enabled, vid_lookup;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastForwardRouterPort_set(rtksw_enable_t enabled)
{
    rtksw_api_ret_t       retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastForwardRouterPort_get(rtksw_enable_t *pEnabled)
{
    rtksw_api_ret_t       retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastGroupEntry_add(ipaddr_t ip_addr, rtksw_uint32 vid, rtksw_portmask_t *pPortmask)
{
    rtksw_uint32      empty_idx = 0xFFFF;
    rtksw_int32       index;
    ipaddr_t        group_addr;
    rtksw_uint32      group_vid;
    rtksw_uint32      pmask;
    rtksw_uint32      valid;
    ...
    {
        if ((retVal = rtl8367c_getAsicLutIPMCGroup((rtksw_uint32)index, &group_addr, &group_vid, &pmask, &valid))!=RT_ERR_OK)
            return retVal;

        if( (valid == RTKSW_ENABLED) && (group_addr == ip_addr) && (group_vid == vid) )
        {
    ...
    pmask = physicalPortmask;
    if ((retVal = rtl8367c_setAsicLutIPMCGroup(empty_idx, ip_addr, vid, pmask, RTKSW_ENABLED))!=RT_ERR_OK)
        return retVal;
 ...
 *      Delete an entry from IP Multicast group table.
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastGroupEntry_del(ipaddr_t ip_addr, rtksw_uint32 vid)
{
    rtksw_int32       index;
    ipaddr_t        group_addr;
    rtksw_uint32      group_vid;
    ...
    for(index = 0; index <= RTL8367C_LUT_IPMCGRP_TABLE_MAX; index++)
    {
        ...
        if( (valid == RTKSW_ENABLED) && (group_addr == ip_addr) && (group_vid == vid) )
        {
            ...
            group_vid = 0;
            pmask = 0;
            if ((retVal = rtl8367c_setAsicLutIPMCGroup(index, group_addr, group_vid, pmask, RTKSW_DISABLED))!=RT_ERR_OK)
                return retVal;
 ...
 *      Delete an entry from IP Multicast group table.
 */
rtksw_api_ret_t dal_rtl8367c_l2_ipMcastGroupEntry_get(ipaddr_t ip_addr, rtksw_uint32 vid, rtksw_portmask_t *pPortmask)
{
    rtksw_int32       index;
    ipaddr_t        group_addr;
    rtksw_uint32      group_vid;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_l2_entry_get(rtksw_l2_addr_table_t *pL2_entry)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 method;
    rtl8367c_luttb l2Table;
