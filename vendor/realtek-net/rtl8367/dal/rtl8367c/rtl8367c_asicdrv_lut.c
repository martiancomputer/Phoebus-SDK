...
static void _rtl8367c_fdbStUser2Smi( rtl8367c_luttb *pLutSt, rtksw_uint16 *pFdbSmi)
{
    /* L3 lookup */
    if(pLutSt->l3lookup)
    {
...
static void _rtl8367c_fdbStSmi2User( rtl8367c_luttb *pLutSt, rtksw_uint16 *pFdbSmi)
{
    /*L3 lookup*/
    if(pFdbSmi[3] & 0x1000)
    {
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpMulticastLookup(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpMulticastLookup(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpMulticastVidLookup(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpMulticastVidLookup(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpLookupMethod(rtksw_uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpLookupMethod(rtksw_uint32* pType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutAgeTimerSpeed(rtksw_uint32 timer, rtksw_uint32 speed)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutAgeTimerSpeed(rtksw_uint32* pTimer, rtksw_uint32* pSpeed)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutCamTbUsage(rtksw_uint32 enabled)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutCamTbUsage(rtksw_uint32* pEnabled)
{
    ret_t       retVal;
    rtksw_uint32  regData;
...
ret_t rtl8367c_setAsicLutLearnLimitNo(rtksw_uint32 port, rtksw_uint32 number)
{
...
ret_t rtl8367c_getAsicLutLearnLimitNo(rtksw_uint32 port, rtksw_uint32* pNumber)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
...
ret_t rtl8367c_setAsicSystemLutLearnLimitNo(rtksw_uint32 number)
{
    if(number > RTL8367C_LUT_LEARNLIMITMAX)
        return RT_ERR_LIMITED_L2ENTRY_NUM;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSystemLutLearnLimitNo(rtksw_uint32 *pNumber)
{
    if(NULL == pNumber)
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutLearnOverAct(rtksw_uint32 action)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutLearnOverAct(rtksw_uint32* pAction)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSystemLutLearnOverAct(rtksw_uint32 action)
{
    if(action >= LRNOVERACT_END)
        return RT_ERR_NOT_ALLOWED;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSystemLutLearnOverAct(rtksw_uint32 *pAction)
{
    if(NULL == pAction)
        return RT_ERR_NULL_POINTER;
...
ret_t rtl8367c_setAsicSystemLutLearnPortMask(rtksw_uint32 portmask)
{
    ret_t retVal;
 ...
 */
 /*修改: RTL8367C_LUT_SYSTEM_LEARN_PMASK_MASK*/
ret_t rtl8367c_getAsicSystemLutLearnPortMask(rtksw_uint32 *pPortmask)
{
    rtksw_uint32 tmpmask;
    ret_t retVal;
...
ret_t rtl8367c_setAsicL2LookupTb(rtl8367c_luttb *pL2Table)
{
    ...
    rtksw_uint32 i;
    rtksw_uint16 smil2Table[RTL8367C_LUT_TABLE_SIZE];
    rtksw_uint32 tblCmd;
    rtksw_uint32 busyCounter;

    memset(smil2Table, 0x00, sizeof(rtksw_uint16) * RTL8367C_LUT_TABLE_SIZE);
 ...
 *      None
 */
ret_t rtl8367c_getAsicL2LookupTb(rtksw_uint32 method, rtl8367c_luttb *pL2Table)
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint16* accessPtr;
...
ret_t rtl8367c_getAsicLutLearnNo(rtksw_uint32 port, rtksw_uint32* pNumber)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushAllStatus(rtksw_uint32 *pBusyStatus)
{
    if(NULL == pBusyStatus)
        return RT_ERR_NULL_POINTER;
...
ret_t rtl8367c_setAsicLutForceFlush(rtksw_uint32 portmask)
{
    ret_t retVal;
 ...
 */
 /*port8~port10的设置在另外一个register, wait for updating of base.h, reg.h*/
ret_t rtl8367c_getAsicLutForceFlushStatus(rtksw_uint32 *pPortmask)
{
    rtksw_uint32 tmpMask;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushMode(rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushMode(rtksw_uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushType(rtksw_uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushType(rtksw_uint32* pType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushVid(rtksw_uint32 vid)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushVid(rtksw_uint32* pVid)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushFid(rtksw_uint32 fid)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushFid(rtksw_uint32* pFid)
{
...
ret_t rtl8367c_setAsicLutDisableAging(rtksw_uint32 port, rtksw_uint32 disabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 */
 /*修改RTL8367C_PORTIDMAX*/
ret_t rtl8367c_getAsicLutDisableAging(rtksw_uint32 port, rtksw_uint32 *pDisabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIPMCGroup(rtksw_uint32 index, ipaddr_t group_addr, rtksw_uint32 vid, rtksw_uint32 pmask, rtksw_uint32 valid)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIPMCGroup(rtksw_uint32 index, ipaddr_t *pGroup_addr, rtksw_uint32 *pVid, rtksw_uint32 *pPmask, rtksw_uint32 *pValid)
{
    rtksw_uint32      regAddr, regData, bitoffset;
    ipaddr_t    ipData;
    ret_t       retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutLinkDownForceAging(rtksw_uint32 enable)
{
    if(enable > 1)
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutLinkDownForceAging(rtksw_uint32 *pEnable)
{
    rtksw_uint32  value;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpmcFwdRouterPort(rtksw_uint32 enable)
{
    if(enable > 1)
        return RT_ERR_ENABLE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpmcFwdRouterPort(rtksw_uint32 *pEnable)
{
    if(NULL == pEnable)
        return RT_ERR_NULL_POINTER;
