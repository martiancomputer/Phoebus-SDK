 ...
 *      None
 */
ret_t rtl8367c_setAsicPortIsolationPermittedPortmask(rtksw_uint32 port, rtksw_uint32 permitPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIsolationPermittedPortmask(rtksw_uint32 port, rtksw_uint32 *pPermitPortmask)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 */
ret_t rtl8367c_setAsicPortIsolationEfid(rtksw_uint32 port, rtksw_uint32 efid)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIsolationEfid(rtksw_uint32 port, rtksw_uint32 *pEfid)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
