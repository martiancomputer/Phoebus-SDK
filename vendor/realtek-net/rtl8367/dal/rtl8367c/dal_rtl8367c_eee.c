 ...
 */
rtksw_api_ret_t dal_rtl8367c_eee_init(void)
{
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367c_eee_portEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t   retVal;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367c_eee_portEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData1, regData2;
    rtksw_uint32    phy_port;
