 ...
 *      None
 */
ret_t rtl8367c_setAsicShareMeter(rtksw_uint32 index, rtksw_uint32 rate, rtksw_uint32 ifg)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicShareMeter(rtksw_uint32 index, rtksw_uint32 *pRate, rtksw_uint32 *pIfg)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicShareMeterBucketSize(rtksw_uint32 index, rtksw_uint32 lbthreshold)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicShareMeterBucketSize(rtksw_uint32 index, rtksw_uint32 *pLbthreshold)
{
    if(index > RTL8367C_METERMAX)
        return RT_ERR_FILTER_METER_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicShareMeterType(rtksw_uint32 index, rtksw_uint32 type)
{
    rtksw_uint32 reg;
 ...
 *      None
 */
ret_t rtl8367c_getAsicShareMeterType(rtksw_uint32 index, rtksw_uint32 *pType)
{
    rtksw_uint32 reg;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMeterExceedStatus(rtksw_uint32 index)
{
    if(index > RTL8367C_METERMAX)
        return RT_ERR_FILTER_METER_ID;
 ...
 */
ret_t rtl8367c_getAsicMeterExceedStatus(rtksw_uint32 index, rtksw_uint32* pStatus)
{
    if(index > RTL8367C_METERMAX)
        return RT_ERR_FILTER_METER_ID;
