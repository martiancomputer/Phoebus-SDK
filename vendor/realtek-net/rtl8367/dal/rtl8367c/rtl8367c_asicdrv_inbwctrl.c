 ...
 *      None
 */
ret_t rtl8367c_setAsicPortIngressBandwidth(rtksw_uint32 port, rtksw_uint32 bandwidth, rtksw_uint32 preifg, rtksw_uint32 enableFC)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIngressBandwidth(rtksw_uint32 port, rtksw_uint32* pBandwidth, rtksw_uint32* pPreifg, rtksw_uint32* pEnableFC)
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 regAddr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortIngressBandwidthBypass(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIngressBandwidthBypass(rtksw_uint32* pEnabled)
{
