 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_int_polarity_set(rtksw_int_polarity_t type);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_int_polarity_get(rtksw_int_polarity_t *pType);
 ...
 *      - INT_TYPE_SLIENT
 */
extern rtksw_api_ret_t dal_rtl8367c_int_control_set(rtksw_int_type_t type, rtksw_enable_t enable);
 ...
 *      - INT_TYPE_SLIENT
 */
extern rtksw_api_ret_t dal_rtl8367c_int_control_get(rtksw_int_type_t type, rtksw_enable_t* pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_int_status_set(rtksw_int_status_t *pStatusMask);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367c_int_status_get(rtksw_int_status_t* pStatusMask);
 ...
 *      The status will be cleared after execute this API.
 */
extern rtksw_api_ret_t dal_rtl8367c_int_advanceInfo_get(rtksw_int_advType_t adv_type, rtksw_int_info_t* info);
