 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_global_reset(void);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_port_reset(rtksw_port_t port);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_queueManage_reset(void);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_global_get(rtksw_stat_global_type_t cntr_idx, rtksw_stat_counter_t *pCntr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_global_getAll(rtksw_stat_global_cntr_t *pGlobal_cntrs);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_port_get(rtksw_port_t port, rtksw_stat_port_type_t cntr_idx, rtksw_stat_counter_t *pCntr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_port_getAll(rtksw_port_t port, rtksw_stat_port_cntr_t *pPort_cntrs);
 ...
 *      Set the type and mode of Logging Counter.
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_logging_counterCfg_set(rtksw_uint32 idx, rtksw_logging_counter_mode_t mode, rtksw_logging_counter_type_t type);
 ...
 *      Get the type and mode of Logging Counter.
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_logging_counterCfg_get(rtksw_uint32 idx, rtksw_logging_counter_mode_t *pMode, rtksw_logging_counter_type_t *pType);
 ...
 *      Reset Logging Counter.
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_logging_counter_reset(rtksw_uint32 idx);
 ...
 *      Get Logging Counter.
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_logging_counter_get(rtksw_uint32 idx, rtksw_uint32 *pCnt);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_lengthMode_set(rtksw_stat_lengthMode_t txMode, rtksw_stat_lengthMode_t rxMode);
 ...
 * Note:
 */
extern rtksw_api_ret_t dal_rtl8367c_stat_lengthMode_get(rtksw_stat_lengthMode_t *pTxMode, rtksw_stat_lengthMode_t *pRxMode);
