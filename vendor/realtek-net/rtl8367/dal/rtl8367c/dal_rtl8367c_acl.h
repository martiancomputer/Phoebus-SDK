 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_init(void);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_field_add(rtksw_filter_cfg_t *pFilter_cfg, rtksw_filter_field_t *pFilter_field);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_add(rtksw_filter_id_t filter_id, rtksw_filter_cfg_t *pFilter_cfg, rtksw_filter_action_t *pAction, rtksw_filter_number_t *ruleNum);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_del(rtksw_filter_id_t filter_id);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_delAll(void);
 ...
 *      This function delete all ACL configuration from ASIC.
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_get(rtksw_filter_id_t filter_id, rtksw_filter_cfg_raw_t *pFilter_cfg, rtksw_filter_action_t *pAction);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_unmatchAction_set(rtksw_port_t port, rtksw_filter_unmatch_action_t action);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_unmatchAction_get(rtksw_port_t port, rtksw_filter_unmatch_action_t* action);
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_state_set(rtksw_port_t port, rtksw_filter_state_t state);
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_state_get(rtksw_port_t port, rtksw_filter_state_t* state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_template_set(rtksw_filter_template_t *aclTemplate);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_template_get(rtksw_filter_template_t *aclTemplate);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_field_sel_set(rtksw_uint32 index, rtksw_field_sel_t format, rtksw_uint32 offset);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAcl_field_sel_get(rtksw_uint32 index, rtksw_field_sel_t *pFormat, rtksw_uint32 *pOffset);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_iprange_set(rtksw_uint32 index, rtksw_filter_iprange_t type, ipaddr_t upperIp, ipaddr_t lowerIp);
 ...
 *      upperIp must be larger or equal than lowerIp.
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_iprange_get(rtksw_uint32 index, rtksw_filter_iprange_t *pType, ipaddr_t *pUpperIp, ipaddr_t *pLowerIp);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_vidrange_set(rtksw_uint32 index, rtksw_filter_vidrange_t type, rtksw_uint32 upperVid, rtksw_uint32 lowerVid);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_vidrange_get(rtksw_uint32 index, rtksw_filter_vidrange_t *pType, rtksw_uint32 *pUpperVid, rtksw_uint32 *pLowerVid);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_portrange_set(rtksw_uint32 index, rtksw_filter_portrange_t type, rtksw_uint32 upperPort, rtksw_uint32 lowerPort);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_portrange_get(rtksw_uint32 index, rtksw_filter_portrange_t *pType, rtksw_uint32 *pUpperPort, rtksw_uint32 *pLowerPort);
 ...
 *      none
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAclPolarity_set(rtksw_uint32 polarity);
 ...
 *      none
 */
extern rtksw_api_ret_t dal_rtl8367c_filter_igrAclPolarity_get(rtksw_uint32* pPolarity);
