 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlMeterIdx_set(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_uint32 index)
{
    ...
    switch (stormType)
    {
        case STORM_GROUP_UNKNOWN_UNICAST:
            if ((retVal = rtl8367c_setAsicStormFilterUnknownUnicastMeter(rtksw_switch_port_L2P_get(port), index))!=RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_UNKNOWN_MULTICAST:
            if ((retVal = rtl8367c_setAsicStormFilterUnknownMulticastMeter(rtksw_switch_port_L2P_get(port), index))!=RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_MULTICAST:
            if ((retVal = rtl8367c_setAsicStormFilterMulticastMeter(rtksw_switch_port_L2P_get(port), index))!=RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_BROADCAST:
            if ((retVal = rtl8367c_setAsicStormFilterBroadcastMeter(rtksw_switch_port_L2P_get(port), index))!=RT_ERR_OK)
                return retVal;
            break;
        default:
            break;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlMeterIdx_get(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
    ...
    {
        case STORM_GROUP_UNKNOWN_UNICAST:
            if ((retVal = rtl8367c_getAsicStormFilterUnknownUnicastMeter(rtksw_switch_port_L2P_get(port), pIndex))!=RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_UNKNOWN_MULTICAST:
            if ((retVal = rtl8367c_getAsicStormFilterUnknownMulticastMeter(rtksw_switch_port_L2P_get(port), pIndex))!=RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_MULTICAST:
            if ((retVal = rtl8367c_getAsicStormFilterMulticastMeter(rtksw_switch_port_L2P_get(port), pIndex))!=RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_BROADCAST:
            if ((retVal = rtl8367c_getAsicStormFilterBroadcastMeter(rtksw_switch_port_L2P_get(port), pIndex))!=RT_ERR_OK)
                return retVal;
            break;
        default:
            break;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlPortEnable_set(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    {
        case STORM_GROUP_UNKNOWN_UNICAST:
            if ((retVal = rtl8367c_setAsicStormFilterUnknownUnicastEnable(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_UNKNOWN_MULTICAST:
            if ((retVal = rtl8367c_setAsicStormFilterUnknownMulticastEnable(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_MULTICAST:
            if ((retVal = rtl8367c_setAsicStormFilterMulticastEnable(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_BROADCAST:
            if ((retVal = rtl8367c_setAsicStormFilterBroadcastEnable(rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
                return retVal;
            break;
        default:
            break;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlPortEnable_get(rtksw_port_t port, rtksw_rate_storm_group_t stormType, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    {
        case STORM_GROUP_UNKNOWN_UNICAST:
            if ((retVal = rtl8367c_getAsicStormFilterUnknownUnicastEnable(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_UNKNOWN_MULTICAST:
            if ((retVal = rtl8367c_getAsicStormFilterUnknownMulticastEnable(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_MULTICAST:
            if ((retVal = rtl8367c_getAsicStormFilterMulticastEnable(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_BROADCAST:
            if ((retVal = rtl8367c_getAsicStormFilterBroadcastEnable(rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        default:
            break;
 ...
 *      - BYPASS_LLDP.
 */
rtksw_api_ret_t dal_rtl8367c_storm_bypass_set(rtksw_storm_bypass_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *      - BYPASS_LLDP.
 */
rtksw_api_ret_t dal_rtl8367c_storm_bypass_get(rtksw_storm_bypass_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
    rtksw_uint32 tmp;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlExtPortmask_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlExtPortmask_get(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlExtEnable_set(rtksw_rate_storm_group_t stormType, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlExtEnable_get(rtksw_rate_storm_group_t stormType, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    {
        case STORM_GROUP_UNKNOWN_UNICAST:
            if ((retVal = rtl8367c_getAsicStormFilterExtUnknownUnicastEnable((rtksw_uint32 *)pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_UNKNOWN_MULTICAST:
            if ((retVal = rtl8367c_getAsicStormFilterExtUnknownMulticastEnable((rtksw_uint32 *)pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_MULTICAST:
            if ((retVal = rtl8367c_getAsicStormFilterExtMulticastEnable((rtksw_uint32 *)pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        case STORM_GROUP_BROADCAST:
            if ((retVal = rtl8367c_getAsicStormFilterExtBroadcastEnable((rtksw_uint32 *)pEnable)) != RT_ERR_OK)
                return retVal;
            break;
        default:
            break;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlExtMeterIdx_set(rtksw_rate_storm_group_t stormType, rtksw_uint32 index)
{
    rtksw_api_ret_t retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_stormControlExtMeterIdx_get(rtksw_rate_storm_group_t stormType, rtksw_uint32 *pIndex)
{
    rtksw_api_ret_t retVal;
