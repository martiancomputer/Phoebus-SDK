 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsCounterReset(rtksw_uint32 greset, rtksw_uint32 qmreset, rtksw_uint32 portmask)
{
    ret_t retVal;
 ...
 */
ret_t rtl8367c_getAsicMIBsCounter(rtksw_uint32 port, RTL8367C_MIBCOUNTER mibIdx, rtksw_uint64* pCounter)
{
    ret_t retVal;
    ...
    CONST rtksw_uint16 mibLength[RTL8367C_MIBS_NUMBER]= {
 ...
 */
ret_t rtl8367c_getAsicMIBsLogCounter(rtksw_uint32 index, rtksw_uint32 *pCounter)
{
    ret_t retVal;
    rtksw_uint32 regAddr;
    rtksw_uint32 regData;
 ...
 */
ret_t rtl8367c_getAsicMIBsControl(rtksw_uint32* pMask)
{
    ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetValue(rtksw_uint32 value)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsResetValue(rtksw_uint32* value)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsUsageMode(rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsUsageMode(rtksw_uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsTimer(rtksw_uint32 timer)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsTimer(rtksw_uint32* pTimer)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingMode(rtksw_uint32 index, rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingMode(rtksw_uint32 index, rtksw_uint32* pMode)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingType(rtksw_uint32 index, rtksw_uint32 type)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingType(rtksw_uint32 index, rtksw_uint32* pType)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetLoggingCounter(rtksw_uint32 index)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLength(rtksw_uint32 txLengthMode, rtksw_uint32 rxLengthMode)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLength(rtksw_uint32 *pTxLengthMode, rtksw_uint32 *pRxLengthMode)
{
    ret_t retVal;
