 ...
 *      None
 */
ret_t rtl8367c_setAsic1xPBEnConfig(rtksw_uint32 port, rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xPBEnConfig(rtksw_uint32 port, rtksw_uint32 *pEnabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xPBAuthConfig(rtksw_uint32 port, rtksw_uint32 auth)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xPBAuthConfig(rtksw_uint32 port, rtksw_uint32 *pAuth)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xPBOpdirConfig(rtksw_uint32 port, rtksw_uint32 opdir)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xPBOpdirConfig(rtksw_uint32 port, rtksw_uint32* pOpdir)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xMBEnConfig(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xMBEnConfig(rtksw_uint32 port, rtksw_uint32 *pEnabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xMBOpdirConfig(rtksw_uint32 opdir)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xMBOpdirConfig(rtksw_uint32 *pOpdir)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xProcConfig(rtksw_uint32 port, rtksw_uint32 proc)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xProcConfig(rtksw_uint32 port, rtksw_uint32* pProc)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xGuestVidx(rtksw_uint32 index)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xGuestVidx(rtksw_uint32 *pIndex)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xGVOpdir(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xGVOpdir(rtksw_uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xTrapPriority(rtksw_uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xTrapPriority(rtksw_uint32 *pPriority)
{
