 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingMode(rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingMode(rtksw_uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingFc(rtksw_uint32 group, rtksw_uint32 enabled)
{
    ret_t       retVal;
    ...
    if((retVal = rtl8367c_setAsicRegBit(RTL8367C_REG_PORT_TRUNK_DROP_CTRL, RTL8367C_PORT_TRUNK_DROP_CTRL_OFFSET, RTKSW_ENABLED)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingFc(rtksw_uint32 group, rtksw_uint32* pEnabled)
{
    if(group > RTL8367C_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingGroup(rtksw_uint32 group, rtksw_uint32 portmask)
{
    if(group > RTL8367C_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingGroup(rtksw_uint32 group, rtksw_uint32* pPortmask)
{
    if(group > RTL8367C_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingFlood(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingFlood(rtksw_uint32* pEnabled)
{
 ...
 */
ret_t rtl8367c_setAsicTrunkingHashSelect(rtksw_uint32 hashsel)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingHashSelect(rtksw_uint32* pHashsel)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicQeueuEmptyStatus(rtksw_uint32* portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingHashTable(rtksw_uint32 hashval, rtksw_uint32 portId)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingHashTable(rtksw_uint32 hashval, rtksw_uint32* pPortId)
{
    if(hashval > RTL8367C_TRUNKING_HASHVALUE_MAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingHashTable1(rtksw_uint32 hashval, rtksw_uint32 portId)
{
    if(hashval > RTL8367C_TRUNKING_HASHVALUE_MAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingHashTable1(rtksw_uint32 hashval, rtksw_uint32* pPortId)
{
    if(hashval > RTL8367C_TRUNKING_HASHVALUE_MAX)
        return RT_ERR_OUT_OF_RANGE;
