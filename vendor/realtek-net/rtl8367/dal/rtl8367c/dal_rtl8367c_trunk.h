 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_port_set(rtksw_trunk_group_t trk_gid, rtksw_portmask_t *pTrunk_member_portmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_port_get(rtksw_trunk_group_t trk_gid, rtksw_portmask_t *pTrunk_member_portmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_distributionAlgorithm_set(rtksw_trunk_group_t trk_gid, rtksw_uint32 algo_bitmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_distributionAlgorithm_get(rtksw_trunk_group_t trk_gid, rtksw_uint32 *pAlgo_bitmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_trafficSeparate_set(rtksw_trunk_group_t trk_gid, rtksw_trunk_separateType_t separateType);
 ...
 *      SEPARATE_FLOOD: trunk MSB link up port is dedicated to TX flooding (L2 lookup miss) traffic
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_trafficSeparate_get(rtksw_trunk_group_t trk_gid, rtksw_trunk_separateType_t *pSeparateType);
 ...
 *      - TRUNK_MODE_DUMB
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_mode_set(rtksw_trunk_mode_t mode);
 ...
 *      - TRUNK_MODE_DUMB
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_mode_get(rtksw_trunk_mode_t *pMode);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_trafficPause_set(rtksw_trunk_group_t trk_gid, rtksw_enable_t enable);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_trafficPause_get(rtksw_trunk_group_t trk_gid, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_hashMappingTable_set(rtksw_trunk_group_t trk_gid, rtksw_trunk_hashVal2Port_t *pHash2Port_array);
 ...
 *      Trunk group 2 uses a independent table.
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_hashMappingTable_get(rtksw_trunk_group_t trk_gid, rtksw_trunk_hashVal2Port_t *pHash2Port_array);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_trunk_portQueueEmpty_get(rtksw_portmask_t *pEmpty_portmask);
