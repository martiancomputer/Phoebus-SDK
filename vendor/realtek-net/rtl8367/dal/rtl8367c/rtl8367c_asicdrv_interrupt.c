 ...
 *      None
 */
ret_t rtl8367c_setAsicInterruptPolarity(rtksw_uint32 polarity)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptPolarity(rtksw_uint32* pPolarity)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicInterruptMask(rtksw_uint32 imr)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptMask(rtksw_uint32* pImr)
{
 ...
 *      [11]: Silent Start
 */
ret_t rtl8367c_setAsicInterruptStatus(rtksw_uint32 ims)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptStatus(rtksw_uint32* pIms)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicInterruptRelatedStatus(rtksw_uint32 type, rtksw_uint32 status)
{
    CONST rtksw_uint32 indicatorAddress[INTRST_END] = {RTL8367C_REG_LEARN_OVER_INDICATOR,
 ...
 *      None
 */
ret_t rtl8367c_getAsicInterruptRelatedStatus(rtksw_uint32 type, rtksw_uint32* pStatus)
{
    CONST rtksw_uint32 indicatorAddress[INTRST_END] = {RTL8367C_REG_LEARN_OVER_INDICATOR,
                                                    RTL8367C_REG_SPEED_CHANGE_INDICATOR,
                                                    RTL8367C_REG_SPECIAL_CONGEST_INDICATOR,
