...
{
    ret_t   retVal;
    rtksw_uint32 i, regValue, type, option,reg_data,reg_value;
    rtksw_uint32 idx;
    ...
    else if (2 == type)
    {
        ...
        if (mode == EXT_RGMII)
        {
            ...
            if (id == 1)
            {
                ...
                if ((retVal = rtl8367c_getAsicRegBit(0x1307, 3, &reg_value)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicRegBit(0x1307, 3, reg_value)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((retVal = rtl8367c_getAsicRegBits(0x1307, 0x7, &reg_value)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicRegBits(0x1307, 0x7, reg_value)) != RT_ERR_OK)
                    return retVal;
            ...
            else if (id == 2)
            {
                ...
                if ((retVal = rtl8367c_getAsicRegBit(0x13c5, 3, &reg_value)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicRegBit(0x13c5, 3, reg_value)) != RT_ERR_OK)
                    return retVal;
                ...
                if ((retVal = rtl8367c_getAsicRegBits(0x13c5, 0x7, &reg_value)) != RT_ERR_OK)
                    return retVal;

                if ((retVal = rtl8367c_setAsicRegBits(0x13c5, 0x7, reg_value)) != RT_ERR_OK)
                    return retVal;
