 ...
 */
ret_t rtl8367c_setAsicCputagEnable(rtksw_uint32 enabled)
{
    if(enabled > 1)
 ...
 *      None
 */
ret_t rtl8367c_getAsicCputagEnable(rtksw_uint32 *pEnabled)
{
 ...
 */
ret_t rtl8367c_setAsicCputagTrapPort(rtksw_uint32 port)
{
    ret_t retVal;
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagTrapPort(rtksw_uint32 *pPort)
{
    ret_t retVal;
    rtksw_uint32 tmpPort;
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagPortmask(rtksw_uint32 portmask)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagInsertMode(rtksw_uint32 mode)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagInsertMode(rtksw_uint32 *pMode)
{
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagPriorityRemapping(rtksw_uint32 srcPri, rtksw_uint32 newPri)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagPriorityRemapping(rtksw_uint32 srcPri, rtksw_uint32 *pNewPri)
{
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagPosition(rtksw_uint32 postion)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagPosition(rtksw_uint32* pPostion)
{
 ...
 *      forwarded to CPU port, and all ports cannot parse CPU tag.
 */
ret_t rtl8367c_setAsicCputagMode(rtksw_uint32 mode)
{
    if(mode > 1)
        return RT_ERR_INPUT;
 ...
 *      None
 */
ret_t rtl8367c_getAsicCputagMode(rtksw_uint32 *pMode)
{
 ...
 *      forwarded to CPU port, and all ports cannot parse CPU tag.
 */
ret_t rtl8367c_setAsicCputagRxMinLength(rtksw_uint32 mode)
{
    if(mode > 1)
        return RT_ERR_INPUT;
 ...
 *      None
 */
ret_t rtl8367c_getAsicCputagRxMinLength(rtksw_uint32 *pMode)
{
