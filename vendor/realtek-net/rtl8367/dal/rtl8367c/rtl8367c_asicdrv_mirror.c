 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirror(rtksw_uint32 source, rtksw_uint32 monitor)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirror(rtksw_uint32 *pSource, rtksw_uint32 *pMonitor)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorRxFunction(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorRxFunction(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorTxFunction(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorTxFunction(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorIsolation(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorIsolation(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorMask(rtksw_uint32 SourcePortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorMask(rtksw_uint32 *pSourcePortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorVlanRxLeaky(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorVlanRxLeaky(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorVlanTxLeaky(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorVlanTxLeaky(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorIsolationRxLeaky(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorIsolationRxLeaky(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorIsolationTxLeaky(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorIsolationTxLeaky(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorRealKeep(rtksw_uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorRealKeep(rtksw_uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortMirrorOverride(rtksw_uint32 rxMirror, rtksw_uint32 txMirror, rtksw_uint32 aclMirror)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortMirrorOverride(rtksw_uint32 *pRxMirror, rtksw_uint32 *pTxMirror, rtksw_uint32 *pAclMirror)
{
    ret_t retVal;
