 ...
 */
rtksw_api_ret_t dal_rtl8367c_rate_shareMeter_set(rtksw_meter_id_t index, rtksw_meter_type_t type, rtksw_rate_t rate, rtksw_enable_t ifg_include)
{
    ...
    /* Set Type */
    if ((retVal = rtl8367c_setAsicShareMeterType(index, (rtksw_uint32)type)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_rate_shareMeter_get(rtksw_meter_id_t index, rtksw_meter_type_t *pType, rtksw_rate_t *pRate, rtksw_enable_t *pIfg_include)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicShareMeterType(index, (rtksw_uint32 *)pType)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_rate_shareMeterBucket_set(rtksw_meter_id_t index, rtksw_uint32 bucket_size)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_rate_shareMeterBucket_get(rtksw_meter_id_t index, rtksw_uint32 *pBucket_size)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_rate_igrBandwidthCtrlRate_set(rtksw_port_t port, rtksw_rate_t rate, rtksw_enable_t ifg_include, rtksw_enable_t fc_enable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicPortIngressBandwidth(rtksw_switch_port_L2P_get(port), rate>>3, ifg_include,fc_enable)) != RT_ERR_OK)
        return retVal;
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
rtksw_api_ret_t dal_rtl8367c_rate_igrBandwidthCtrlRate_get(rtksw_port_t port, rtksw_rate_t *pRate, rtksw_enable_t *pIfg_include, rtksw_enable_t *pFc_enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    ...
    if ((retVal = rtl8367c_getAsicPortIngressBandwidth(rtksw_switch_port_L2P_get(port), &regData, pIfg_include, pFc_enable)) != RT_ERR_OK)
        return retVal;
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
rtksw_api_ret_t dal_rtl8367c_rate_egrBandwidthCtrlRate_set( rtksw_port_t port, rtksw_rate_t rate,  rtksw_enable_t ifg_include)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicPortEgressRate(rtksw_switch_port_L2P_get(port), rate>>3)) != RT_ERR_OK)
        return retVal;
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
rtksw_api_ret_t dal_rtl8367c_rate_egrBandwidthCtrlRate_get(rtksw_port_t port, rtksw_rate_t *pRate, rtksw_enable_t *pIfg_include)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    ...
    if ((retVal = rtl8367c_getAsicPortEgressRate(rtksw_switch_port_L2P_get(port), &regData)) != RT_ERR_OK)
        return retVal;

    *pRate = regData << 3;

    if ((retVal = rtl8367c_getAsicPortEgressRateIfg((rtksw_uint32*)pIfg_include)) != RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_rate_egrQueueBwCtrlEnable_get(rtksw_port_t port, rtksw_qid_t queue, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_getAsicAprEnable(rtksw_switch_port_L2P_get(port),pEnable))!=RT_ERR_OK)
        return retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367c_rate_egrQueueBwCtrlEnable_set(rtksw_port_t port, rtksw_qid_t queue, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicAprEnable(rtksw_switch_port_L2P_get(port), enable))!=RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_rate_egrQueueBwCtrlRate_get(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t *pIndex)
{
    rtksw_api_ret_t retVal;
    ...
    if (queue >= RTKSW_MAX_NUM_OF_QUEUE)
        return RT_ERR_QUEUE_ID;
 ...
 *    The unit of granularity is 8Kbps.
 */
rtksw_api_ret_t dal_rtl8367c_rate_egrQueueBwCtrlRate_set(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t index)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 offset_idx;
    rtksw_uint32 phy_port;
