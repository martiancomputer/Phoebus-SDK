 ...
 *      None
 */
ret_t rtl8367c_setAsicRldp(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldp(rtksw_uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpEnable8051(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpEnable8051(rtksw_uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpCompareRandomNumber(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpCompareRandomNumber(rtksw_uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpIndicatorSource(rtksw_uint32 src)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpIndicatorSource(rtksw_uint32 *pSrc)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpCheckingStatePara(rtksw_uint32 retryCount, rtksw_uint32 retryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpCheckingStatePara(rtksw_uint32 *pRetryCount, rtksw_uint32 *pRetryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpLoopStatePara(rtksw_uint32 retryCount, rtksw_uint32 retryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLoopStatePara(rtksw_uint32 *pRetryCount, rtksw_uint32 *pRetryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpTxPortmask(rtksw_uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpTxPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLoopedPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLoopedPortPair(rtksw_uint32 port, rtksw_uint32 *pLoopedPair)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRlppTrap8051(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRlppTrap8051(rtksw_uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpLeaveLoopedPortmask(rtksw_uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLeaveLoopedPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpEnterLoopedPortmask(rtksw_uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpEnterLoopedPortmask(rtksw_uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpTriggerMode(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpTriggerMode(rtksw_uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldp8051Portmask(rtksw_uint32 portmask)
{
    ret_t retVal;
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldp8051Portmask(rtksw_uint32 *pPortmask)
{
