 ...
 *     None
 */
ret_t rtl8367c_setAsicEavTpid(rtksw_uint32 outerTag, rtksw_uint32 innerTag)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicEavTpid(rtksw_uint32* pOuterTag, rtksw_uint32* pInnerTag)
{
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicEavSysTime(rtksw_uint32 second, rtksw_uint32 nanoSecond)
{
    ret_t retVal;
    rtksw_uint32 sec_h, sec_l, nsec8_h, nsec8_l;
    rtksw_uint32 nano_second_8;
    rtksw_uint32 regData, busyFlag, count;
 ...
 *      The time granuality is 8 nano seconds.
 */
ret_t rtl8367c_getAsicEavSysTime(rtksw_uint32* pSecond, rtksw_uint32* pNanoSecond)
{
    ret_t retVal;
    rtksw_uint32 sec_h, sec_l, nsec8_h, nsec8_l;
    rtksw_uint32 nano_second_8;
 ...
 */
ret_t rtl8367c_setAsicEavSysTimeAdjust(rtksw_uint32 type, rtksw_uint32 second, rtksw_uint32 nanoSecond)
{
    ret_t retVal;
    rtksw_uint32 sec_h, sec_l, nsec8_h, nsec8_l;
    rtksw_uint32 nano_second_8;
 ...
 *      None
 */
ret_t rtl8367c_setAsicEavSysTimeCtrl(rtksw_uint32 control)
{
    ret_t  retVal;
    rtksw_uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicEavSysTimeCtrl(rtksw_uint32* pControl)
{
    ret_t  retVal;
    rtksw_uint32 regData;
    rtksw_uint32 mask;
 ...
 *      [7]:RX_PDELAY_RESP,
 */
ret_t rtl8367c_setAsicEavInterruptMask(rtksw_uint32 imr)
{
 ...
 *      [7]:RX_PDELAY_RESP,
 */
ret_t rtl8367c_getAsicEavInterruptMask(rtksw_uint32* pImr)
{
 ...
 *      [4]:p4 interrupt,
 */
ret_t rtl8367c_getAsicEavInterruptStatus(rtksw_uint32* pIms)
{
 ...
 *      [7]:RX_PDELAY_RESP,
 */
ret_t rtl8367c_setAsicEavPortInterruptStatus(rtksw_uint32 port, rtksw_uint32 ims)
{
 ...
 *      [7]:RX_PDELAY_RESP,
 */
ret_t rtl8367c_getAsicEavPortInterruptStatus(rtksw_uint32 port, rtksw_uint32* pIms)
{
 ...
 */
ret_t rtl8367c_setAsicEavPortEnable(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicEavPortEnable(rtksw_uint32 port, rtksw_uint32 *pEnabled)
{
    if(port > RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      The time granuality is 8 nano seconds.
 */
ret_t rtl8367c_getAsicEavPortTimeStamp(rtksw_uint32 port, rtksw_uint32 type, rtl8367c_ptp_time_stamp_t* timeStamp)
{
    ret_t retVal;
    rtksw_uint32 sec_h, sec_l, nsec8_h, nsec8_l;
    rtksw_uint32 nano_second_8;
 ...
 */
ret_t rtl8367c_setAsicEavTrap(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicEavTrap(rtksw_uint32 port, rtksw_uint32 *pEnabled)
{
    if(port > RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      If EAV function is enabled, PTP event messgae packet will be attached PTP timestamp for trapping
 */
ret_t rtl8367c_setAsicEavEnable(rtksw_uint32 port, rtksw_uint32 enabled)
{
    if(port > RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicEavEnable(rtksw_uint32 port, rtksw_uint32 *pEnabled)
{
    if(port > RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicEavPriRemapping(rtksw_uint32 srcpriority, rtksw_uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicEavPriRemapping(rtksw_uint32 srcpriority, rtksw_uint32 *pPriority)
{
