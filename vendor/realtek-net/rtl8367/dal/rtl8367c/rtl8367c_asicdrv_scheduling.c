 ...
 *      None
 */
ret_t rtl8367c_setAsicLeakyBucketParameter(rtksw_uint32 tick, rtksw_uint32 token)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLeakyBucketParameter(rtksw_uint32 *tick, rtksw_uint32 *token)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAprMeter(rtksw_uint32 port, rtksw_uint32 qid, rtksw_uint32 apridx)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAprMeter(rtksw_uint32 port, rtksw_uint32 qid, rtksw_uint32 *apridx)
{
    ret_t retVal;
    rtksw_uint32 regAddr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAprEnable(rtksw_uint32 port, rtksw_uint32 aprEnable)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAprEnable(rtksw_uint32 port, rtksw_uint32 *aprEnable)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicWFQWeight(rtksw_uint32 port, rtksw_uint32 qid, rtksw_uint32 qWeight)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicWFQWeight(rtksw_uint32 port, rtksw_uint32 qid, rtksw_uint32 *qWeight)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicWFQBurstSize(rtksw_uint32 burstsize)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicWFQBurstSize(rtksw_uint32 *burstsize)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicQueueType(rtksw_uint32 port, rtksw_uint32 qid, rtksw_uint32 queueType)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicQueueType(rtksw_uint32 port, rtksw_uint32 qid, rtksw_uint32 *queueType)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortEgressRate(rtksw_uint32 port, rtksw_uint32 rate)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortEgressRate(rtksw_uint32 port, rtksw_uint32 *rate)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortEgressRateIfg(rtksw_uint32 ifg)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortEgressRateIfg(rtksw_uint32 *ifg)
{
    ret_t retVal;
