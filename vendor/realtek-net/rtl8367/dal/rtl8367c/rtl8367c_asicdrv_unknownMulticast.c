 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownL2MulticastBehavior(rtksw_uint32 port, rtksw_uint32 behave)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownL2MulticastBehavior(rtksw_uint32 port, rtksw_uint32 *pBehave)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownIPv4MulticastBehavior(rtksw_uint32 port, rtksw_uint32 behave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownIPv4MulticastBehavior(rtksw_uint32 port, rtksw_uint32 *pBehave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownIPv6MulticastBehavior(rtksw_uint32 port, rtksw_uint32 behave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownIPv6MulticastBehavior(rtksw_uint32 port, rtksw_uint32 *pBehave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownMulticastTrapPriority(rtksw_uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownMulticastTrapPriority(rtksw_uint32 *pPriority)
{
