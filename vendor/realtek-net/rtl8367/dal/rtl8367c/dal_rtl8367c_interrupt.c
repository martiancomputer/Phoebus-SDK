 ...
 */
rtksw_api_ret_t dal_rtl8367c_int_polarity_set(rtksw_int_polarity_t type)
{
 ...
 */
rtksw_api_ret_t dal_rtl8367c_int_polarity_get(rtksw_int_polarity_t *pType)
{
    rtksw_api_ret_t retVal;
 ...
 *      - INT_TYPE_SLIENT
 */
rtksw_api_ret_t dal_rtl8367c_int_control_set(rtksw_int_type_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 mask;
 ...
 *      - INT_TYPE_SLIENT
 */
rtksw_api_ret_t dal_rtl8367c_int_control_get(rtksw_int_type_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 mask;
 ...
 */
rtksw_api_ret_t dal_rtl8367c_int_status_set(rtksw_int_status_t *pStatusMask)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367c_setAsicInterruptStatus((rtksw_uint32)pStatusMask->value[0]))!=RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367c_int_status_get(rtksw_int_status_t* pStatusMask)
{
    rtksw_api_ret_t   retVal;
 ...
 *      The status will be cleared after execute this API.
 */
rtksw_api_ret_t dal_rtl8367c_int_advanceInfo_get(rtksw_int_advType_t adv_type, rtksw_int_info_t *pInfo)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      data;
    ...
    switch(adv_type)
    {
        case ADV_L2_LEARN_PORT_MASK:
            ...
            if((retVal = rtksw_switch_portmask_P2L_get(data, &(pInfo->portMask))) != RT_ERR_OK)
                return retVal;
