 ...
 *      None
 */
ret_t rtl8367c_setAsicOamParser(rtksw_uint32 port, rtksw_uint32 parser)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicOamParser(rtksw_uint32 port, rtksw_uint32* pParser)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicOamMultiplexer(rtksw_uint32 port, rtksw_uint32 multiplexer)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicOamMultiplexer(rtksw_uint32 port, rtksw_uint32* pMultiplexer)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicOamCpuPri(rtksw_uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicOamCpuPri(rtksw_uint32 *pPriority)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicOamEnable(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicOamEnable(rtksw_uint32 *pEnabled)
{
