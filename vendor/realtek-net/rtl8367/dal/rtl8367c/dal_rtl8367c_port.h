 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyAutoNegoAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyAutoNegoAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 *      be set as following 100F > 100H > 10F > 10H priority sequence.
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyForceModeAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 *      Get the capablity of specified PHY.
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyForceModeAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyStatus_get(rtksw_port_t port, rtksw_port_linkStatus_t *pLinkStatus, rtksw_port_speed_t *pSpeed, rtksw_port_duplex_t *pDuplex);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_macForceLink_set(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_macForceLink_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability);
 ...
 *      - MODE_EXT_100FX,
 */
extern rtksw_api_ret_t dal_rtl8367c_port_macForceLinkExt_set(rtksw_port_t port, rtksw_mode_ext_t mode, rtksw_port_mac_ability_t *pPortability);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_macForceLinkExt_get(rtksw_port_t port, rtksw_mode_ext_t *pMode, rtksw_port_mac_ability_t *pPortability);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_macStatus_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortstatus);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_macLocalLoopbackEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_port_macLocalLoopbackEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyReg_set(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t value);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyReg_get(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t *pData);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyOCPReg_set(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 ocpData);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyOCPReg_get(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 *pRegData);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_backpressureEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_backpressureEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_adminEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_adminEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_isolation_set(rtksw_port_t port, rtksw_portmask_t *pPortmask);
 ...
 *      A port can only transmit packet to ports included in permitted portmask
 */
extern rtksw_api_ret_t dal_rtl8367c_port_isolation_get(rtksw_port_t port, rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_rgmiiDelayExt_set(rtksw_port_t port, rtksw_data_t txDelay, rtksw_data_t rxDelay);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_rgmiiDelayExt_get(rtksw_port_t port, rtksw_data_t *pTxDelay, rtksw_data_t *pRxDelay);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyEnableAll_set(rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyEnableAll_get(rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_efid_set(rtksw_port_t port, rtksw_data_t efid);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_efid_get(rtksw_port_t port, rtksw_data_t *pEfid);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyComboPortMedia_set(rtksw_port_t port, rtksw_port_media_t media);
 ...
 *      The API can Set Combo port media type.
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyComboPortMedia_get(rtksw_port_t port, rtksw_port_media_t *pMedia);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_rtctEnable_set(rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_rtctDisable_set(rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_rtctResult_get(rtksw_port_t port, rtksw_rtctResult_t *pRtctResult);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_sds_reset(rtksw_port_t port);
 ...
 *      The API can reset Serdes
 */
extern rtksw_api_ret_t dal_rtl8367c_port_sgmiiLinkStatus_get(rtksw_port_t port, rtksw_data_t *pSignalDetect, rtksw_data_t *pSync, rtksw_port_linkStatus_t *pLink);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_sgmiiNway_set(rtksw_port_t port, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_sgmiiNway_get(rtksw_port_t port, rtksw_enable_t *pState);
 ...
 *      The API can get SGMII/HSGMII port Nway state
 */
extern rtksw_api_ret_t dal_rtl8367c_port_fiberAbilityExt_set(rtksw_port_t port, rtksw_uint32 pause, rtksw_uint32 asypause);
 ...
 *      The API can get SGMII/HSGMII port Nway state
 */
extern rtksw_api_ret_t dal_rtl8367c_port_fiberAbilityExt_get(rtksw_port_t port, rtksw_uint32* pPause, rtksw_uint32* pAsypause);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_autoDos_set(rtksw_port_autoDosType_t type, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_autoDos_get(rtksw_port_autoDosType_t type, rtksw_enable_t *pState);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyMdx_set(rtksw_port_t port, rtksw_port_phy_mdix_mode_t mode);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyMdx_get(rtksw_port_t port, rtksw_port_phy_mdix_mode_t *pMode);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyMdxStatus_get(rtksw_port_t port, rtksw_port_phy_mdix_status_t *pStatus);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyTestMode_set(rtksw_port_t port, rtksw_port_phy_test_mode_t mode);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyTestMode_get(rtksw_port_t port, rtksw_port_phy_test_mode_t *pMode);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyGreenEthernet_set(rtksw_port_t port, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyGreenEthernet_get(rtksw_port_t port, rtksw_enable_t *pState);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyLinkDownPowerSaving_set(rtksw_port_t port, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367c_port_phyLinkDownPowerSaving_get(rtksw_port_t port, rtksw_enable_t *pState);
