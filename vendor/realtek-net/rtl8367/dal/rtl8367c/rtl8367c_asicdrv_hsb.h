...
extern ret_t rtl8367c_setAsicFieldSelector(rtksw_uint32 index, rtksw_uint32 format, rtksw_uint32 offset);
extern ret_t rtl8367c_getAsicFieldSelector(rtksw_uint32 index, rtksw_uint32* pFormat, rtksw_uint32* pOffset);
