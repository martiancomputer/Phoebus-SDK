 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityDot1qRemapping(rtksw_uint32 srcpriority, rtksw_uint32 priority )
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityDot1qRemapping(rtksw_uint32 srcpriority, rtksw_uint32 *pPriority )
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityPortBased(rtksw_uint32 port, rtksw_uint32 priority )
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityPortBased(rtksw_uint32 port, rtksw_uint32 *pPriority )
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityDscpBased(rtksw_uint32 dscp, rtksw_uint32 priority )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityDscpBased(rtksw_uint32 dscp, rtksw_uint32 *pPriority )
{
    if(dscp > RTL8367C_DSCPMAX)
        return RT_ERR_QOS_DSCP_VALUE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityDecision(rtksw_uint32 index, rtksw_uint32 prisrc, rtksw_uint32 decisionPri)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityDecision(rtksw_uint32 index, rtksw_uint32 prisrc, rtksw_uint32* pDecisionPri)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortPriorityDecisionIndex(rtksw_uint32 port, rtksw_uint32 index )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortPriorityDecisionIndex(rtksw_uint32 port, rtksw_uint32 *pIndex )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicOutputQueueMappingIndex(rtksw_uint32 port, rtksw_uint32 index )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicOutputQueueMappingIndex(rtksw_uint32 port, rtksw_uint32 *pIndex )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityToQIDMappingTable(rtksw_uint32 index, rtksw_uint32 priority, rtksw_uint32 qid )
{
    if(index >= RTL8367C_QUEUENO)
        return RT_ERR_QUEUE_NUM;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityToQIDMappingTable(rtksw_uint32 index, rtksw_uint32 priority, rtksw_uint32* pQid)
{
    if(index >= RTL8367C_QUEUENO)
        return RT_ERR_QUEUE_NUM;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDot1pAbility(rtksw_uint32 port, rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDot1pAbility(rtksw_uint32 port, rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDot1pParameter(rtksw_uint32 priority, rtksw_uint32 newPriority )
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDot1pParameter(rtksw_uint32 priority, rtksw_uint32 *pNewPriority )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 */
ret_t rtl8367c_setAsicRemarkingDot1pSrc(rtksw_uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDot1pSrc(rtksw_uint32 *pType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDscpAbility(rtksw_uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDscpAbility(rtksw_uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDscpParameter(rtksw_uint32 priority, rtksw_uint32 newDscp )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDscpParameter(rtksw_uint32 priority, rtksw_uint32* pNewDscp )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 *      priority to TX DSCP value.
 */
ret_t rtl8367c_setAsicRemarkingDscpSrc(rtksw_uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDscpSrc(rtksw_uint32 *pType)
{
 ...
 */
ret_t rtl8367c_setAsicRemarkingDscp2Dscp(rtksw_uint32 dscp, rtksw_uint32 rmkDscp)
{
 ...
 *      None.
 */
ret_t rtl8367c_getAsicRemarkingDscp2Dscp(rtksw_uint32 dscp, rtksw_uint32 *pRmkDscp)
{
    if(dscp > RTL8367C_DSCPMAX)
        return RT_ERR_QOS_DSCP_VALUE;
