 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_init(void);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_addr_add(rtksw_mac_t *pMac, rtksw_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_addr_get(rtksw_mac_t *pMac, rtksw_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_addr_next_get(rtksw_l2_read_method_t read_method, rtksw_port_t port, rtksw_uint32 *pAddress, rtksw_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_addr_del(rtksw_mac_t *pMac, rtksw_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_mcastAddr_add(rtksw_l2_mcastAddr_t *pMcastAddr);
 ...
 *      the mac is learned. Otherwise, it will return a RT_ERR_L2_ENTRY_NOTFOUND error.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_mcastAddr_get(rtksw_l2_mcastAddr_t *pMcastAddr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_mcastAddr_next_get(rtksw_uint32 *pAddress, rtksw_l2_mcastAddr_t *pMcastAddr);
 ...
 *      If the mac has existed in the LUT, it will be deleted. Otherwise, it will return RT_ERR_L2_ENTRY_NOTFOUND.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_mcastAddr_del(rtksw_l2_mcastAddr_t *pMcastAddr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastAddr_add(rtksw_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastAddr_get(rtksw_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastAddr_next_get(rtksw_uint32 *pAddress, rtksw_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastAddr_del(rtksw_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ucastAddr_flush(rtksw_l2_flushCfg_t *pConfig);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_table_clear(void);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_table_clearStatus_get(rtksw_l2_clearStatus_t *pStatus);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_flushLinkDownPortAddrEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_flushLinkDownPortAddrEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_agingEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_agingEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 *      to 8k.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitLearningCnt_set(rtksw_port_t port, rtksw_mac_cnt_t mac_cnt);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitLearningCnt_get(rtksw_port_t port, rtksw_mac_cnt_t *pMac_cnt);
 ...
 *      to 2112.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitSystemLearningCnt_set(rtksw_mac_cnt_t mac_cnt);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitSystemLearningCnt_get(rtksw_mac_cnt_t *pMac_cnt);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitLearningCntAction_set(rtksw_port_t port, rtksw_l2_limitLearnCntAction_t action);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitLearningCntAction_get(rtksw_port_t port, rtksw_l2_limitLearnCntAction_t *pAction);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitSystemLearningCntAction_set(rtksw_l2_limitLearnCntAction_t action);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitSystemLearningCntAction_get(rtksw_l2_limitLearnCntAction_t *pAction);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitSystemLearningCntPortMask_set(rtksw_portmask_t *pPortmask);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_limitSystemLearningCntPortMask_get(rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_learningCnt_get(rtksw_port_t port, rtksw_mac_cnt_t *pMac_cnt);
 ...
 *      - FLOOD_BC
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_floodPortMask_set(rtksw_l2_flood_type_t floood_type, rtksw_portmask_t *pFlood_portmask);
 ...
 *      - FLOOD_BC
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_floodPortMask_get(rtksw_l2_flood_type_t floood_type, rtksw_portmask_t *pFlood_portmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_localPktPermit_set(rtksw_port_t port, rtksw_enable_t permit);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_localPktPermit_get(rtksw_port_t port, rtksw_enable_t *pPermit);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_aging_set(rtksw_l2_age_time_t aging_time);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_aging_get(rtksw_l2_age_time_t *pAging_time);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastAddrLookup_set(rtksw_l2_ipmc_lookup_type_t type);
 ...
 *      None.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastAddrLookup_get(rtksw_l2_ipmc_lookup_type_t *pType);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastGroupEntry_add(ipaddr_t ip_addr, rtksw_uint32 vid, rtksw_portmask_t *pPortmask);
 ...
 *      Delete an entry from IP Multicast group table.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastGroupEntry_del(ipaddr_t ip_addr, rtksw_uint32 vid);
 ...
 *      Delete an entry from IP Multicast group table.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_ipMcastGroupEntry_get(ipaddr_t ip_addr, rtksw_uint32 vid, rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_entry_get(rtksw_l2_addr_table_t *pL2_entry);
 ...
 *      group.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_lookupHitIsolationAction_set(rtksw_l2_lookupHitIsolationAction_t action);
 ...
 *      group.
 */
extern rtksw_api_ret_t dal_rtl8367d_l2_lookupHitIsolationAction_get(rtksw_l2_lookupHitIsolationAction_t *pAction);
