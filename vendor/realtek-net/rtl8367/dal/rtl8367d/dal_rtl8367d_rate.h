...
#ifndef __DAL_RTL8367D_RATE_H__
#define __DAL_RTL8367D_RATE_H__
 ...
 */
#define RTL8367D_METERBUCKETSIZEMAX         0xFFFF
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_shareMeter_set(rtksw_meter_id_t index, rtksw_meter_type_t type, rtksw_rate_t rate, rtksw_enable_t ifg_include);
 ...
 *
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_shareMeter_get(rtksw_meter_id_t index, rtksw_meter_type_t *pType, rtksw_rate_t *pRate, rtksw_enable_t *pIfg_include);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_shareMeterBucket_set(rtksw_meter_id_t index, rtksw_uint32 bucket_size);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_shareMeterBucket_get(rtksw_meter_id_t index, rtksw_uint32 *pBucket_size);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_igrBandwidthCtrlRate_set( rtksw_port_t port, rtksw_rate_t rate,  rtksw_enable_t ifg_include, rtksw_enable_t fc_enable);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_igrBandwidthCtrlRate_get(rtksw_port_t port, rtksw_rate_t *pRate, rtksw_enable_t *pIfg_include, rtksw_enable_t *pFc_enable);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_egrBandwidthCtrlRate_set(rtksw_port_t port, rtksw_rate_t rate,  rtksw_enable_t ifg_includ);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_egrBandwidthCtrlRate_get(rtksw_port_t port, rtksw_rate_t *pRate, rtksw_enable_t *pIfg_include);
 ...
 *      None
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_egrQueueBwCtrlEnable_set(rtksw_port_t port, rtksw_qid_t queue, rtksw_enable_t enable);
 ...
 *    None.
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_egrQueueBwCtrlEnable_get(rtksw_port_t port, rtksw_qid_t queue, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_egrQueueBwCtrlRate_set(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t index);
 ...
 *    The unit of granularity is 8Kbps.
 */
extern rtksw_api_ret_t dal_rtl8367d_rate_egrQueueBwCtrlRate_get(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t *pIndex);

#endif /* __DAL_RTL8367D_RATE_H__ */
