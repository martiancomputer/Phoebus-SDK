 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_enable_set(rtksw_enable_t enable)
{
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_enable_get(rtksw_enable_t *pEnable)
 ...
 *      - CPU_INSERT_TO_NONE
 */
rtksw_api_ret_t dal_rtl8367d_cpu_tagPort_set(rtksw_port_t port, rtksw_cpu_insert_t mode)
{
    rtksw_api_ret_t retVal;
 ...
 *      - CPU_INSERT_TO_NONE
 */
rtksw_api_ret_t dal_rtl8367d_cpu_tagPort_get(rtksw_port_t *pPort, rtksw_cpu_insert_t *pMode)
{
    rtksw_api_ret_t retVal;
    ...
    *pPort = rtksw_switch_port_P2L_get(port);
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_awarePort_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    ...
    if(rtksw_switch_portmask_L2P_get(pPortmask, &phyMbrPmask) != RT_ERR_OK)
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_awarePort_get(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmsk;
    ...
    if(rtksw_switch_portmask_P2L_get(pmsk, pPortmask) != RT_ERR_OK)
        return RT_ERR_FAILED;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_tagPosition_set(rtksw_cpu_position_t position)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_tagPosition_get(rtksw_cpu_position_t *pPosition)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_tagLength_set(rtksw_cpu_tag_length_t length)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_tagLength_get(rtksw_cpu_tag_length_t *pLength)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_priRemap_set(rtksw_pri_t int_pri, rtksw_pri_t new_pri)
{
    rtksw_api_ret_t retVal;
 ...
 *      Priority of CPU tag assignment for internal asic priority, and it is used for queue usage and packet scheduling.
 */
rtksw_api_ret_t dal_rtl8367d_cpu_priRemap_get(rtksw_pri_t int_pri, rtksw_pri_t *pNew_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_acceptLength_set(rtksw_cpu_rx_length_t length)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_cpu_acceptLength_get(rtksw_cpu_rx_length_t *pLength)
{
    rtksw_api_ret_t retVal;
