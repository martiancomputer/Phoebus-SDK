 ...
 */
rtksw_api_ret_t dal_rtl8367d_trap_unknownUnicastPktAction_set(rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action)
{
    ...
    if((retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_UNKNOWN_UNICAST_DA_PORT_BEHAVE, RTL8367D_Port0_ACTION_MASK << (phyPort * 2), (rtksw_uint32)ucast_action)) != RT_ERR_OK)
        return retVal;
 ...
 *          - UCAST_ACTION_FLOODING
 */
rtksw_api_ret_t dal_rtl8367d_trap_unknownUnicastPktAction_get(rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 * Note:
 */
rtksw_api_ret_t dal_rtl8367d_trap_unmatchMacMoving_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    if((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_L2_SA_MOVING_FORBID, rtksw_switch_port_L2P_get(port), (enable == RTKSW_ENABLED) ? 0 : 1)) != RT_ERR_OK)
        return retVal;
 ...
 * Note:
 */
rtksw_api_ret_t dal_rtl8367d_trap_unmatchMacMoving_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    ...
    if((retVal = rtl8367d_getAsicRegBit(RTL8367D_REG_L2_SA_MOVING_FORBID, rtksw_switch_port_L2P_get(port), &regData)) != RT_ERR_OK)
        return retVal;

    *pEnable = (regData == 0) ? RTKSW_ENABLED : RTKSW_DISABLED;
    return RT_ERR_OK;
}
 ...
 */
rtksw_api_ret_t dal_rtl8367d_trap_unknownMcastPktAction_set(rtksw_port_t port, rtksw_mcast_type_t type, rtksw_trap_mcast_action_t mcast_action)
{
    rtksw_api_ret_t retVal;
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t dal_rtl8367d_trap_unknownMcastPktAction_get(rtksw_port_t port, rtksw_mcast_type_t type, rtksw_trap_mcast_action_t *pMcast_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 rawAction;
    rtksw_uint32 phyPort;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_trap_lldpEnable_set(rtksw_enable_t enabled)
{
    rtksw_api_ret_t retVal;
    ...
    if((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_RMA_LLDP_EN, RTL8367D_RMA_LLDP_EN_OFFSET, (enabled == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
        return retVal;
 ...
 *      - 01:80:c2:00:00:00 ethertype = 0x88CC
 */
rtksw_api_ret_t dal_rtl8367d_trap_lldpEnable_get(rtksw_enable_t *pEnabled)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    ...
    *pEnabled = (regData == 1) ? RTKSW_ENABLED : RTKSW_DISABLED;
    return RT_ERR_OK;
}
 ...
 *      - TRAP_REASON_IGMPMLD
 */
rtksw_api_ret_t dal_rtl8367d_trap_reasonTrapToCpuPriority_set(rtksw_trap_reason_type_t type, rtksw_pri_t priority)
{
    rtksw_api_ret_t retVal;
 ...
 *      - TRAP_REASON_IGMPMLD
 */
rtksw_api_ret_t dal_rtl8367d_trap_reasonTrapToCpuPriority_get(rtksw_trap_reason_type_t type, rtksw_pri_t *pPriority)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_trap_rmaAction_set(rtksw_trap_type_t type, rtksw_trap_rma_action_t rma_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 index;
    ...
    if (type >= 0 && type <= TRAP_UNDEF_GARP_2F)
    {
        if( (type >= 0x4 && type <= 0x7) || (type >= 0x9 && type <= 0x0C) || (0x0F == type))
            ...
            index = (rtksw_uint32)type;

        if ((retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_RMA_CTRL00 + index, RTL8367D_RMA_CTRL00_OPERATION_MASK, (rtksw_uint32)rma_action)) != RT_ERR_OK)
            return retVal;
    }
    else if (type == TRAP_CDP)
    {
        if ((retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_RMA_CTRL_CDP, RTL8367D_RMA_CTRL_CDP_OPERATION_MASK, (rtksw_uint32)rma_action)) != RT_ERR_OK)
            return retVal;
    }
    else if (type  == TRAP_CSSTP)
    {
        if ((retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_RMA_CTRL_CSSTP, RTL8367D_RMA_CTRL_CSSTP_OPERATION_MASK, (rtksw_uint32)rma_action)) != RT_ERR_OK)
            return retVal;
    }
    else if (type  == TRAP_LLDP)
    {
        if ((retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_RMA_CTRL_LLDP, RTL8367D_RMA_CTRL_LLDP_OPERATION_MASK, (rtksw_uint32)rma_action)) != RT_ERR_OK)
            return retVal;
    }
    else
        return RT_ERR_INPUT;
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
rtksw_api_ret_t dal_rtl8367d_trap_rmaAction_get(rtksw_trap_type_t type, rtksw_trap_rma_action_t *pRma_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 index;
    rtksw_uint32 regData;
    ...
    *pRma_action = (rtksw_trap_rma_action_t)regData;
    return RT_ERR_OK;
}
 ...
 *      - TRAP_LLDP.
 */
rtksw_api_ret_t dal_rtl8367d_trap_rmaKeepFormat_set(rtksw_trap_type_t type, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 index;
    ...
    if (type >= 0 && type <= TRAP_UNDEF_GARP_2F)
    {
        ...
        if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_RMA_CTRL00 + index, RTL8367D_RMA_CTRL00_KEEP_FORMAT_OFFSET, (enable == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
            return retVal;
    }
    else if (type == TRAP_CDP)
    {
        if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_RMA_CTRL_CDP, RTL8367D_RMA_CTRL_CDP_KEEP_FORMAT_OFFSET, (enable == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
            return retVal;
    }
    else if (type  == TRAP_CSSTP)
    {
        if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_RMA_CTRL_CSSTP, RTL8367D_RMA_CTRL_CSSTP_KEEP_FORMAT_OFFSET,(enable == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
            return retVal;
    }
    else if (type  == TRAP_LLDP)
    {
        if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_RMA_CTRL_LLDP, RTL8367D_RMA_CTRL_LLDP_KEEP_FORMAT_OFFSET, (enable == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
            return retVal;
    }
    else
        return RT_ERR_INPUT;
 ...
 *      - TRAP_LLDP.
 */
rtksw_api_ret_t dal_rtl8367d_trap_rmaKeepFormat_get(rtksw_trap_type_t type, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 index;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t dal_rtl8367d_trap_portUnknownMacPktAction_set(rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phyPort;
    ...
    if ((retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_LUT_UNKN_SA_CTRL, RTL8367D_LUT_UNKN_SA_CTRL_PORT0_ACT_MASK << (phyPort * 2), (rtksw_uint32)ucast_action)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtksw_api_ret_t dal_rtl8367d_trap_portUnknownMacPktAction_get(rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 phyPort;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t dal_rtl8367d_trap_portUnmatchMacPktAction_set(rtksw_port_t port, rtksw_trap_ucast_action_t ucast_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phyPort;
    ...
    if ((retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_LUT_UNMATCHED_SA_CTRL, RTL8367D_LUT_UNMATCHED_SA_CTRL_PORT0_ACT_MASK << (phyPort * 2), (rtksw_uint32)ucast_action)) != RT_ERR_OK)
        return retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtksw_api_ret_t dal_rtl8367d_trap_portUnmatchMacPktAction_get(rtksw_port_t port, rtksw_trap_ucast_action_t *pUcast_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 phyPort;
