 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_init(rtksw_queue_num_t queueNum)
{
    ...
    CONST_T rtksw_uint32 g_priorityDecision[8] = {0x01,0x10,0x04,0x02,0x08};
    ...
    RTKSW_SCAN_ALL_PHY_PORTMASK(port)
    {
        ...
        if ((retVal = rtl8367d_setAsicRegBit((RTL8367D_REG_PORT0_MISC_CFG + (port << 5)), RTL8367D_PORT0_MISC_CFG_DOT1Q_REMARK_ENABLE_OFFSET, RTKSW_DISABLED)) != RT_ERR_OK)
            return retVal;
        /*Disable DSCP Remarking*/
        if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_SWITCH_CTRL0, RTL8367D_PORT0_REMARKING_DSCP_ENABLE_OFFSET + port, RTKSW_DISABLED)) != RT_ERR_OK)
            return retVal;
    }
 ...
 *      - RTL8367D_PRIDEC_1AD
 */
rtksw_api_ret_t dal_rtl8367d_qos_priSel_set(rtksw_qos_priDecTbl_t index, rtksw_priority_select_t *pPriDec)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RTL8367D_PRIDEC_1AD,
 */
rtksw_api_ret_t dal_rtl8367d_qos_priSel_get(rtksw_qos_priDecTbl_t index, rtksw_priority_select_t *pPriDec)
{
    ...
    memset(pPriDec, 0x00, sizeof(rtksw_priority_select_t));
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pPriRemap_set(rtksw_pri_t dot1p_pri, rtksw_pri_t int_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pPriRemap_get(rtksw_pri_t dot1p_pri, rtksw_pri_t *pInt_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_dscpPriRemap_set(rtksw_dscp_t dscp, rtksw_pri_t int_pri)
{
    rtksw_api_ret_t retVal;
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
rtksw_api_ret_t dal_rtl8367d_qos_dscpPriRemap_get(rtksw_dscp_t dscp, rtksw_pri_t *pInt_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_portPri_set(rtksw_port_t port, rtksw_pri_t int_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_portPri_get(rtksw_port_t port, rtksw_pri_t *pInt_pri)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_queueNum_set(rtksw_port_t port, rtksw_queue_num_t queue_num)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_queueNum_get(rtksw_port_t port, rtksw_queue_num_t *pQueue_num)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 qidx;
    rtksw_uint32 phy_port;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_priMap_set(rtksw_queue_num_t queue_num, rtksw_qos_pri2queue_t *pPri2qid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pri;
 ...
 *      The queue number is from 1 to 8.
 */
rtksw_api_ret_t dal_rtl8367d_qos_priMap_get(rtksw_queue_num_t queue_num, rtksw_qos_pri2queue_t *pPri2qid)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pri;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_schedulingQueue_set(rtksw_port_t port, rtksw_qos_queue_weights_t *pQweights)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 qid;
    rtksw_uint32 phy_port;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_schedulingQueue_get(rtksw_port_t port, rtksw_qos_queue_weights_t *pQweights)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 qid,qtype,qweight,phy_port;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pRemark_set(rtksw_pri_t int_pri, rtksw_pri_t dot1p_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pRemark_get(rtksw_pri_t int_pri, rtksw_pri_t *pDot1p_pri)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkSrcSel_set(rtksw_qos_1pRmkSrc_t type)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkSrcSel_get(rtksw_qos_1pRmkSrc_t *pType)
{
    rtksw_api_ret_t retVal;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_dscpRemark_set(rtksw_pri_t int_pri, rtksw_dscp_t dscp)
{
    rtksw_api_ret_t retVal;
...
rtksw_api_ret_t dal_rtl8367d_qos_dscpRemark_get(rtksw_pri_t int_pri, rtksw_dscp_t *pDscp)
{
    rtksw_api_ret_t retVal;
 ...
 *      priority to TX DSCP value.
 */
rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkSrcSel_set(rtksw_qos_dscpRmkSrc_t type)
{
    rtksw_api_ret_t retVal;
 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkSrcSel_get(rtksw_qos_dscpRmkSrc_t *pType)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_schedulingType_set(rtksw_qos_scheduling_type_t type)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_qos_schedulingType_get(rtksw_qos_scheduling_type_t *pType)
{
    rtksw_api_ret_t retVal;
 ...
 *      The API can set priority of port assignments for queue usage and packet scheduling.
 */
rtksw_api_ret_t dal_rtl8367d_qos_portPriSelIndex_set(rtksw_port_t port, rtksw_qos_priDecTbl_t index)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
 ...
 *      The API can get priority of port assignments for queue usage and packet scheduling.
 */
rtksw_api_ret_t dal_rtl8367d_qos_portPriSelIndex_get(rtksw_port_t port, rtksw_qos_priDecTbl_t *pIndex)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phy_port;
