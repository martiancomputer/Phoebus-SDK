...
#ifndef __DAL_RTL8367D_QOS_H__
#define __DAL_RTL8367D_QOS_H__

#include <qos.h>

#define RTL8367D_QTYPE_STRICT  0
#define RTL8367D_QTYPE_WFQ     1

#define RTL8367D_PRIDEC_PORT   0
#define RTL8367D_PRIDEC_ACL    1
#define RTL8367D_PRIDEC_DSCP   2
#define RTL8367D_PRIDEC_1Q     3
#define RTL8367D_PRIDEC_1AD    4
#define RTL8367D_PRIDEC_END    5
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_init(rtksw_queue_num_t queueNum);
 ...
 *      - RTL8367D_PRIDEC_1AD
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_priSel_set(rtksw_qos_priDecTbl_t index, rtksw_priority_select_t *pPriDec);
 ...
 *      - RTL8367D_PRIDEC_1AD,
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_priSel_get(rtksw_qos_priDecTbl_t index, rtksw_priority_select_t *pPriDec);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pPriRemap_set(rtksw_pri_t dot1p_pri, rtksw_pri_t int_pri);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pPriRemap_get(rtksw_pri_t dot1p_pri, rtksw_pri_t *pInt_pri);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkSrcSel_set(rtksw_qos_1pRmkSrc_t type);
 ...
 *      None
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkSrcSel_get(rtksw_qos_1pRmkSrc_t *pType);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpPriRemap_set(rtksw_dscp_t dscp, rtksw_pri_t int_pri);
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpPriRemap_get(rtksw_dscp_t dscp, rtksw_pri_t *pInt_pri);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_portPri_set(rtksw_port_t port, rtksw_pri_t int_pri) ;
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_portPri_get(rtksw_port_t port, rtksw_pri_t *pInt_pri) ;
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_queueNum_set(rtksw_port_t port, rtksw_queue_num_t queue_num);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_queueNum_get(rtksw_port_t port, rtksw_queue_num_t *pQueue_num);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_priMap_set(rtksw_queue_num_t queue_num, rtksw_qos_pri2queue_t *pPri2qid);
 ...
 *      The queue number is from 1 to 8.
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_priMap_get(rtksw_queue_num_t queue_num, rtksw_qos_pri2queue_t *pPri2qid);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_schedulingQueue_set(rtksw_port_t port, rtksw_qos_queue_weights_t *pQweights);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_schedulingQueue_get(rtksw_port_t port, rtksw_qos_queue_weights_t *pQweights);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pRemarkEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pRemark_set(rtksw_pri_t int_pri, rtksw_pri_t dot1p_pri);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_1pRemark_get(rtksw_pri_t int_pri, rtksw_pri_t *pDot1p_pri);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpRemark_set(rtksw_pri_t int_pri, rtksw_dscp_t dscp);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpRemark_get(rtksw_pri_t int_pri, rtksw_dscp_t *pDscp);
 ...
 *      priority to TX DSCP value.
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkSrcSel_set(rtksw_qos_dscpRmkSrc_t type);

/* Function Name:
 *      dal_rtl8367d_qos_dcpRemarkSrcSel_get
 * Description:
 ...
 *      None
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_dscpRemarkSrcSel_get(rtksw_qos_dscpRmkSrc_t *pType);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_schedulingType_set(rtksw_qos_scheduling_type_t type);
 ...
 */
extern rtksw_api_ret_t dal_rtl8367d_qos_schedulingType_get(rtksw_qos_scheduling_type_t *pType);
 ...
 *      The API can set priority of port assignments for queue usage and packet scheduling.
 */
 extern rtksw_api_ret_t dal_rtl8367d_qos_portPriSelIndex_set(rtksw_port_t port, rtksw_qos_priDecTbl_t index);
 ...
 *      The API can get priority of port assignments for queue usage and packet scheduling.
 */
 extern rtksw_api_ret_t dal_rtl8367d_qos_portPriSelIndex_get(rtksw_port_t port, rtksw_qos_priDecTbl_t *pIndex);

#endif /* __DAL_RTL8367D_QOS_H__*/
