 ...
 */
static rtksw_api_ret_t _dal_rtl8367d_switch_portMaxPktLen_set(rtksw_port_t port, rtksw_switch_maxPktLen_linkSpeed_t speed, rtksw_uint32 cfgId)
{
    ...
    if((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_MAX_LENGTH_CFG, (speed * 8) + rtksw_switch_port_L2P_get(port), cfgId)) != RT_ERR_OK)
        return retVal;

    return RT_ERR_OK;
}

static rtksw_api_ret_t _dal_rtl8367d_switch_portMaxPktLen_get(rtksw_port_t port, rtksw_switch_maxPktLen_linkSpeed_t speed, rtksw_uint32 *pCfgId)
{
    rtksw_api_ret_t retVal;
    ...
    if((retVal = rtl8367d_getAsicRegBit(RTL8367D_REG_MAX_LENGTH_CFG, (speed * 8) + rtksw_switch_port_L2P_get(port), pCfgId)) != RT_ERR_OK)
        return retVal;

    return RT_ERR_OK;
}

static rtksw_api_ret_t _dal_rtl8367d_switch_maxPktLenCfg_set(rtksw_uint32 cfgId, rtksw_uint32 pktLen)
{
    rtksw_api_ret_t retVal;
...
static rtksw_api_ret_t _dal_rtl8367d_switch_maxPktLenCfg_get(rtksw_uint32 cfgId, rtksw_uint32 *pPktLen)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_switch_init(void)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 idx;
    ...
    {
        if ((retVal = dal_rtl8367d_rate_shareMeter_set(idx, METER_TYPE_KBPS, RTL8367D_QOS_RATE_INPUT_MAX_HSG, RTKSW_DISABLED)) != RT_ERR_OK)
            return retVal;
    }
    ...
    switch (rtksw_switch_chipType_get())
    {
		...
		printk("%s.%d: init\n", __func__, __LINE__);
            ...
            {
                if ((retVal = rtl8367d_setAsicReg(0xE000 + idx, (rtksw_uint32)NCtrl_init[idx])) != RT_ERR_OK)
                    return retVal;
            }
 ...
 * Note:
 */
rtksw_api_ret_t dal_rtl8367d_switch_portMaxPktLen_set(rtksw_port_t port, rtksw_switch_maxPktLen_linkSpeed_t speed, rtksw_uint32 cfgId)
{
    rtksw_api_ret_t retVal;
 ...
 * Note:
 */
rtksw_api_ret_t dal_rtl8367d_switch_portMaxPktLen_get(rtksw_port_t port, rtksw_switch_maxPktLen_linkSpeed_t speed, rtksw_uint32 *pCfgId)
{
    rtksw_api_ret_t retVal;
 ...
 * Note:
 */
rtksw_api_ret_t dal_rtl8367d_switch_maxPktLenCfg_set(rtksw_uint32 cfgId, rtksw_uint32 pktLen)
{
    rtksw_api_ret_t retVal;
 ...
 * Note:
 */
rtksw_api_ret_t dal_rtl8367d_switch_maxPktLenCfg_get(rtksw_uint32 cfgId, rtksw_uint32 *pPktLen)
{
    rtksw_api_ret_t retVal;
