 ...
 *      None
 */
rtksw_api_ret_t dal_rtl8367d_gpio_input_get(rtksw_uint32 pin, rtksw_uint32 *pInput)
{
 ...
 */
rtksw_api_ret_t dal_rtl8367d_gpio_output_set(rtksw_uint32 pin, rtksw_uint32 output)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_gpio_output_get(rtksw_uint32 pin, rtksw_uint32 *pOutput)
{
    rtksw_api_ret_t retVal;
 ...
 *      The API can set GPIO pin output 1 or 0.
 */
rtksw_api_ret_t dal_rtl8367d_gpio_state_set(rtksw_uint32 pin, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_gpio_state_get(rtksw_uint32 pin, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 gpioState;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_gpio_mode_set(rtksw_uint32 pin, rtksw_gpio_mode_t mode)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_gpio_mode_get(rtksw_uint32 pin, rtksw_gpio_mode_t *pMode)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 gpioMode;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_gpio_aclEnClear_set(rtksw_uint32 pin)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_gpio_aclEnClear_get(rtksw_uint32 pin, rtksw_enable_t *pAclEn)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_getAsicRegBit(RTL8367D_REG_ACL_GPIO0 + (pin / 16), (pin % 16), (rtksw_uint32 *)pAclEn)) != RT_ERR_OK)
        return retVal;
