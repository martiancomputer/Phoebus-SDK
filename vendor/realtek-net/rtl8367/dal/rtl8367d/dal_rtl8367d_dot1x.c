 ...
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_unauthPacketOper_set(rtksw_port_t port, rtksw_dot1x_unauth_action_t unauth_action)
{
 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_unauthPacketOper_get(rtksw_port_t port, rtksw_dot1x_unauth_action_t *pUnauth_action)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phyPort;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_eapolFrame2CpuEnable_set(rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 action;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_eapolFrame2CpuEnable_get(rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 action;
 ...
 *      - RTKSW_ENABLED
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_portBasedEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_DOT1X_PORT_ENABLE, rtksw_switch_port_L2P_get(port), enable)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_portBasedEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_getAsicRegBit(RTL8367D_REG_DOT1X_PORT_ENABLE, rtksw_switch_port_L2P_get(port), pEnable)) != RT_ERR_OK)
        return retVal;
 ...
 *      - AUTH
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_portBasedAuthStatus_set(rtksw_port_t port, rtksw_dot1x_auth_status_t port_auth)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_DOT1X_PORT_AUTH, rtksw_switch_port_L2P_get(port), port_auth)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_portBasedAuthStatus_get(rtksw_port_t port, rtksw_dot1x_auth_status_t *pPort_auth)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_getAsicRegBit(RTL8367D_REG_DOT1X_PORT_AUTH, rtksw_switch_port_L2P_get(port), pPort_auth)) != RT_ERR_OK)
        return retVal;
 ...
 *      - IN
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_portBasedDirection_set(rtksw_port_t port, rtksw_dot1x_direction_t port_direction)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_DOT1X_PORT_OPDIR, rtksw_switch_port_L2P_get(port), port_direction)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_dot1x_portBasedDirection_get(rtksw_port_t port, rtksw_dot1x_direction_t *pPort_direction)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_getAsicRegBit(RTL8367D_REG_DOT1X_PORT_OPDIR, rtksw_switch_port_L2P_get(port), pPort_direction)) != RT_ERR_OK)
        return retVal;
