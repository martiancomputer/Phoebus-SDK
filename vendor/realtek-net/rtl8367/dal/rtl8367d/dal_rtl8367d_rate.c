...
static rtksw_api_ret_t _dal_rtl8367d_rate_egrQueueBwCtrlRate_get(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t *pIndex)
{
...
static rtksw_api_ret_t _dal_rtl8367d_rate_egrQueueBwCtrlRate_set(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t index)
{
    rtksw_api_ret_t retVal;
...
static rtksw_api_ret_t _dal_rtl8367e_rate_egrQueueBwCtrlRate_get(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t *pIndex)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 apridx;
    rtksw_uint32 phy_port;
...
static rtksw_api_ret_t _dal_rtl8367e_rate_egrQueueBwCtrlRate_set(rtksw_port_t port, rtksw_qid_t queue, rtksw_meter_id_t index)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 offset_idx;
    rtksw_uint32 phy_port;
