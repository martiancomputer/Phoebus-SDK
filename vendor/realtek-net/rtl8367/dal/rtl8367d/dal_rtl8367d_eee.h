 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_eee_portEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t dal_rtl8367d_eee_portEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
