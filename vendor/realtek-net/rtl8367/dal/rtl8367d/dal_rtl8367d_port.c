...
const rtksw_uint32 HSGCfg[][2] = { {0x0427, 0x4E0C}, {0x0428, 0xAA00}, {0x0425, 0x5189}, {0x0424, 0x8414}, {0x0423, 0x1020}, {0x0410, 0x0002}, {0x0504, 0x051B}, {0x0421, 0x8E13}, {0x0422, 0x1140}, {0x0004, 0x074F}};
const rtksw_uint32 SGCfg[][2] = { {0x0427, 0x4E0C}, {0x0428, 0xAA00}, {0x0425, 0x5189}, {0x0424, 0x8414}, {0x0423, 0x1020}, {0x0410, 0x0002}, {0x0484, 0x011B}, {0x0421, 0x8E13}, {0x0422, 0x1140}, {0x0004, 0x074F}};
const rtksw_uint32 Fiber1000M100MCfg[][2] = { {0x0427, 0x4E0C}, {0x0428, 0xAA00}, {0x0425, 0x5189}, {0x0424, 0x8414}, {0x0423, 0x1020}, {0x0410, 0x0002}, {0x0484, 0x011B}, {0x0421, 0x8E13}, {0x0422, 0x1140}, {0x0004, 0x074F}, {0x0040, 0x2100}, {0x0044, 0x0C01}, {0x0040, 0x1140}, {0x0044, 0x01A0}, {0x0001, 0x0F20}};
const rtksw_uint32 Fiber1000MCfg[][2] = { {0x0427, 0x4E0C}, {0x0428, 0xAA00}, {0x0425, 0x5189}, {0x0424, 0x8414}, {0x0423, 0x1020}, {0x0410, 0x0002}, {0x0484, 0x011B}, {0x0421, 0x8E13}, {0x0422, 0x1140}, {0x0004, 0x074F}, {0x0040, 0x1140}, {0x0044, 0x01A0}};
const rtksw_uint32 Fiber100MCfg[][2] = { {0x0427, 0x4E0C}, {0x0428, 0xAA00}, {0x0425, 0x5189}, {0x0424, 0x8414}, {0x0423, 0x1020}, {0x0410, 0x0002}, {0x0484, 0x011B}, {0x0421, 0x8E13}, {0x0422, 0x1140}, {0x0004, 0x074F}, {0x0040, 0x2100}, {0x0044, 0x0C01}};
const rtksw_uint32 Fiber2P5GCfg[][2] = { {0x0427, 0x4E0C}, {0x0428, 0xAA00}, {0x0425, 0x5189}, {0x0424, 0x8414}, {0x0423, 0x1020}, {0x0410, 0x0002}, {0x0504, 0x051B}, {0x0421, 0x8E13}, {0x0422, 0x1140}, {0x0040, 0x1140}, {0x0044, 0x01A0}};

const rtksw_uint32 RTCTPatch[][2] =
{
    {0xa436, 0x8160},
    {0xa438, 0x6de5},
    {0xa436, 0x8162},
...
static rtksw_api_ret_t _dal_rtl8367d_setAsicPHYOCPReg(rtksw_uint32 phyNo, rtksw_uint32 ocpAddr, rtksw_uint32 ocpData )
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 busyFlag, checkCounter;
    rtksw_uint32 ocpAddrPrefix, ocpAddr9_6, ocpAddr5_1;
...
static rtksw_api_ret_t _dal_rtl8367d_getAsicPHYOCPReg(rtksw_uint32 phyNo, rtksw_uint32 ocpAddr, rtksw_uint32 *pRegData )
{
    ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 busyFlag,checkCounter;
...
static rtksw_api_ret_t _dal_rtl8367d_setAsicPHYReg(rtksw_uint32 phyNo, rtksw_uint32 phyAddr, rtksw_uint32 phyData )
{
    rtksw_uint32 ocp_addr;
...
static rtksw_api_ret_t _dal_rtl8367d_getAsicPHYReg(rtksw_uint32 phyNo, rtksw_uint32 phyAddr, rtksw_uint32 *pRegData )
{
    rtksw_uint32 ocp_addr;
...
static rtksw_api_ret_t _dal_rtl8367d_setAsicPortExtMode(rtksw_uint32 id, rtksw_uint32 mode)
{
    ...
    if (id == 1)
    {
        ...
        else if ((mode == MODE_EXT_SGMII) || (mode == MODE_EXT_HSGMII) || (mode == MODE_EXT_1000X_100FX) || (mode == MODE_EXT_1000X) || (mode == MODE_EXT_100FX) || (mode == MODE_EXT_FIBER_2P5G))
        {
            ...
            {
                case MODE_EXT_SGMII:
                    for(i = 0; i < sizeof(SGCfg) / (sizeof(rtksw_uint32) * 2); i++)
                    {
                ...
                case MODE_EXT_HSGMII:
                    for(i = 0; i < sizeof(HSGCfg) / (sizeof(rtksw_uint32) * 2); i++)
                    {
                ...
                case MODE_EXT_1000X_100FX:
                    for(i = 0; i < sizeof(Fiber1000M100MCfg) / (sizeof(rtksw_uint32) * 2); i++)
                    {
                    ...
                    break;
                case MODE_EXT_1000X:
                    for(i = 0; i < sizeof(Fiber1000MCfg) / (sizeof(rtksw_uint32) * 2); i++)
                    {
                    ...
                    break;
                case MODE_EXT_100FX:
                    for(i = 0; i < sizeof(Fiber100MCfg) / (sizeof(rtksw_uint32) * 2); i++)
                    {
                ...
                case MODE_EXT_FIBER_2P5G:
                    for(i = 0; i < sizeof(Fiber2P5GCfg) / (sizeof(rtksw_uint32) * 2); i++)
                    {
...
static rtksw_api_ret_t _dal_rtl8367d_getAsicPortExtMode(rtksw_uint32 id, rtksw_uint32 *pMode)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
...
static rtksw_api_ret_t _dal_rtl8367d_port_sgmiiLinkStatus_get(rtksw_port_t port, rtksw_data_t *pSignalDetect, rtksw_data_t *pSync, rtksw_port_linkStatus_t *pLink)
{
    rtksw_api_ret_t retVal;
...
static rtksw_api_ret_t _dal_rtl8367d_port_sgmiiNway_set(rtksw_port_t port, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regValue;
    rtksw_uint32 serdesAddr;
...
static rtksw_api_ret_t _dal_rtl8367d_port_sgmiiNway_get(rtksw_port_t port, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regValue;
    rtksw_uint32 serdesAddr;
...
static rtksw_api_ret_t _dal_rtl8367d_port_fiberAbility_set(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility)
{
    rtksw_api_ret_t retVal;
    rtksw_port_media_t media_type;
    rtksw_mode_ext_t mode;
    rtksw_port_mac_ability_t portAbility;
    rtksw_uint32 regData;
    rtksw_uint32 sdsId;
    rtksw_uint32 i;
...
static rtksw_api_ret_t _dal_rtl8367d_port_fiberAbility_get(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility)
{
    rtksw_api_ret_t retVal;
    rtksw_port_media_t media_type;
    rtksw_mode_ext_t mode;
    ...
    memset(pAbility, 0x00, sizeof(rtksw_port_fiber_ability_t));
...
static rtksw_api_ret_t _dal_rtl8367e_port_maxPacketLength_set(rtksw_port_t port, rtksw_uint32 length)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_setAsicReg(RTL8367D_REG_PORT0_PKTMAXLEN + (rtksw_switch_port_L2P_get(port) * 0x20), length)) != RT_ERR_OK)
        return retVal;

    return RT_ERR_OK;
}

static rtksw_api_ret_t _dal_rtl8367e_port_maxPacketLength_get(rtksw_port_t port, rtksw_uint32 *pLength)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_getAsicReg(RTL8367D_REG_PORT0_PKTMAXLEN + (rtksw_switch_port_L2P_get(port) * 0x20), pLength)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyAutoNegoAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t       retVal;
    ...
    rtksw_port_media_t    media_type;
    rtksw_port_fiber_ability_t fiberAbility;
    ...
    if (rtksw_switch_isComboPort(port) == RT_ERR_OK)
    {
        ...
        if(media_type == RTKSW_PORT_MEDIA_FIBER)
        {
            memset(&fiberAbility, 0x00, sizeof(rtksw_port_fiber_ability_t));
        ...
        else if (media_type == RTKSW_PORT_MEDIA_RGMII)
            return RT_ERR_PORT_ID;
    }
    ...
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_1000_BASET_CONTROL_REG, &phyData)) != RT_ERR_OK)
        return retVal;

    phyData = (phyData & (~0x0200)) | phyEnMsk9 ;

    if ((retVal = _dal_rtl8367d_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_1000_BASET_CONTROL_REG, phyData)) != RT_ERR_OK)
        return retVal;

    /*Auto-Negotiation control register setting*/
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_AN_ADVERTISEMENT_REG, &phyData)) != RT_ERR_OK)
        return retVal;

    phyData = (phyData & (~0x0DE0)) | phyEnMsk4;
    if ((retVal = _dal_rtl8367d_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_AN_ADVERTISEMENT_REG, phyData)) != RT_ERR_OK)
        return retVal;

    /*Control register setting and restart auto*/
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, &phyData)) != RT_ERR_OK)
        return retVal;
    ...
    if ((retVal = _dal_rtl8367d_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, phyData)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyAutoNegoAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t       retVal;
    ...
    /*Control register setting and restart auto*/
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, &phyData0)) != RT_ERR_OK)
        return retVal;

    /*Auto-Negotiation control register setting*/
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_AN_ADVERTISEMENT_REG, &phyData4)) != RT_ERR_OK)
        return retVal;

    /*1000 BASE-T control register setting*/
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_1000_BASET_CONTROL_REG, &phyData9)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyForceModeAbility_set(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
     rtksw_api_ret_t      retVal;
     rtksw_uint32         phyData;
     rtksw_uint32         phyEnMsk0;
 ...
 *      Get the capablity of specified PHY.
 */
rtksw_api_ret_t dal_rtl8367d_port_phyForceModeAbility_get(rtksw_port_t port, rtksw_port_phy_ability_t *pAbility)
{
    rtksw_api_ret_t       retVal;
    rtksw_uint32          phyData0;
    rtksw_uint32          phyData4;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyStatus_get(rtksw_port_t port, rtksw_port_linkStatus_t *pLinkStatus, rtksw_port_speed_t *pSpeed, rtksw_port_duplex_t *pDuplex)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 phyData;
    ...
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_RESOLVED_REG, &phyData)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_macForceLink_set(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 reg_data = 0;
    rtksw_uint32 reg_data2;
    rtksw_uint32 rtl8367d_speed;
    ...
    if (pPortability->forcemode >1|| pPortability->speed >= RTKSW_PORT_SPEED_END || pPortability->duplex > 1 ||
    ...
    /* Link down */
    if((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_MAC0_FORCE_SELECT + rtksw_switch_port_L2P_get(port), RTL8367D_MAC0_FORCE_SELECT_LINK_ABLTY_OFFSET, 0)) != RT_ERR_OK)
        return retVal;

    /* Configure ability without link */
    if((retVal = rtl8367d_setAsicReg(RTL8367D_REG_MAC0_FORCE_SELECT + rtksw_switch_port_L2P_get(port), reg_data & ~(0x0010))) != RT_ERR_OK)
        return retVal;

    if((retVal = rtl8367d_setAsicReg(RTL8367D_REG_MAC0_FORCE_SELECT_EN + rtksw_switch_port_L2P_get(port), reg_data2)) != RT_ERR_OK)
        return retVal;

    /* Link up */
    if (pPortability->link == 1)
    {
        if((retVal = rtl8367d_setAsicReg(RTL8367D_REG_MAC0_FORCE_SELECT + rtksw_switch_port_L2P_get(port), reg_data)) != RT_ERR_OK)
            return retVal;
    }
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_macForceLink_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 reg_data;
    rtksw_uint32 reg_data2;
    rtksw_uint32 rtl8367d_speed;
    ...
    if((retVal = rtl8367d_getAsicReg(RTL8367D_REG_MAC0_FORCE_SELECT + rtksw_switch_port_L2P_get(port), &reg_data)) != RT_ERR_OK)
        return retVal;

    if((retVal = rtl8367d_getAsicReg(RTL8367D_REG_MAC0_FORCE_SELECT_EN + rtksw_switch_port_L2P_get(port), &reg_data2)) != RT_ERR_OK)
        return retVal;

    if ((reg_data == 0x1000) && (reg_data2 == 0x3000) && (rtksw_switch_isExtPort(port) == RT_ERR_OK))
    {
 ...
 *      - MODE_EXT_HSGMII,
 */
rtksw_api_ret_t dal_rtl8367d_port_macForceLinkExt_set(rtksw_port_t port, rtksw_mode_ext_t mode, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    ...
    if (port == UTP_PORT4)
    {
        ...
        if (media_type != RTKSW_PORT_MEDIA_RGMII)
            return RT_ERR_PORT_ID;
    }
    else
    {
    ...
    if (pPortability->link == 0)
    {
        ...
        {
            if((retVal = rtl8367d_setAsicReg(RTL8367D_REG_MAC0_FORCE_SELECT + rtksw_switch_port_L2P_get(port), 0x1000)) != RT_ERR_OK)
                return retVal;

            if((retVal = rtl8367d_setAsicReg(RTL8367D_REG_MAC0_FORCE_SELECT_EN + rtksw_switch_port_L2P_get(port), 0x3000)) != RT_ERR_OK)
                return retVal;
        }
        else
        {
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_macForceLinkExt_get(rtksw_port_t port, rtksw_mode_ext_t *pMode, rtksw_port_mac_ability_t *pPortability)
{
    rtksw_api_ret_t retVal;
    rtksw_port_mac_ability_t ability;
    rtksw_uint32 ext_id;
    ...
    if ((retVal = _dal_rtl8367d_getAsicPortExtMode(ext_id, (rtksw_uint32 *)pMode)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_macStatus_get(rtksw_port_t port, rtksw_port_mac_ability_t *pPortstatus)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    rtksw_uint32 rtl8367d_speed;
    ...
    if ((retVal = rtl8367d_getAsicReg(RTL8367D_REG_PORT0_STATUS+rtksw_switch_port_L2P_get(port), &regData)) != RT_ERR_OK)
        return retVal;

    memset(pPortstatus, 0x00, sizeof(rtksw_port_mac_ability_t));
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_macLocalLoopbackEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      data;
    ...
    if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_PORT0_MISC_CFG + (rtksw_switch_port_L2P_get(port) << 5), RTL8367D_PORT0_MISC_CFG_MAC_LOOPBACK_OFFSET, (enable == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
        return retVal;

    if(rtksw_switch_isUtpPort(port) == RT_ERR_OK)
    {
        if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, &data)) != RT_ERR_OK)
            return retVal;
        ...
        if ((retVal = _dal_rtl8367d_setAsicPHYReg(rtksw_switch_port_L2P_get(port), PHY_CONTROL_REG, data)) != RT_ERR_OK)
            return retVal;
    }
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367d_port_macLocalLoopbackEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
    ...
    if ((retVal = rtl8367d_getAsicRegBit(RTL8367D_REG_PORT0_MISC_CFG + (rtksw_switch_port_L2P_get(port) << 5), RTL8367D_PORT0_MISC_CFG_MAC_LOOPBACK_OFFSET, &regData)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyReg_set(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t regData)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = _dal_rtl8367d_setAsicPHYReg(rtksw_switch_port_L2P_get(port), reg, regData)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyReg_get(rtksw_port_t port, rtksw_port_phy_reg_t reg, rtksw_port_phy_data_t *pData)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = _dal_rtl8367d_getAsicPHYReg(rtksw_switch_port_L2P_get(port), reg, pData)) != RT_ERR_OK)
        return retVal;
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367d_port_phyOCPReg_set(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 ocpData )
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = _dal_rtl8367d_setAsicPHYOCPReg(rtksw_switch_port_L2P_get(port), ocpAddr, ocpData)) != RT_ERR_OK)
        return retVal;
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367d_port_phyOCPReg_get(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 *pRegData )
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = _dal_rtl8367d_getAsicPHYOCPReg(rtksw_switch_port_L2P_get(port), ocpAddr, pRegData)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLE (Backpressure)
 */
rtksw_api_ret_t dal_rtl8367d_port_backpressureEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_CFG_BACKPRESSURE, RTL8367D_LONGTXE_OFFSET, (enable == RTKSW_ENABLED) ? 0 : 1)) != RT_ERR_OK)
        return retVal;
 ...
 *      - ENABLE (Backpressure)
 */
rtksw_api_ret_t dal_rtl8367d_port_backpressureEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367d_port_adminEnable_set(rtksw_port_t port, rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32      data;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367d_port_adminEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32      data;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_isolation_set(rtksw_port_t port, rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
    ...
    if ((retVal = rtl8367d_setAsicReg(RTL8367D_REG_PORT_ISOLATION_PORT0_MASK + rtksw_switch_port_L2P_get(port), pmask)) != RT_ERR_OK)
        return retVal;
 ...
 *      A port can only transmit packet to ports included in permitted portmask
 */
rtksw_api_ret_t dal_rtl8367d_port_isolation_get(rtksw_port_t port, rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 pmask;
    ...
    if ((retVal = rtl8367d_getAsicReg(RTL8367D_REG_PORT_ISOLATION_PORT0_MASK + rtksw_switch_port_L2P_get(port), &pmask)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_rgmiiDelayExt_set(rtksw_port_t port, rtksw_data_t txDelay, rtksw_data_t rxDelay)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_rgmiiDelayExt_get(rtksw_port_t port, rtksw_data_t *pTxDelay, rtksw_data_t *pRxDelay)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367d_port_phyEnableAll_set(rtksw_enable_t enable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 data;
    rtksw_uint32 port;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367d_port_phyEnableAll_get(rtksw_enable_t *pEnable)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 data;
    rtksw_uint32 port;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyComboPortMedia_set(rtksw_port_t port, rtksw_port_media_t media)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 i;
    rtksw_uint32 mux;
    ...
    if (currentMedia == RTKSW_PORT_MEDIA_FIBER)
    {
        if( (retVal = rtl8367d_setAsicRegBits(RTL8367D_REG_FIBER_CFG_2, RTL8367D_SDS_RX_DISABLE_MASK, 0)) != RT_ERR_OK)
            return retVal;
    ...
    else if (currentMedia == RTKSW_PORT_MEDIA_RGMII)
    {
        /* Disable RGMII */
    ...
    else if(media == RTKSW_PORT_MEDIA_RGMII)
    {
 ...
 *      The API can Set Combo port media type.
 */
rtksw_api_ret_t dal_rtl8367d_port_phyComboPortMedia_get(rtksw_port_t port, rtksw_port_media_t *pMedia)
{
    rtksw_api_ret_t   retVal;
    rtksw_uint32      data;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_rtctEnable_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_port_t port;
    rtksw_uint32 regData;
    ...
    {
        /* Initialize RTCT */
        for(i = 0; i < sizeof(RTCTPatch) / (sizeof(rtksw_uint32) * 2); i++)
        {
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_rtctDisable_set(rtksw_portmask_t *pPortmask)
{
    rtksw_api_ret_t retVal;
    rtksw_port_t port;
    rtksw_uint32 regData;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_rtctResult_get(rtksw_port_t port, rtksw_rtctResult_t *pRtctResult)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_sgmiiLinkStatus_get(rtksw_port_t port, rtksw_data_t *pSignalDetect, rtksw_data_t *pSync, rtksw_port_linkStatus_t *pLink)
{
    rtksw_api_ret_t retVal, retVal2;
    rtksw_uint32 running;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_sgmiiNway_set(rtksw_port_t port, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal, retVal2;
    rtksw_uint32 running;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_sgmiiNway_get(rtksw_port_t port, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal, retVal2;
    rtksw_uint32 running;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_autoDos_set(rtksw_port_autoDosType_t type, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal;
    ...
    if ((retVal = rtl8367d_setAsicRegBit(RTL8367D_REG_DOS_CFG, RTL8367D_DROP_DAEQSA_OFFSET + type, (state == RTKSW_ENABLED) ? 1 : 0)) != RT_ERR_OK)
        return retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_autoDos_get(rtksw_port_autoDosType_t type, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 regData;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_fiberAbility_set(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility)
{
    rtksw_api_ret_t retVal, retVal2;
    rtksw_uint32 running;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_fiberAbility_get(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility)
{
    rtksw_api_ret_t retVal, retVal2;
    rtksw_uint32 running;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyMdx_set(rtksw_port_t port, rtksw_port_phy_mdix_mode_t mode)
{
    rtksw_uint32 regData;
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyMdx_get(rtksw_port_t port, rtksw_port_phy_mdix_mode_t *pMode)
{
    rtksw_uint32 regData;
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyMdxStatus_get(rtksw_port_t port, rtksw_port_phy_mdix_status_t *pStatus)
{
    rtksw_uint32 regData;
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyTestMode_set(rtksw_port_t port, rtksw_port_phy_test_mode_t mode)
{
    rtksw_uint32          data, i;
    rtksw_api_ret_t       retVal;
    ...
    if(mode >= RTKSW_PHY_TEST_MODE_END)
        return RT_ERR_INPUT;
    ...
    if (RTKSW_PHY_TEST_MODE_NORMAL != mode)
    {
        ...
        {
            if(rtksw_switch_isUtpPort(i) == RT_ERR_OK)
            {
                if(i != port)
                {
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyTestMode_get(rtksw_port_t port, rtksw_port_phy_test_mode_t *pMode)
{
    rtksw_uint32      data;
    rtksw_api_ret_t   retVal;
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367d_port_maxPacketLength_set(rtksw_port_t port, rtksw_uint32 length)
{
    rtksw_api_ret_t retVal;
 ...
 *      None.
 */
rtksw_api_ret_t dal_rtl8367d_port_maxPacketLength_get(rtksw_port_t port, rtksw_uint32 *pLength)
{
    rtksw_api_ret_t retVal;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t dal_rtl8367d_port_phyLinkDownPowerSaving_set(rtksw_port_t port, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 ocpData;
    ...
    if ((retVal = _dal_rtl8367d_getAsicPHYOCPReg(rtksw_switch_port_L2P_get(port), 0xA430, &ocpData)) != RT_ERR_OK)
        return retVal;
    ...
    if (state == RTKSW_ENABLED)
     ...
     if ((retVal = _dal_rtl8367d_setAsicPHYOCPReg(rtksw_switch_port_L2P_get(port), 0xA430, ocpData)) != RT_ERR_OK)
        return retVal;   
 ...
 */
rtksw_api_ret_t dal_rtl8367d_port_phyLinkDownPowerSaving_get(rtksw_port_t port, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal;
    rtksw_uint32 ocpData;
    ...
    *pState = (ocpData & (0x0001 << 2)) == (0x0001 << 2) ? RTKSW_ENABLED : RTKSW_DISABLED;
    return retVal;
}
