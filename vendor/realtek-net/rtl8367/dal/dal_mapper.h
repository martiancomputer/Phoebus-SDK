...
typedef struct dal_mapper_s {
    ...
    rtksw_api_ret_t (*port_phyOCPReg_set)(rtksw_port_t, rtksw_uint32, rtksw_uint32);
    rtksw_api_ret_t (*port_phyOCPReg_get)(rtksw_port_t, rtksw_uint32, rtksw_uint32 *);
    ...
    rtksw_api_ret_t (*port_fiberAbility_set)(rtksw_port_t, rtksw_port_fiber_ability_t *);
    rtksw_api_ret_t (*port_fiberAbility_get)(rtksw_port_t, rtksw_port_fiber_ability_t *);
    rtksw_api_ret_t (*port_phyMdx_set)(rtksw_port_t, rtksw_port_phy_mdix_mode_t);
    rtksw_api_ret_t (*port_phyMdx_get)(rtksw_port_t, rtksw_port_phy_mdix_mode_t *);
    rtksw_api_ret_t (*port_phyMdxStatus_get)(rtksw_port_t, rtksw_port_phy_mdix_status_t *);
    rtksw_api_ret_t (*port_phyTestMode_set)(rtksw_port_t, rtksw_port_phy_test_mode_t);
    rtksw_api_ret_t (*port_phyTestMode_get)(rtksw_port_t, rtksw_port_phy_test_mode_t *);
    rtksw_api_ret_t (*port_maxPacketLength_set)(rtksw_port_t, rtksw_uint32);
    rtksw_api_ret_t (*port_maxPacketLength_get)(rtksw_port_t, rtksw_uint32 *);
    rtksw_api_ret_t (*port_phyGreenEthernet_set)(rtksw_port_t, rtksw_enable_t);
    rtksw_api_ret_t (*port_phyGreenEthernet_get)(rtksw_port_t, rtksw_enable_t *);
    rtksw_api_ret_t (*port_phyLinkDownPowerSaving_set)(rtksw_port_t, rtksw_enable_t);
    rtksw_api_ret_t (*port_phyLinkDownPowerSaving_get)(rtksw_port_t, rtksw_enable_t *);
    ...
    /*GPIO*/
    rtksw_api_ret_t (*gpio_input_get)(rtksw_uint32, rtksw_uint32 *);
    rtksw_api_ret_t (*gpio_output_set)(rtksw_uint32, rtksw_uint32);
    rtksw_api_ret_t (*gpio_output_get)(rtksw_uint32, rtksw_uint32 *);
    rtksw_api_ret_t (*gpio_state_set)(rtksw_uint32, rtksw_enable_t);
    rtksw_api_ret_t (*gpio_state_get)(rtksw_uint32, rtksw_enable_t *);
    rtksw_api_ret_t (*gpio_mode_set)(rtksw_uint32, rtksw_gpio_mode_t);
    rtksw_api_ret_t (*gpio_mode_get)(rtksw_uint32, rtksw_gpio_mode_t *);
    rtksw_api_ret_t (*gpio_aclEnClear_set)(rtksw_uint32);
    rtksw_api_ret_t (*gpio_aclEnClear_get)(rtksw_uint32, rtksw_enable_t *);
