 ...
 *      This API enables H/W IGMP and set a default initial configuration.
 */
extern rtksw_api_ret_t rtksw_igmp_init(void);
 ...
 *      This API set H/W IGMP state.
 */
extern rtksw_api_ret_t rtksw_igmp_state_set(rtksw_enable_t enabled);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_state_get(rtksw_enable_t *pEnabled);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_static_router_port_set(rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_static_router_port_get(rtksw_portmask_t *pPortmask);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_protocol_set(rtksw_port_t port, rtksw_igmp_protocol_t protocol, rtksw_igmp_action_t action);
 ...
 *      This API set IGMP/MLD protocol action
 */
extern rtksw_api_ret_t rtksw_igmp_protocol_get(rtksw_port_t port, rtksw_igmp_protocol_t protocol, rtksw_igmp_action_t *pAction);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_fastLeave_set(rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_fastLeave_get(rtksw_enable_t *pState);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_maxGroup_set(rtksw_port_t port, rtksw_uint32 group);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_maxGroup_get(rtksw_port_t port, rtksw_uint32 *pGroup);
 ...
 */
extern rtksw_api_ret_t rtksw_igmp_currentGroup_get(rtksw_port_t port, rtksw_uint32 *pGroup);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_tableFullAction_set(rtksw_igmp_tableFullAction_t action);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_tableFullAction_get(rtksw_igmp_tableFullAction_t *pAction);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_checksumErrorAction_set(rtksw_igmp_checksumErrorAction_t action);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_checksumErrorAction_get(rtksw_igmp_checksumErrorAction_t *pAction);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_leaveTimer_set(rtksw_uint32 timer);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_leaveTimer_get(rtksw_uint32 *pTimer);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_queryInterval_set(rtksw_uint32 interval);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_queryInterval_get(rtksw_uint32 *pInterval);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_robustness_set(rtksw_uint32 robustness);
 ...
 * Note:
 */
extern rtksw_api_ret_t rtksw_igmp_robustness_get(rtksw_uint32 *pRobustness);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_dynamicRouterPortAllow_set(rtksw_portmask_t *pPortmask);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_dynamicRouterPortAllow_get(rtksw_portmask_t *pPortmask);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_dynamicRouterPort_get(rtksw_igmp_dynamicRouterPort_t *pDynamicRouterPort);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_suppressionEnable_set(rtksw_enable_t reportSuppression, rtksw_enable_t leaveSuppression);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_suppressionEnable_get(rtksw_enable_t *pReportSuppression, rtksw_enable_t *pLeaveSuppression);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_portRxPktEnable_set(rtksw_port_t port, rtksw_igmp_rxPktEnable_t *pRxCfg);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_portRxPktEnable_get(rtksw_port_t port, rtksw_igmp_rxPktEnable_t *pRxCfg);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_groupInfo_get(rtksw_uint32 index, rtksw_igmp_groupInfo_t *pGroup);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_ReportLeaveFwdAction_set(rtksw_igmp_ReportLeaveFwdAct_t action);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_ReportLeaveFwdAction_get(rtksw_igmp_ReportLeaveFwdAct_t *pAction);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_dropLeaveZeroEnable_set(rtksw_enable_t enabled);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_dropLeaveZeroEnable_get(rtksw_enable_t *pEnabled);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_bypassGroupRange_set(rtksw_igmp_bypassGroup_t group, rtksw_enable_t enabled);
 ...
 *
 */
extern rtksw_api_ret_t rtksw_igmp_bypassGroupRange_get(rtksw_igmp_bypassGroup_t group, rtksw_enable_t *pEnable);
