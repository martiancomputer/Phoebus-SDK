 ...
 *      None.
 */
rtksw_api_ret_t rtksw_port_phyOCPReg_set(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 ocpData)
{
    rtksw_api_ret_t retVal;
 ...
 *      None.
 */
rtksw_api_ret_t rtksw_port_phyOCPReg_get(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 *pRegData)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_fiberAbility_set(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_fiberAbility_get(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_phyMdx_set(rtksw_port_t port, rtksw_port_phy_mdix_mode_t mode)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_phyMdx_get(rtksw_port_t port, rtksw_port_phy_mdix_mode_t *pMode)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_phyMdxStatus_get(rtksw_port_t port, rtksw_port_phy_mdix_status_t *pStatus)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_phyTestMode_set(rtksw_port_t port, rtksw_port_phy_test_mode_t mode)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_phyTestMode_get(rtksw_port_t port, rtksw_port_phy_test_mode_t *pMode)
{
    rtksw_api_ret_t retVal;
 ...
 *      None.
 */
rtksw_api_ret_t rtksw_port_maxPacketLength_set(rtksw_port_t port, rtksw_uint32 length)
{
    rtksw_api_ret_t retVal;
 ...
 *      None.
 */
rtksw_api_ret_t rtksw_port_maxPacketLength_get(rtksw_port_t port, rtksw_uint32 *pLength)
{
    rtksw_api_ret_t retVal;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t rtksw_port_phyGreenEthernet_set(rtksw_port_t port, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_phyGreenEthernet_get(rtksw_port_t port, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal;
 ...
 *      - ENABLE
 */
rtksw_api_ret_t rtksw_port_phyLinkDownPowerSaving_set(rtksw_port_t port, rtksw_enable_t state)
{
    rtksw_api_ret_t retVal;
 ...
 */
rtksw_api_ret_t rtksw_port_phyLinkDownPowerSaving_get(rtksw_port_t port, rtksw_enable_t *pState)
{
    rtksw_api_ret_t retVal;
