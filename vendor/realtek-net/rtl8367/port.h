...
{
    RTKSW_PORT_MAC_NORMAL = 0,
    RTKSW_PORT_MAC_FORCE,
    RTKSW_PORT_MAC_END
 ...
 *      None.
 */
extern rtksw_api_ret_t rtksw_port_phyOCPReg_set(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 ocpData);
 ...
 *      None.
 */
extern rtksw_api_ret_t rtksw_port_phyOCPReg_get(rtksw_port_t port, rtksw_uint32 ocpAddr, rtksw_uint32 *pRegData);
 ...
 */
extern rtksw_api_ret_t rtksw_port_fiberAbility_set(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility);
 ...
 */
extern rtksw_api_ret_t rtksw_port_fiberAbility_get(rtksw_port_t port, rtksw_port_fiber_ability_t *pAbility);
 ...
 */
extern rtksw_api_ret_t rtksw_port_phyMdx_set(rtksw_port_t port, rtksw_port_phy_mdix_mode_t mode);
 ...
 */
extern rtksw_api_ret_t rtksw_port_phyMdx_get(rtksw_port_t port, rtksw_port_phy_mdix_mode_t *pMode);
 ...
 */
extern rtksw_api_ret_t rtksw_port_phyMdxStatus_get(rtksw_port_t port, rtksw_port_phy_mdix_status_t *pStatus);
 ...
 */
extern rtksw_api_ret_t rtksw_port_phyTestMode_set(rtksw_port_t port, rtksw_port_phy_test_mode_t mode);
 ...
 */
extern rtksw_api_ret_t rtksw_port_phyTestMode_get(rtksw_port_t port, rtksw_port_phy_test_mode_t *pMode);
 ...
 *      None.
 */
extern rtksw_api_ret_t rtksw_port_maxPacketLength_set(rtksw_port_t port, rtksw_uint32 length);
 ...
 *      None.
 */
extern rtksw_api_ret_t rtksw_port_maxPacketLength_get(rtksw_port_t port, rtksw_uint32 *pLength);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t rtksw_port_phyGreenEthernet_set(rtksw_port_t port, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t rtksw_port_phyGreenEthernet_get(rtksw_port_t port, rtksw_enable_t *pState);
 ...
 *      - ENABLE
 */
extern rtksw_api_ret_t rtksw_port_phyLinkDownPowerSaving_set(rtksw_port_t port, rtksw_enable_t state);
 ...
 */
extern rtksw_api_ret_t rtksw_port_phyLinkDownPowerSaving_get(rtksw_port_t port, rtksw_enable_t *pState);
