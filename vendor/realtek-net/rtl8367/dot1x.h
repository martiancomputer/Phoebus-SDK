 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
extern rtksw_api_ret_t rtksw_dot1x_unauthPacketOper_set(rtksw_port_t port, rtksw_dot1x_unauth_action_t unauth_action);
 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
extern rtksw_api_ret_t rtksw_dot1x_unauthPacketOper_get(rtksw_port_t port, rtksw_dot1x_unauth_action_t *pUnauth_action);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t rtksw_dot1x_eapolFrame2CpuEnable_set(rtksw_enable_t enable);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t rtksw_dot1x_eapolFrame2CpuEnable_get(rtksw_enable_t *pEnable);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t rtksw_dot1x_portBasedEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_portBasedEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 *      - AUTH
 */
extern rtksw_api_ret_t rtksw_dot1x_portBasedAuthStatus_set(rtksw_port_t port, rtksw_dot1x_auth_status_t port_auth);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_portBasedAuthStatus_get(rtksw_port_t port, rtksw_dot1x_auth_status_t *pPort_auth);
 ...
 *      - IN
 */
extern rtksw_api_ret_t rtksw_dot1x_portBasedDirection_set(rtksw_port_t port, rtksw_dot1x_direction_t port_direction);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_portBasedDirection_get(rtksw_port_t port, rtksw_dot1x_direction_t *pPort_direction);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t rtksw_dot1x_macBasedEnable_set(rtksw_port_t port, rtksw_enable_t enable);
 ...
 *      - RTKSW_ENABLED
 */
extern rtksw_api_ret_t rtksw_dot1x_macBasedEnable_get(rtksw_port_t port, rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_macBasedAuthMac_add(rtksw_port_t port, rtksw_mac_t *pAuth_mac, rtksw_fid_t fid);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_macBasedAuthMac_del(rtksw_port_t port, rtksw_mac_t *pAuth_mac, rtksw_fid_t fid);
 ...
 *      - IN
 */
extern rtksw_api_ret_t rtksw_dot1x_macBasedDirection_set(rtksw_dot1x_direction_t mac_direction);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_macBasedDirection_get(rtksw_dot1x_direction_t *pMac_direction);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_guestVlan_set(rtksw_vlan_t vid);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_guestVlan_get(rtksw_vlan_t *pVid);
 ...
 *      - RTKSW_DISABLED
 */
extern rtksw_api_ret_t rtksw_dot1x_guestVlan2Auth_set(rtksw_enable_t enable);
 ...
 */
extern rtksw_api_ret_t rtksw_dot1x_guestVlan2Auth_get(rtksw_enable_t *pEnable);
