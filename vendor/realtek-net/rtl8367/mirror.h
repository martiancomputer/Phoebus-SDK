 ...
 *      should be identical.
 */
extern rtksw_api_ret_t rtksw_mirror_portBased_set(rtksw_port_t mirroring_port, rtksw_portmask_t *pMirrored_rx_portmask, rtksw_portmask_t *pMirrored_tx_portmask);
 ...
 */
extern rtksw_api_ret_t rtksw_mirror_portBased_get(rtksw_port_t* pMirroring_port, rtksw_portmask_t *pMirrored_rx_portmask, rtksw_portmask_t *pMirrored_tx_portmask);
 ...
 */
extern rtksw_api_ret_t rtksw_mirror_portIso_set(rtksw_enable_t enable);
 ...
 */
extern rtksw_api_ret_t rtksw_mirror_portIso_get(rtksw_enable_t *pEnable);
 ...
 */
extern rtksw_api_ret_t rtksw_mirror_vlanLeaky_set(rtksw_enable_t txenable, rtksw_enable_t rxenable);
 ...
 */
extern rtksw_api_ret_t rtksw_mirror_vlanLeaky_get(rtksw_enable_t *pTxenable, rtksw_enable_t *pRxenable);
 ...
 *      The API is to set mirror VLAN leaky function forwarding packets to miror port.
 */
extern rtksw_api_ret_t rtksw_mirror_isolationLeaky_set(rtksw_enable_t txenable, rtksw_enable_t rxenable);
 ...
 */
extern rtksw_api_ret_t rtksw_mirror_isolationLeaky_get(rtksw_enable_t *pTxenable, rtksw_enable_t *pRxenable);
 ...
 *      - MIRROR_KEEP_END
 */
extern rtksw_api_ret_t rtksw_mirror_keep_set(rtksw_mirror_keep_t mode);
 ...
 *      - MIRROR_KEEP_END
 */
extern rtksw_api_ret_t rtksw_mirror_keep_get(rtksw_mirror_keep_t *pMode);
 ...
 */
extern rtksw_api_ret_t rtksw_mirror_override_set(rtksw_enable_t rxMirror, rtksw_enable_t txMirror, rtksw_enable_t aclMirror);
 ...
 *      normal forward & mirrored packet at the same time.
 */
extern rtksw_api_ret_t rtksw_mirror_override_get(rtksw_enable_t *pRxMirror, rtksw_enable_t *pTxMirror, rtksw_enable_t *pAclMirror);
