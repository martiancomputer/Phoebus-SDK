...
static hwp_swDescp_t rtl9302c_4x8284__4xg_swDescp = {
    ...
    .port.descp = {
        { .mac_id =  0, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 0, .phy_idx = 0,        .smi = 0,        .phy_addr =  0,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id =  1, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 0, .phy_idx = 0,        .smi = 0,        .phy_addr =  1,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id =  2, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 0, .phy_idx = 0,        .smi = 0,        .phy_addr =  2,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id =  3, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 0, .phy_idx = 0,        .smi = 0,        .phy_addr =  3,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id =  8, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 1,        .smi = 1,        .phy_addr =  8,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id =  9, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 1,        .smi = 1,        .phy_addr =  9,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 10, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 1,        .smi = 1,        .phy_addr = 10,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
        { .mac_id = 11, .attr = HWP_ETH,   .eth = HWP_2_5GE,    .medi = HWP_COPPER, .sds_idx = 1, .phy_idx = 1,        .smi = 1,        .phy_addr = 11,        .led_c = 0,        .led_f = HWP_NONE,.led_layout = SINGLE_SET,},
    ...
    .phy.descp = {
        [0] = { .chip = RTK_PHYTYPE_NONE,       .mac_id = 0,  .phy_max = 4 },
        [1] = { .chip = RTK_PHYTYPE_NONE,       .mac_id = 8,  .phy_max = 4 },
        [2] = { .chip = RTK_PHYTYPE_NONE/* 412 */, .mac_id = 16, .phy_max = 4 },
        [3] = { .chip = RTK_PHYTYPE_NONE/* 412 */, .mac_id = 20, .phy_max = 4 },
        [4] = { .chip = HWP_END },
    },   /* .phy.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9302c_4x8284_4xg = {

    .identifier.name        = "RTL9302C_4xRTL8284_4XGE",
    .identifier.id          = HWP_RTL9302C_4xRTL8284_4XGE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9302c_4x8284__4xg_swDescp,
    }
