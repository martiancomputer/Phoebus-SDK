 ...
 *
 */
#ifndef __DAL_MANGO_TRAP_H__
#define __DAL_MANGO_TRAP_H__
 ...
 */
extern int32
dal_mango_trap_mgmtFrameAction_get(uint32 unit, rtk_trap_mgmtType_t frameType, rtk_mgmt_action_t *pAction);
