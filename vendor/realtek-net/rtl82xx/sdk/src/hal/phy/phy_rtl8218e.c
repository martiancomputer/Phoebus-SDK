...
#define PHY_8218E_RTCT_CABLE_FACTOR_5E          (7900)
#define PHY_8218E_RTCT_CABLE_FACTOR_6A          (7780)
#define PHY_8218E_RTCT_CABLE_FACTOR_6A_UU       (7850)
#define PHY_8218E_RTCT_CABLE_FACTOR             (PHY_8218E_RTCT_CABLE_FACTOR_5E)
#define PHY_8218E_RTCT_CABLE_OFFSET_5E          (268)
#define PHY_8218E_RTCT_CABLE_OFFSET_6A          (223)
#define PHY_8218E_RTCT_CABLE_OFFSET_6A_UU       (319)
...
_phy_8218e_rtct_cable_set(uint32 unit, rtk_port_t port, uint32 cableType)
{
    ...
    switch (cableType)
    {
        case RTK_PHY_CTRL_RTCT_CABLE_TYPE_CAT5E:
            ...
            hal_miim_write(unit, port, 0, 31, 0xA43);
            _phy_8218e_indr_bits_write(unit, port, 0x8194, 15, 8, 0x38);
            _phy_8218e_indr_bits_write(unit, port, 0x8195, 15, 8, 0x03);
            _phy_8218e_indr_bits_write(unit, port, 0x8197, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x8198, 15, 8, 0x0C);
            _phy_8218e_indr_bits_write(unit, port, 0x81A9, 15, 8, 0x1F);
            _phy_8218e_indr_bits_write(unit, port, 0x81AA, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x818A, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x818B, 15, 8, 0x04);
            _phy_8218e_indr_bits_write(unit, port, 0x819F, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81A0, 15, 8, 0xE0);
            _phy_8218e_indr_bits_write(unit, port, 0x819B, 15, 8, 0x01);
            _phy_8218e_indr_bits_write(unit, port, 0x819C, 15, 8, 0x01);
            _phy_8218e_indr_bits_write(unit, port, 0x819D, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x819E, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81A5, 15, 8, 0x01);
            _phy_8218e_indr_bits_write(unit, port, 0x81A6, 15, 8, 0x50);
            _phy_8218e_indr_bits_write(unit, port, 0x81A7, 15, 8, 0x01);
            _phy_8218e_indr_bits_write(unit, port, 0x81A8, 15, 8, 0x50);
            _phy_8218e_indr_bits_write(unit, port, 0x81A3, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81A4, 15, 8, 0x04);
            _phy_8218e_indr_bits_write(unit, port, 0x81A1, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81A2, 15, 8, 0x04);
            _phy_8218e_indr_bits_write(unit, port, 0x8188, 15, 8, 0x3E);
            _phy_8218e_indr_bits_write(unit, port, 0x8189, 15, 8, 0x80);
            _phy_8218e_indr_bits_write(unit, port, 0x8186, 15, 8, 0x41);
            _phy_8218e_indr_bits_write(unit, port, 0x8187, 15, 8, 0xa0);
            _phy_8218e_indr_bits_write(unit, port, 0x818C, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x819A, 15, 8, 0xe4);
            _phy_8218e_indr_bits_write(unit, port, 0x818D, 15, 8, 0x3e);
            _phy_8218e_indr_bits_write(unit, port, 0x818E, 15, 8, 0x80);
            _phy_8218e_indr_bits_write(unit, port, 0x81AB, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81AC, 15, 8, 0x0E);
            _phy_8218e_indr_bits_write(unit, port, 0x81AD, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81AE, 15, 8, 0x46);
            _phy_8218e_indr_bits_write(unit, port, 0x81AF, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81B0, 15, 8, 0xEA);
            _phy_8218e_indr_bits_write(unit, port, 0x81B1, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81B2, 15, 8, 0x04);
            _phy_8218e_indr_bits_write(unit, port, 0x81B3, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81B4, 15, 8, 0x11);
            _phy_8218e_indr_bits_write(unit, port, 0x81B5, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81B6, 15, 8, 0x2B);
            _phy_8218e_indr_bits_write(unit, port, 0x81B7, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81B8, 15, 8, 0xF6);
            _phy_8218e_indr_bits_write(unit, port, 0x81B9, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81BA, 15, 8, 0x01);
            _phy_8218e_indr_bits_write(unit, port, 0x81C3, 15, 8, 0x12);
            _phy_8218e_indr_bits_write(unit, port, 0x81C4, 15, 8, 0x8E);
            _phy_8218e_indr_bits_write(unit, port, 0x81C5, 15, 8, 0xFD);
            _phy_8218e_indr_bits_write(unit, port, 0x81C6, 15, 8, 0x1B);
            _phy_8218e_indr_bits_write(unit, port, 0x81C7, 15, 8, 0x01);
            _phy_8218e_indr_bits_write(unit, port, 0x81C8, 15, 8, 0xC6);
            _phy_8218e_indr_bits_write(unit, port, 0x81C9, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81CA, 15, 8, 0x68);
            _phy_8218e_indr_bits_write(unit, port, 0x81CB, 15, 8, 0x0D);
            _phy_8218e_indr_bits_write(unit, port, 0x81CC, 15, 8, 0x70);
            _phy_8218e_indr_bits_write(unit, port, 0x81CD, 15, 8, 0xFE);
            _phy_8218e_indr_bits_write(unit, port, 0x81CE, 15, 8, 0x9F);
            _phy_8218e_indr_bits_write(unit, port, 0x81CF, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81D0, 15, 8, 0xDE);
            _phy_8218e_indr_bits_write(unit, port, 0x81D1, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81D2, 15, 8, 0x9A);
            _phy_8218e_indr_bits_write(unit, port, 0x81DB, 15, 8, 0xDC);
            _phy_8218e_indr_bits_write(unit, port, 0x81DC, 15, 8, 0x66);
            _phy_8218e_indr_bits_write(unit, port, 0x81DD, 15, 8, 0x03);
            _phy_8218e_indr_bits_write(unit, port, 0x81DE, 15, 8, 0x60);
            _phy_8218e_indr_bits_write(unit, port, 0x81DF, 15, 8, 0xFE);
            _phy_8218e_indr_bits_write(unit, port, 0x81E0, 15, 8, 0xC1);
            _phy_8218e_indr_bits_write(unit, port, 0x81E1, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81E2, 15, 8, 0x45);
            _phy_8218e_indr_bits_write(unit, port, 0x81E3, 15, 8, 0xDE);
            _phy_8218e_indr_bits_write(unit, port, 0x81E4, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81E5, 15, 8, 0x02);
            _phy_8218e_indr_bits_write(unit, port, 0x81E6, 15, 8, 0xF4);
            _phy_8218e_indr_bits_write(unit, port, 0x81E7, 15, 8, 0xFE);
            _phy_8218e_indr_bits_write(unit, port, 0x81E8, 15, 8, 0xC7);
            _phy_8218e_indr_bits_write(unit, port, 0x81E9, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81EA, 15, 8, 0x6E);
            _phy_8218e_indr_bits_write(unit, port, 0x81F3, 15, 8, 0x0A);
            _phy_8218e_indr_bits_write(unit, port, 0x81F4, 15, 8, 0xB1);
            _phy_8218e_indr_bits_write(unit, port, 0x81F5, 15, 8, 0xFE);
            _phy_8218e_indr_bits_write(unit, port, 0x81F6, 15, 8, 0x39);
            _phy_8218e_indr_bits_write(unit, port, 0x81F7, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81F8, 15, 8, 0xF6);
            _phy_8218e_indr_bits_write(unit, port, 0x81F9, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81FA, 15, 8, 0xBE);
            _phy_8218e_indr_bits_write(unit, port, 0x81FB, 15, 8, 0x03);
            _phy_8218e_indr_bits_write(unit, port, 0x81FC, 15, 8, 0xC0);
            _phy_8218e_indr_bits_write(unit, port, 0x81FD, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81FE, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x81FF, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x8200, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x8201, 15, 8, 0x00);
            _phy_8218e_indr_bits_write(unit, port, 0x8202, 15, 8, 0x00);
            break;

        case RTK_PHY_CTRL_RTCT_CABLE_TYPE_CAT6A:
            hal_miim_write(unit, port, 0, 30, 0);
            hal_miim_write(unit, port, 0, 31, 0xA43);
            _phy_8218e_indr_bits_write(unit, port, 0x8185, 15, 8, 0x25);
            _phy_8218e_indr_bits_write(unit, port, 0x8186, 15, 8, 0x41);
            _phy_8218e_indr_bits_write(unit, port, 0x8187, 15, 8, 0xA0);
            _phy_8218e_indr_bits_write(unit, port, 0x8188, 15, 8, 0x3E);
            _phy_8218e_indr_bits_write(unit, port, 0x8189, 15, 8, 0x80);
            _phy_8218e_indr_bits_write(unit, port, 0x818A, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x818B, 15, 8, 0x4);
            _phy_8218e_indr_bits_write(unit, port, 0x818C, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x818D, 15, 8, 0x3E);
            _phy_8218e_indr_bits_write(unit, port, 0x818E, 15, 8, 0x80);
            _phy_8218e_indr_bits_write(unit, port, 0x8194, 15, 8, 0x2E);
            _phy_8218e_indr_bits_write(unit, port, 0x8195, 15, 8, 0x3);
            _phy_8218e_indr_bits_write(unit, port, 0x8197, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x8198, 15, 8, 0xC);
            _phy_8218e_indr_bits_write(unit, port, 0x819A, 15, 8, 0xE4);
            _phy_8218e_indr_bits_write(unit, port, 0x819B, 15, 8, 0x1);
            _phy_8218e_indr_bits_write(unit, port, 0x819C, 15, 8, 0x1);
            _phy_8218e_indr_bits_write(unit, port, 0x819D, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x819E, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x819F, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81A0, 15, 8, 0xE0);
            _phy_8218e_indr_bits_write(unit, port, 0x81A1, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81A2, 15, 8, 0x4);
            _phy_8218e_indr_bits_write(unit, port, 0x81A3, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81A4, 15, 8, 0x4);
            _phy_8218e_indr_bits_write(unit, port, 0x81A5, 15, 8, 0x1);
            _phy_8218e_indr_bits_write(unit, port, 0x81A6, 15, 8, 0x50);
            _phy_8218e_indr_bits_write(unit, port, 0x81A7, 15, 8, 0x1);
            _phy_8218e_indr_bits_write(unit, port, 0x81A8, 15, 8, 0x50);
            _phy_8218e_indr_bits_write(unit, port, 0x81A9, 15, 8, 0x24);
            _phy_8218e_indr_bits_write(unit, port, 0x81AA, 15, 8, 0x28);
            _phy_8218e_indr_bits_write(unit, port, 0x81AB, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81AC, 15, 8, 0xE);
            _phy_8218e_indr_bits_write(unit, port, 0x81AD, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81AE, 15, 8, 0x46);
            _phy_8218e_indr_bits_write(unit, port, 0x81AF, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81B0, 15, 8, 0xEA);
            _phy_8218e_indr_bits_write(unit, port, 0x81B1, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81B2, 15, 8, 0x4);
            _phy_8218e_indr_bits_write(unit, port, 0x81B3, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81B4, 15, 8, 0x11);
            _phy_8218e_indr_bits_write(unit, port, 0x81B5, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81B6, 15, 8, 0x2B);
            _phy_8218e_indr_bits_write(unit, port, 0x81B7, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81B8, 15, 8, 0xF6);
            _phy_8218e_indr_bits_write(unit, port, 0x81B9, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81BA, 15, 8, 0x1);
            _phy_8218e_indr_bits_write(unit, port, 0x81C3, 15, 8, 0x16);
            _phy_8218e_indr_bits_write(unit, port, 0x81C4, 15, 8, 0x80);
            _phy_8218e_indr_bits_write(unit, port, 0x81C5, 15, 8, 0xFD);
            _phy_8218e_indr_bits_write(unit, port, 0x81C6, 15, 8, 0xCB);
            _phy_8218e_indr_bits_write(unit, port, 0x81C7, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81C8, 15, 8, 0xFC);
            _phy_8218e_indr_bits_write(unit, port, 0x81C9, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81CA, 15, 8, 0xBE);
            _phy_8218e_indr_bits_write(unit, port, 0x81CB, 15, 8, 0x13);
            _phy_8218e_indr_bits_write(unit, port, 0x81CC, 15, 8, 0x31);
            _phy_8218e_indr_bits_write(unit, port, 0x81CD, 15, 8, 0xFE);
            _phy_8218e_indr_bits_write(unit, port, 0x81CE, 15, 8, 0xB6);
            _phy_8218e_indr_bits_write(unit, port, 0x81CF, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81D0, 15, 8, 0x66);
            _phy_8218e_indr_bits_write(unit, port, 0x81D1, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81D2, 15, 8, 0xDC);
            _phy_8218e_indr_bits_write(unit, port, 0x81DB, 15, 8, 0xE5);
            _phy_8218e_indr_bits_write(unit, port, 0x81DC, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81DD, 15, 8, 0x1);
            _phy_8218e_indr_bits_write(unit, port, 0x81DE, 15, 8, 0x97);
            _phy_8218e_indr_bits_write(unit, port, 0x81DF, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81E0, 15, 8, 0xFC);
            _phy_8218e_indr_bits_write(unit, port, 0x81E1, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81E2, 15, 8, 0xE8);
            _phy_8218e_indr_bits_write(unit, port, 0x81E3, 15, 8, 0xD5);
            _phy_8218e_indr_bits_write(unit, port, 0x81E4, 15, 8, 0xCE);
            _phy_8218e_indr_bits_write(unit, port, 0x81E5, 15, 8, 0x3);
            _phy_8218e_indr_bits_write(unit, port, 0x81E6, 15, 8, 0x89);
            _phy_8218e_indr_bits_write(unit, port, 0x81E7, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81E8, 15, 8, 0x24);
            _phy_8218e_indr_bits_write(unit, port, 0x81E9, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81EA, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81EB, 15, 8, 0xB);
            _phy_8218e_indr_bits_write(unit, port, 0x81EC, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81ED, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81EE, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81EF, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81F0, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81F1, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81F2, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81F3, 15, 8, 0xA);
            _phy_8218e_indr_bits_write(unit, port, 0x81F4, 15, 8, 0x62);
            _phy_8218e_indr_bits_write(unit, port, 0x81F5, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81F6, 15, 8, 0x4C);
            _phy_8218e_indr_bits_write(unit, port, 0x81F7, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x81F8, 15, 8, 0x36);
            _phy_8218e_indr_bits_write(unit, port, 0x81F9, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x81FA, 15, 8, 0xEE);
            _phy_8218e_indr_bits_write(unit, port, 0x81FB, 15, 8, 0x11);
            _phy_8218e_indr_bits_write(unit, port, 0x81FC, 15, 8, 0x30);
            _phy_8218e_indr_bits_write(unit, port, 0x81FD, 15, 8, 0xFE);
            _phy_8218e_indr_bits_write(unit, port, 0x81FE, 15, 8, 0x9C);
            _phy_8218e_indr_bits_write(unit, port, 0x81FF, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x8200, 15, 8, 0xA0);
            _phy_8218e_indr_bits_write(unit, port, 0x8201, 15, 8, 0xFF);
            _phy_8218e_indr_bits_write(unit, port, 0x8202, 15, 8, 0xC4);
            break;
        ...
        case RTK_PHY_CTRL_RTCT_CABLE_TYPE_CAT6A_UU:
            ...
            _phy_8218e_indr_bits_write(unit, port, 0x818D, 15, 8, 0x3E);
            _phy_8218e_indr_bits_write(unit, port, 0x818E, 15, 8, 0x80);
            _phy_8218e_indr_bits_write(unit, port, 0x8194, 15, 8, 0x46);
            _phy_8218e_indr_bits_write(unit, port, 0x8195, 15, 8, 0x3);
            _phy_8218e_indr_bits_write(unit, port, 0x8197, 15, 8, 0x0);
            _phy_8218e_indr_bits_write(unit, port, 0x8198, 15, 8, 0xC);
            _phy_8218e_indr_bits_write(unit, port, 0x819A, 15, 8, 0xE4);
...
int32
_phy_8218e_intrCommonStatus_get(uint32 unit, uint32 port, rtk_phy_intrStatusVal_t *pStatus)
{
    uint32  blk = 0;
    uint32  data = 0;
    ...
    pStatus->statusValue |= (data & BIT_2) ? (1 << RTK_PHY_INTR_STATUS_COMMON_NWAY_NEXT_PAGE_RECV) : (0);
    pStatus->statusValue |= (data & BIT_3) ? (1 << RTK_PHY_INTR_STATUS_COMMON_AN_COMPLETE) : (0);
    pStatus->statusValue |= (data & BIT_4) ? (1 << RTK_PHY_INTR_STATUS_COMMON_LINK_CHANGE) : (0);
    pStatus->statusValue |= (data & BIT_9) ? (1 << RTK_PHY_INTR_STATUS_COMMON_ALDPS_STATE_CHANGE) : (0);
