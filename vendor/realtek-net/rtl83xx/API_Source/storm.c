 ...
 *
 * $Revision: 79496 $
 * $Date: 2017-06-08 17:31:25 +0800 (?▒х?, 08 ?нц? 2017) $
 *
 ...
 *
 */
rtk_api_ret_t rtk_83xx_rate_stormControlMeterIdx_set(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 index)
{
    rtk_api_ret_t retVal;
...
EXPORT_SYMBOL(rtk_83xx_rate_stormControlMeterIdx_set);
 ...
 *
 */
rtk_api_ret_t rtk_83xx_rate_stormControlMeterIdx_get(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 *pIndex)
{
    rtk_api_ret_t retVal;
...
EXPORT_SYMBOL(rtk_83xx_rate_stormControlMeterIdx_get);
 ...
 *
 */
rtk_api_ret_t rtk_83xx_rate_stormControlPortEnable_set(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
...
EXPORT_SYMBOL(rtk_83xx_rate_stormControlPortEnable_set);
 ...
 *
 */
rtk_api_ret_t rtk_83xx_rate_stormControlPortEnable_get(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
...
EXPORT_SYMBOL(rtk_83xx_rate_stormControlPortEnable_get);
