 ...
 */
extern rtk_api_ret_t rtk_83xx_stat_port_getAll(rtk_port_t port, rtk_stat_port_cntr_t *pPort_cntrs);
...
extern rtk_api_ret_t rtl_stat_port_getserial(rtk_port_t port, rtk_stat_port_cntr_t *pPort_cntrs);
