...
extern rtk_api_ret_t rtk_83xx_qos_init(rtk_queue_num_t queueNum);
extern rtk_api_ret_t rtk_83xx_qos_enable(rtk_enable_t enable);
extern rtk_api_ret_t rtk_83xx_qos_priSelGroup_get(rtk_qos_priDecTbl_t index, rtk_priority_select_t *pPriDec);
extern rtk_api_ret_t rtk_83xx_qos_priSelGroup_set(rtk_qos_priDecTbl_t index, rtk_priority_select_t *pPriDec);
#endif
