 ...
 *      should be identical.
 */
extern rtk_api_ret_t rtk_83xx_mirror_portBased_set(rtk_port_t mirroring_port, rtk_portmask_t *pMirrored_rx_portmask, rtk_portmask_t *pMirrored_tx_portmask);
 ...
 */
extern rtk_api_ret_t rtk_83xx_mirror_portIso_set(rtk_enable_t enable);
