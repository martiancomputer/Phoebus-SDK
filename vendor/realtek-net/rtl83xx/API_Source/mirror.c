 ...
 *
 * $Revision: 79629 $
 * $Date: 2017-06-14 18:08:03 +0800 (?▒ф?, 14 ?нц? 2017) $
 *
 ...
 *      should be identical.
 */
rtk_api_ret_t rtk_83xx_mirror_portBased_set(rtk_port_t mirroring_port, rtk_portmask_t *pMirrored_rx_portmask, rtk_portmask_t *pMirrored_tx_portmask)
{
     rtk_api_ret_t retVal;
...
EXPORT_SYMBOL(rtk_83xx_mirror_portBased_set);
 ...
 */
rtk_api_ret_t rtk_83xx_mirror_portIso_set(rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
...
EXPORT_SYMBOL(rtk_83xx_mirror_portIso_set);
