 ...
 *           (18) LiteRomeDriver portTrigger configuration
*/
 ...
 *      None
 */
//extern call_rtk_rg_asic_fb_init(void);
extern rtk_rg_err_code_t
...
/* Function Name:
 *      rtk_rg_asic_dump_flow_table_idx
 * Description:
 ...
 */
extern int32
rtk_rg_asic_dump_flow_table_idx(uint32 idx);

/* Function Name:
 *      rtk_rg_asic_dump_flow_table_all
 * Description:
 *      dump valid entry of flow table
 * Input:
 *      idx - index of netif table
 ...
 */
extern int32
rtk_rg_asic_dump_flow_table_all(void);

/* Function Name:
 *      rtk_rg_asic_dump_netif_table_idx
 * Description:
 *      dump valid entry of flow table
 * Input:
 *      idx - index of netif table
 ...
 */
extern int32
rtk_rg_asic_dump_netif_table_idx(uint32 idx);

/* Function Name:
 *      rtk_rg_asic_dump_netif_table_all
 * Description:
 *      dump valid entry of flow table
 * Input:
 *      idx - index of netif table
 ...
 */
extern int32
rtk_rg_asic_dump_netif_table_all(void);


/* Function Name:
 *	rtk_rg_asic_netifTable_add
 * Description:
 *      Add netif table entry
 * Input:
 *      idx - index of netif table
...
/* Function Name:
 *      rtk_rg_vxlanClientInfo_set
 * Description:
 *      Set VXLAN mode information to the indexed WAN interface after dial.
 * Input:
 * Output:
 *      wan_intf_idx - [in]<tab>The interface index of previous setup for VXLAN mode.
 *      vxlanClient_info - [in]<tab>The configuration related to VXLAN mode.
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_NULL_POINTER - the input parameters may be NULL
 *      RT_ERR_RG_INVALID_PARAM - the input parameter contains illegal information or range
 ...
 */
extern int32
rtk_rg_vxlanClientInfo_set(int wan_intf_idx, rtk_rg_vxlanClientInfoAfterDial_t *vxlanClient_info);
...
/* Sub-module Name: PortTrigger configuration */

/* Function Name:
 *      rtk_rg_portTrigger_add
 * Description:
 *      Add port trigger rule.
 * Input:
 * Output:
 *      *port_trigger - [in]<tab>the port trigger data structure.
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_NOT_INIT
 *      RT_ERR_RG_INVALID_PARAM
 *      RT_ERR_RG_ENTRY_EXIST
 *      RT_ERR_RG_FAILED
 * Note:
 *      port_trigger.match_port_start - match port start number.<nl>
 *      port_trigger.match_port_end - match port end number.<nl>
 *      port_trigger.natType - match incoming or outgoing port.<nl>
 *      port_trigger.relate_port_start - relate port start number.<nl>
 *      port_trigger.relate_port_end - relate port end number.<nl>
 *      port_trigger.match_is_tcp - Layer 4 protocol is TCP or not.<nl>
 *      port_trigger.relate_is_tcp - Layer 4 protocol is TCP or not.<nl>
 */
extern int32
rtk_rg_portTrigger_add(rtk_rg_portTrigger_info_t *port_trigger);

/* Function Name:
 *      rtk_rg_portTrigger_del
 * Description:
 *      Delete port trigger rule.
 * Input:
 * Output:
 *      *port_trigger - [in]<tab>the port trigger data structure for deleting.
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_NOT_INIT
 *      RT_ERR_RG_INVALID_PARAM
 ...
 */
extern int32
rtk_rg_portTrigger_del(rtk_rg_portTrigger_info_t *port_trigger);

/* Sub-module Name: ipset configuration */
 ...
 *      Add ipset rule.
 * Input:
 *      *ipset_rule - [in]<tab>the ipset data structure.
 * Output:
 *      index  - [out]<tab>the index of the added ipset rule.
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_NOT_INIT
 *      RT_ERR_RG_INVALID_PARAM
 ...
 *      RT_ERR_RG_FAILED
 * Note:
 *      ipset_rule.filter_type - use to choose the filtered type<nl>
 *      ipset_rule.ipv4_address - assign the packet ingress destination ipv4 prefix(valid when filter_type is RTK_RG_IPSET_FILTER_TYPE_REMOTE_IPV4_IP)<nl>
 *      ipset_rule.suffix_len - assign the packet ingress destination ipv4 suffix length(valid when filter_type is RTK_RG_IPSET_FILTER_TYPE_REMOTE_IPV4_IP)<nl>
 *      ipset_rule.l4_port_start - assign the packet ingress layer4 destination port lower bound(valid when filter_type is RTK_RG_IPSET_FILTER_TYPE_REMOTE_L4P_xxx)<nl>
 *      ipset_rule.l4_port_end - assign the packet ingress layer4 destination port upper bound(valid when filter_type is RTK_RG_IPSET_FILTER_TYPE_REMOTE_L4P_xxx)<nl>
 *      ipset_rule.action_type - use to assign the action<nl>
 */
extern int32
rtk_rg_ipset_add(rtk_rg_ipset_rule_t *ipset_rule, int *index);
 ...
 *      Delete ipset rule.
 * Input:
 *	  set_idx - the index of the ipset set.
 *	  index - the index of the ipset filter rule.
 * Output:
 *      none
 * Return:
 *      RT_ERR_RG_OK
 ...
 */
extern int32
rtk_rg_ipset_del(int set_idx, int index);

/* Function Name:
 *      rtk_rg_ipsets_group_set
 * Description:
 *      Set ipsets group configuration.
 * Input:
 *      *ipsets_group_cfg - [in]<tab>the ipsets group data structure.
 *      index  - [out]<tab>the group index of the update ipsets.
 * Output:
 * 	    none
 * Return:
 *      RT_ERR_RG_OK
 ...
 *      RT_ERR_RG_FAILED
 * Note:
 *      ipsets_group_cfg.operation - compare operation, 0 is and(all ipsets in this group should hit), 1 is or(one of ipsets in this group should hit) <nl>
 *      ipsets_group_cfg.netifIdx - assign the network interface(valid when target is RTK_RG_IPSETS_TARGET_ACCEPT)<nl>
 *      ipsets_group_cfg.target - use to assign the target: accept, drop, reject<nl>
 */
extern int32
rtk_rg_ipsets_group_set(rtk_rg_ipsets_group_cfg_t *ipsets_group_cfg, int index);

/* Function Name:
 *      rtk_rg_ipsets_set_add
 * Description:
 *      Add ipsets set rule.
 * Input:
 *      *ipsets_set_cfg - [in]<tab>the ipsets set data structure.
 * Output:
 *      index  - [out]<tab>the index of the added ipsets set.
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_NOT_INIT
 *      RT_ERR_RG_INVALID_PARAM
 ...
 *      RT_ERR_RG_FAILED
 * Note:
 *      ipsets_set_cfg.group_idx - assign the ipsets group index<nl>
 *      ipsets_set_cfg.protocol - assign the ipsets compare protocol, 0 is ipv4, 1 is ipv6<nl>
 *      ipsets_set_cfg.direction - assign the ipsets compare direction, 0 is source, 1 is destination<nl>
 *      ipsets_set_cfg.set_type - use to choose the set type<nl>
 */
extern int32
rtk_rg_ipsets_set_add(rtk_rg_ipsets_set_cfg_t *ipsets_set_cfg, int *index);

/* Function Name:
 *      rtk_rg_ipsets_set_del
 * Description:
 *      Delete ipsets set.
 * Input:
 *	    index - the index of the ipsets set.
 * Output:
 *      none
 * Return:
 *      RT_ERR_RG_OK
 ...
 */
extern int32
rtk_rg_ipsets_set_del(int index);

/* Function Name:
 *      rtk_rg_ipsets_rule_add
 * Description:
 *      Add ipsets rule.
 * Input:
 *      *ipsets_rule - [in]<tab>the ipsets rule data structure.
 * Output:
 *      index  - [out]<tab>the index of the added ipsets rule.
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_NOT_INIT
 *      RT_ERR_RG_INVALID_PARAM
 ...
 *      RT_ERR_RG_FAILED
 * Note:
 *      ipsets_rule.set_idx - assign the set index<nl>
 *      ipsets_rule.mac - assign the mac value if set type is RTK_RG_IPSETS_SET_TYPE_MAC<nl>
 *      ipsets_rule.ipv4_address - assign the ipv4 address value if protocol is ipv4 and set type is RTK_RG_IPSETS_SET_TYPE_IP prefix<nl>
 *      ipsets_rule.ipv6_address - assign the ipv6 address value if protocol is ipv6 and set type is RTK_RG_IPSETS_SET_TYPE_IP prefix<nl>
 *      ipsets_rule.ip_suffix_len - assign the ip address suffix value if set type is RTK_RG_IPSETS_SET_TYPE_IP_SUBNET<nl>
 *      ipsets_rule.l4_port - assign the l4 port value if set type is RTK_RG_IPSETS_SET_TYPE_IP_L4PORT<nl>
 *      ipsets_rule.l4_port_start - assign the l4 port lower bound value if set type is RTK_RG_IPSETS_SET_TYPE_L4_PORT_RANGE<nl>
 *      ipsets_rule.l4_port_end - assign the l4 port upper bound value if set type is RTK_RG_IPSETS_SET_TYPE_L4_PORT_RANGE<nl>
 */
extern int32
rtk_rg_ipsets_rule_add(rtk_rg_ipsets_rule_t *ipsets_rule, int *index);

/* Function Name:
 *      rtk_rg_ipsets_rule_del
 * Description:
 *      Delete ipsets rule.
 * Input:
 *	  set_idx - the index of the ipsets set.
 *	  index - the index of the ipsets filter rule.s
 * Output:
 *      none
 * Return:
 *      RT_ERR_RG_OK
 ...
 */
 extern int32
rtk_rg_ipsets_rule_del(int set_idx, int index);
...
/* Function Name:
 *      rtk_rg_igmpMldSnoopingControl_set
 * Description:
 *      Set IGMP Snooping Config.
 * Input:
 * Output:
 *      Non
 * Return:
...
/* Function Name:
 *      rtk_rg_igmpMldSnoopingControl_get
 * Description:
 *      Get IGMP Snooping Config.
 * Input:
 * Output:
...
/* Function Name:
 *      rtk_rg_igmpMldSnoopingPortControl_add
 * Description:
 *      Set IGMP Snooping Port Config.
 * Input:
 * Output:
 *      Non
 * Return:
...
/* Function Name:
 *      rtk_rg_igmpMldSnoopingControl_del
 * Description:
 *      Del IGMP Snooping Port Config.
 * Input:
 * Output:
 *      Non
 * Return:
...
/* Function Name:
 *      rtk_rg_igmpMldSnoopingPortControl_find
 * Description:
 *      Find IGMP Snooping Port Config.
 * Input:
 * Output:
 *      Non
 * Return:
...
/* Function Name:
 *      rtk_rg_accessDot1xControl_set
 * Description:
 *      Configure 802.1x network access control for blocking specific port.
 * Input:
 *        blocking_ctrl      - blocking control config
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_FAILED
 * Note:
 *      blocking_ctrl.port_mask - ports belongs to portmask should care 802.1x
 *      blocking_ctrl.port_idx - port should care 802.1x, only valid when port_mask is 0x0
 *      blocking_ctrl.port_blocking - enable or disable this feature
 */
extern int32 
rtk_rg_accessDot1xControl_set(rtk_rg_accessDot1xCtrl_t blocking_ctrl);

/* Function Name:
 *      rtk_rg_accessDot1xFilter_set
 * Description:
 *      Configure 802.1x network access control for unblocking mac list.
 * Input:
 *      unblocking_filter 	- unblocking filter
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_FAILED
 *      RT_ERR_RG_INVALID_PARAM
 *      RT_ERR_RG_ENTRY_FULL
 * Note:
 *      unblocking_filter.flag - add/delete a mac in unblocking mac list; delete all/dump unblocking mac list
 *      unblocking_filter.mac - mac should not drop by 802.1x, only valid when flag is add or delete
 */
extern int32 
rtk_rg_accessDot1xFilter_set(rtk_rg_accessDot1xFilter_t unblocking_filter);
 ...
 *      dos_action.RTK_RG_DOS_ACTION_DROP - Drop packet while hit DoS criteria.
 *      dos_action.RTK_RG_DOS_ACTION_TRAP - Trap packet to CPU while hit DoS criteria.
 *      dos_threshold - Allowable SYN/FIN/ICMP packet frame rate. The forwarding rate is depend on threshold unit.
 */
extern int32
...
/* Function Name:
 *      rtk_rg_dosFloodThresholdUnit_set
 * Description:
 *      Set denial of service flooding attack protection time unit.
 * Input:
 * Output:
 *      dos_type - [in]<tab>Port security type.
 *      dos_threshUnit - [in]<tab>flood threshold time unit.
 * Return:
 *      RT_ERR_RG_OK - Success
 *		RT_ERR_RG_INVALID_PARAM - the input parameter contains illegal information.
 * Note:
 ...
 *      dos_type.RTK_RG_FINFLOOD_DENY - Receiving TCP FIN packet number is over threshold.
 *      dos_type.RTK_RG_ICMPFLOOD_DENY - Receiving ICMP packet number is over threshold.
 *      dos_threshUnit - Allowable SYN/FIN/ICMP packet frame rate. The forwarding rate is dos_threshold*1k packets per second.
 */
extern int32
rtk_rg_dosFloodThresholdUnit_set(rtk_rg_dos_type_t dos_type, int dos_threshUnit);

/* Function Name:
 *      rtk_rg_dosFloodThresholdUnit_get
 * Description:
 *      Get denial of service flooding attack protection time unit.
 * Input:
 * Output:
 *      dos_type - [in]<tab>Port security type.
 *		*pDos_threshUnit - [out]<tab>flood threshold time unit.
 * Return:
 *      RT_ERR_RG_OK - Success
 *		RT_ERR_RG_INVALID_PARAM - the input parameter contains illegal information.
 *      RT_ERR_RG_NULL_POINTER - input port mask pointer is NULL.
 ...
 *      dos_type.RTK_RG_FINFLOOD_DENY - Receiving TCP FIN packet number is over threshold.
 *      dos_type.RTK_RG_ICMPFLOOD_DENY - Receiving ICMP packet number is over threshold.
 *      pDos_threshUnit - pointer of threshold unit when counting the SYN/FIN/ICMP packet.
 */
extern int32
rtk_rg_dosFloodThresholdUnit_get(rtk_rg_dos_type_t dos_type, int *pDos_threshUnit);
 ...
 */
extern int32
rtk_rg_vlanGroupMacLimit_add(rtk_rg_mac_port_idx_t port, int groupLimit, int *pGroupIdx);

/* Function Name:
 *      rtk_rg_vlanGroupMacLimit_set
 * Description:
 ...
 */
extern int32
rtk_rg_vlanGroupMacLimit_set(int groupIdx, int vlanId, int groupLimit);

/* Function Name:
 *      rtk_rg_vlanGroupMacLimit_del
 * Description:
 ...
 */
extern int32
rtk_rg_vlanGroupMacLimit_del(int groupIdx, int vlanId);

/* Function Name:
 *      rtk_rg_vlanGroupMacLimit_get
 * Description:
 ...
 */
extern int32
rtk_rg_vlanGroupMacLimit_get(int groupIdx, rtk_rg_vlanGroupMacLimit_info_t *pGroupInfo);

/* Function Name:
 *      rtk_rg_vlanGroupMacLimit_find
 * Description:
 ...
 */
extern int32
rtk_rg_vlanGroupMacLimit_find(rtk_rg_mac_port_idx_t port, int vlanId, int *pGroupIdx);
...
/* Function Name:
 *      rtk_rg_mac_filter_whitelist_add
 * Description:
 *      Add mac filter white list.
 * Input:
 *      rtk_rg_macFilterWhiteList_t - [in]<tab>The information entered.
 * Output:
 *      rtk_rg_macFilterWhiteList_t - [out]<tab>The information contained.
 * Return:
 *      RT_ERR_RG_OK
 *      RT_ERR_RG_NULL_POINTER
 * Note:
 *      mac_filter_whitelist_info->mac - MAC which is going to be added
 */
extern int32
rtk_rg_mac_filter_whitelist_add(rtk_rg_macFilterWhiteList_t *mac_filter_whitelist_info);

/* Function Name:
 *      rtk_rg_mac_filter_whitelist_del
 * Description:
 *      Delete mac filter white list.
 * Input:
 *      rtk_rg_macFilterWhiteList_t - [in]<tab>The information entered.
 * Output:
 *      rtk_rg_macFilterWhiteList_t - [out]<tab>The information contained.
 ...
 *      RT_ERR_RG_NULL_POINTER
 * Note:
 *      mac_filter_whitelist_info->mac - MAC which is going to be deleted
 *      mac_filter_whitelist_info->del_flag - determine delete ONE or ALL entry in white list
 */
extern int32
...
/* Function Name:
 *      rtk_rg_flowHiPriEntry_add
 * Description:
 *      add flow high priority entry
 * Input:
...
/* Function Name:
 *      rtk_rg_urlflowPri_add
 * Description:
 *      assign flow priority by url
 * Input:
 *      urlPriEt
 * Output:
 *      None
 ...
 */
extern int32
rtk_rg_urlflowPri_add(rtk_rg_urlHighPri_t* urlPriEt,int *entry_idx);

/* Function Name:
 *      rtk_rg_urlflowPri_del
 * Description:
 *      delete assign flow priority by url table
 * Input:
 *      urlPriEt
 * Output:
 *      None
 ...
 */
extern int32
rtk_rg_urlflowPri_del(int entry_idx);
