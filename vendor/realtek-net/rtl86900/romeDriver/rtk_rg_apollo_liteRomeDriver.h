...
rtk_rg_err_code_t rtk_rg_apollo_accessDot1xControl_set(rtk_rg_accessDot1xCtrl_t blocking_ctrl);
rtk_rg_err_code_t rtk_rg_apollo_accessDot1xFilter_set(rtk_rg_accessDot1xFilter_t unblocking_filter);
rtk_rg_err_code_t rtk_rg_apollo_ipset_add(rtk_rg_ipset_rule_t *ipset_rule, int *index);
rtk_rg_err_code_t rtk_rg_apollo_ipset_del(int set_idx, int index);
rtk_rg_err_code_t rtk_rg_apollo_ipsets_group_set(rtk_rg_ipsets_group_cfg_t *ipsets_group_cfg, int index);
rtk_rg_err_code_t rtk_rg_apollo_ipsets_set_add(rtk_rg_ipsets_set_cfg_t *ipsets_set_cfg, int *index);
rtk_rg_err_code_t rtk_rg_apollo_ipsets_set_del(int index);
rtk_rg_err_code_t rtk_rg_apollo_ipsets_rule_add(rtk_rg_ipsets_rule_t *ipsets_rule, int *index);
rtk_rg_err_code_t rtk_rg_apollo_ipsets_rule_del(int set_idx, int index);
...
rtk_rg_err_code_t rtk_rg_apollo_dosFloodThresholdUnit_set(rtk_rg_dos_type_t dos_type, int dos_threshUnit);
rtk_rg_err_code_t rtk_rg_apollo_dosFloodThresholdUnit_get(rtk_rg_dos_type_t dos_type, int *pDos_threshUnit);
...
rtk_rg_err_code_t rtk_rg_apollo_macFilter_whitelist_add(rtk_rg_macFilterWhiteList_t *mac_filter_whitelist_info);
rtk_rg_err_code_t rtk_rg_apollo_macFilter_whitelist_del(rtk_rg_macFilterWhiteList_t *mac_filter_whitelist_info);
...
rtk_rg_err_code_t rtk_rg_apollo_portTrigger_add(rtk_rg_portTrigger_info_t *port_trigger);
rtk_rg_err_code_t rtk_rg_apollo_portTrigger_del(rtk_rg_portTrigger_info_t *port_trigger);
...
rtk_rg_err_code_t rtk_rg_apollo_vlanGroupMacLimit_add(rtk_rg_mac_port_idx_t port, int groupLimit, int *pGroupIdx);
rtk_rg_err_code_t rtk_rg_apollo_vlanGroupMacLimit_set(int groupIdx, int vlanId, int groupLimit);
rtk_rg_err_code_t rtk_rg_apollo_vlanGroupMacLimit_del(int groupIdx, int vlanId);
rtk_rg_err_code_t rtk_rg_apollo_vlanGroupMacLimit_get(int groupIdx, rtk_rg_vlanGroupMacLimit_info_t *pGroupInfo);
rtk_rg_err_code_t rtk_rg_apollo_vlanGroupMacLimit_find(rtk_rg_mac_port_idx_t port, int vlanId, int *pGroupIdx);
...
rtk_rg_err_code_t rtk_rg_apollo_callback_function_ptr_get(rtk_rg_callbackFunctionPtrGet_t *callback_function_ptr_get_info);
...
#define rtk_rg_mac_filter_whitelist_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//35
#define rtk_rg_mac_filter_whitelist_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
...
#define rtk_rg_shareMeterMode_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_shareMeterMode_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//90
...
#define rtk_rg_redirectHttpRsp_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//160
#define rtk_rg_redirectHttpRsp_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
...
//165
#define rtk_rg_hostPoliceControl_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_hostPoliceControl_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_hostPoliceLogging_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_hostPoliceLogging_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_redirectHttpCount_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//170
#define rtk_rg_redirectHttpCount_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_staticRoute_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_staticRoute_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_staticRoute_find(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_aclLogCounterControl_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//175
#define rtk_rg_aclLogCounterControl_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_aclLogCounter_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_aclLogCounter_reset(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_groupMacLimit_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_groupMacLimit_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//180
#define rtk_rg_igmpMldSnoopingControl_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_igmpMldSnoopingControl_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_flowMibCounter_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_flowMibCounter_reset(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_softwareIdleTime_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//185
#define rtk_rg_softwareIdleTime_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_funcbasedMeter_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_funcbasedMeter_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_flowHiPriEntry_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_flowHiPriEntry_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//190
#define rtk_rg_igmpMldSnoopingPortControl_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_igmpMldSnoopingPortControl_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_igmpMldSnoopingPortControl_find(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_callback_function_ptr_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_vlanGroupMacLimit_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//195
#define rtk_rg_vlanGroupMacLimit_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_vlanGroupMacLimit_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_vlanGroupMacLimit_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_vlanGroupMacLimit_find(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_dosFloodThresholdUnit_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//200
#define rtk_rg_dosFloodThresholdUnit_get(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_accessDot1xControl_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_accessDot1xFilter_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_urlflowPri_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_urlflowPri_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//205
#define rtk_rg_portTrigger_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_portTrigger_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()

#define rtk_rg_ipset_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_ipset_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//210
#define rtk_rg_ipsets_group_set(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_ipsets_set_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_ipsets_set_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_ipsets_rule_add(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
#define rtk_rg_ipsets_rule_del(arg,args...) PLEASE_USE_RTK_RG_APOLLO_API()
//215
#endif
