...
enum rtdrv_rg_set_e{
    ...
    RTDRV_RG_IPSET_DEL,
    RTDRV_RG_IPSETS_GROUP_SET,
    RTDRV_RG_IPSETS_SET_DEL,
    RTDRV_RG_IPSETS_RULE_DEL,
    ...
    RTDRV_RG_ACCESSDOT1XCONTROL_SET,
    RTDRV_RG_ACCESSDOT1XFILTER_SET,
    ...
    RTDRV_RG_DOSFLOODTHRESHOLDUNIT_SET,
    ...
    RTDRV_RG_VLANGROUPMACLIMIT_SET,
    RTDRV_RG_VLANGROUPMACLIMIT_DEL,
...
enum rtdrv_rg_get_e{
    ...
    RTDRV_RG_PORTTRIGGER_ADD,
    RTDRV_RG_PORTTRIGGER_DEL,
    ...
    RTDRV_RG_IPSET_ADD,
    RTDRV_RG_IPSETS_SET_ADD,
    RTDRV_RG_IPSETS_RULE_ADD,
    ...
    RTDRV_RG_DOSFLOODTHRESHOLDUNIT_GET,
    ...
    RTDRV_RG_VLANGROUPMACLIMIT_ADD,
    RTDRV_RG_VLANGROUPMACLIMIT_GET,
    RTDRV_RG_VLANGROUPMACLIMIT_FIND,
    ...
    RTDRV_RG_URLFLOWPRI_ADD,        
    RTDRV_RG_URLFLOWPRI_DEL,     
...
typedef struct rtdrv_rg_vxlanClientInfo_set_s
{
    int                                 wan_intf_idx;
    rtk_rg_vxlanClientInfoAfterDial_t   vxlanClient_info;
} rtdrv_rg_vxlanClientInfo_set_t;
...
typedef struct rtdrv_rg_portTrigger_add_s
{
    rtk_rg_portTrigger_info_t           port_trigger;
} rtdrv_rg_portTrigger_add_t;

typedef struct rtdrv_rg_portTrigger_del_s
{
    rtk_rg_portTrigger_info_t           port_trigger;
} rtdrv_rg_portTrigger_del_t;

typedef struct rtdrv_rg_ipset_add_s
{
    rtk_rg_ipset_rule_t                 ipset_rule;
    int                                 index;
} rtdrv_rg_ipset_add_t;

typedef struct rtdrv_rg_ipset_del_s
{
    int                                 set_index;
    int                                 index;
} rtdrv_rg_ipset_del_t;

typedef struct rtdrv_rg_ipsets_group_set_s
{
    rtk_rg_ipsets_group_cfg_t           ipsets_group_cfg;
    int                                 index;
} rtdrv_rg_ipsets_group_set_t;

typedef struct rtdrv_rg_ipsets_set_add_s
{
    rtk_rg_ipsets_set_cfg_t             ipsets_set_cfg;
    int                                 index;
} rtdrv_rg_ipsets_set_add_t;

typedef struct rtdrv_rg_ipsets_set_del_s
{
    int                                 index;
} rtdrv_rg_ipsets_set_del_t;

typedef struct rtdrv_rg_ipsets_rule_add_s
{
    rtk_rg_ipsets_rule_t                ipsets_rule;
    int                                 index;
} rtdrv_rg_ipsets_rule_add_t;

typedef struct rtdrv_rg_ipsets_rule_del_s
{
    int                                 set_index;
    int                                 index;
} rtdrv_rg_ipsets_rule_del_t;
...
typedef struct rtdrv_rg_accessDot1xCtrl_set_s
{
    rtk_rg_accessDot1xCtrl_t           blockingCfg;
} rtdrv_rg_accessDot1xCtrl_set_t;

typedef struct rtdrv_rg_accessDot1xFilter_set_s
{
    rtk_rg_accessDot1xFilter_t         unblockingFilter;
} rtdrv_rg_accessDot1xFilter_set_t;
...
typedef struct rtdrv_rg_dosFloodThresholdUnit_set_s
{
    rtk_rg_dos_type_t                   dos_type;
    int                                 dos_threshUnit;
} rtdrv_rg_dosFloodThresholdUnit_set_t;

typedef struct rtdrv_rg_dosFloodThresholdUnit_get_s
{
    rtk_rg_dos_type_t                   dos_type;
    int                                 pDos_threshUnit;
} rtdrv_rg_dosFloodThresholdUnit_get_t;
...
typedef struct rtdrv_rg_vlanGroupMacLimit_add_s
{
    rtk_rg_mac_port_idx_t               port;
    int                                 groupLimit;
    int                                 pGroupIdx;
} rtdrv_rg_vlanGroupMacLimit_add_t;

typedef struct rtdrv_rg_vlanGroupMacLimit_set_s
{
    int                                 groupIdx;
    int                                 vlanId;
	int                                 groupLimit;
} rtdrv_rg_vlanGroupMacLimit_set_t;

typedef struct rtdrv_rg_vlanGroupMacLimit_del_s
{
    int                                 groupIdx;
    int                                 vlanId;
} rtdrv_rg_vlanGroupMacLimit_del_t;

typedef struct rtdrv_rg_vlanGroupMacLimit_get_s
{
    int                                 groupIdx;
    rtk_rg_vlanGroupMacLimit_info_t     pGroupInfo;
} rtdrv_rg_vlanGroupMacLimit_get_t;

typedef struct rtdrv_rg_vlanGroupMacLimit_find_s
{
    rtk_rg_mac_port_idx_t               port;
    int                                 vlanId;
    int                                 pGroupIdx;
} rtdrv_rg_vlanGroupMacLimit_find_t;
...
typedef struct rtdrv_rg_urlflowPri_add_s
{
	rtk_rg_urlHighPri_t urlPriEt;
	int					index;
}rtdrv_rg_urlflowPri_add_t;

typedef struct rtdrv_rg_urlflowPri_del_s
{
	int							index;
}rtdrv_rg_urlflowPri_del_t;
...
typedef union rtdrv_rg_union_u
{
	...
	rtdrv_rg_vxlanClientInfo_set_t rtdrv_rg_vxlanClientInfo_set_cfg;
	...
	rtdrv_rg_portTrigger_add_t rtdrv_rg_portTrigger_add_cfg;
	rtdrv_rg_portTrigger_del_t rtdrv_rg_portTrigger_del_cfg;
	rtdrv_rg_ipset_add_t rtdrv_rg_ipset_add_cfg;
	rtdrv_rg_ipset_del_t rtdrv_rg_ipset_del_cfg;
	rtdrv_rg_ipsets_group_set_t rtdrv_rg_ipsets_group_set_cfg;
	rtdrv_rg_ipsets_set_add_t rtdrv_rg_ipsets_set_add_cfg;
	rtdrv_rg_ipsets_set_del_t rtdrv_rg_ipsets_set_del_cfg;
	rtdrv_rg_ipsets_rule_add_t rtdrv_rg_ipsets_rule_add_cfg;
	rtdrv_rg_ipsets_rule_del_t rtdrv_rg_ipsets_rule_del_cfg;
	...
	rtdrv_rg_accessDot1xCtrl_set_t rtdrv_rg_accessDot1xControl_set_cfg;
	rtdrv_rg_accessDot1xFilter_set_t rtdrv_rg_accessDot1xFilter_set_cfg;
	...
	rtdrv_rg_dosFloodThresholdUnit_set_t rtdrv_rg_dosFloodThresholdUnit_set_cfg;
	rtdrv_rg_dosFloodThresholdUnit_get_t rtdrv_rg_dosFloodThresholdUnit_get_cfg;
	...
	rtdrv_rg_vlanGroupMacLimit_add_t rtdrv_rg_vlanGroupMacLimit_add_cfg;
	rtdrv_rg_vlanGroupMacLimit_set_t rtdrv_rg_vlanGroupMacLimit_set_cfg;
	rtdrv_rg_vlanGroupMacLimit_del_t rtdrv_rg_vlanGroupMacLimit_del_cfg;
	rtdrv_rg_vlanGroupMacLimit_get_t rtdrv_rg_vlanGroupMacLimit_get_cfg;
	rtdrv_rg_vlanGroupMacLimit_find_t rtdrv_rg_vlanGroupMacLimit_find_cfg;
	...
	rtdrv_rg_urlflowPri_add_t	rtdrv_rg_urlflowPri_add_cfg;
	rtdrv_rg_urlflowPri_del_t	rtdrv_rg_urlflowPri_del_cfg;
