...
static rt_ext_mapper_t rt_ext_mapper = {0};


void rt_ext_mapper_register(rt_ext_mapper_t *pMapper)
{
    memcpy(&rt_ext_mapper,pMapper,sizeof(rt_ext_mapper_t));
}

EXPORT_SYMBOL(rt_ext_mapper_register);


rt_ext_mapper_t* rt_ext_mapper_get(void)
{
    return &rt_ext_mapper;
} /* end of rt_ext_mapper_get */
