...
typedef enum rtk_fc_ret_e
{
	...
	RTK_FC_RET_ERR_ENTRY_REPLASE,					// e.g. replace LUT entry
	...
	RTK_FC_RET_LRN_DUALPASSTHROUGH,
	//============================
	...
	//============================	
	RTK_FC_RET_NIC_TX_BUSY_TO_PS,   	// return value from nic tx driver to protocal stack

	/* drop code */
	RTK_FC_RET_DROP			= (RTK_FC_RET_CODE_BASIS << 2),							// 0x40000
	RTK_FC_RET_DROP_PORT_MOVING,
	...
	RTK_FC_RET_DROP_NIC_TX_BUSY,   	// nic tx driver return busy but non-local_out free
	RTK_FC_RET_DROP_END,
