...
typedef enum rtk_8277c_asic_flow_defAct_type_e{
	...
	RTK_8277C_FLOW_DEFACT_TYPE_TRAP_UMC_STORM,
...
typedef struct rtk_8277c_asic_globalDatabase_s{
	...
	char physical_port_to_deep_q[8];
...
typedef struct rtk_8277c_asic_flow_config_key_path12_s
{
	...
	uint32_t len_encoded	: 1; // for Ethernet SNAP out, if modify_vlan_only is 1, Ethernet SNAP header will disappear by l2 PE module
...
#if defined(CONFIG_RTK_FC_IPSEC_FASTFWD)
typedef struct rtk_8277c_asic_flow_config_key_esp_ds_spi_s
{
	...
	uint32_t is_from_ponRx_wifi_rx			: 2;
	uint32_t pon_streamId_or_wifi_devIdx	: 8; //stream id for PON RX or wifi dev index for wifi RX
}rtk_8277c_asic_flow_config_key_esp_ds_spi_t;

typedef struct rtk_8277c_asic_flow_config_action_esp_ds_spi_s
{
	uint32_t mac_da_idx					: 13;	// fdb index 4096 + 32 overflow
	uint32_t vlan_act					: 1;
	uint32_t vlan_cnt					: 2;
	...
	uint32_t sw_shaper_en				: 1;
	uint32_t l3_if_vld1					: 1;
}rtk_8277c_asic_flow_config_action_esp_ds_spi_t;

typedef struct rtk_8277c_asic_flow_config_esp_ds_spi_s
{
	rtk_8277c_asic_flow_config_key_esp_ds_spi_t key;
	rtk_8277c_asic_flow_config_action_esp_ds_spi_t action;
}rtk_8277c_asic_flow_config_esp_ds_spi_t;

#endif


#if defined(CONFIG_FC_RTL8277C_SERIES) || defined(CONFIG_FC_RTL9607F_SERIES)
typedef struct rtk_8277c_asic_flow_config_key_pathVxlan_up_extra_tx_s
{
	uint32_t orig_lspid		: 6;
	uint32_t netif_id		: 3; // Only support 8 netif
}rtk_8277c_asic_flow_config_key_pathVxlan_up_extra_tx_t;

typedef struct rtk_8277c_asic_flow_config_action_pathVxlan_up_extra_tx_s
{
	uint32_t cos_update_en				: 1;	// if update cos
	uint32_t cos						: 3;	// cos
	...
	uint32_t vxlan_sport_update_en		: 1;
	uint32_t vxlan_sport				: 16;	// vxlan source port (for upstream)
}rtk_8277c_asic_flow_config_action_pathVxlan_up_extra_tx_t;

typedef struct rtk_8277c_asic_flow_config_pathVxlan_up_extra_tx_s
{
	rtk_8277c_asic_flow_config_key_pathVxlan_up_extra_tx_t key;
	rtk_8277c_asic_flow_config_action_pathVxlan_up_extra_tx_t action;
}rtk_8277c_asic_flow_config_pathVxlan_up_extra_tx_t;
#endif
...
#endif
#if defined(CONFIG_FC_RTL8277C_SERIES) || defined(CONFIG_FC_RTL9607F_SERIES)
		rtk_8277c_asic_flow_config_pathVxlan_up_extra_tx_t pathVxlan_up_extra_tx;
#endif
#if defined(CONFIG_RTK_FC_IPSEC_FASTFWD)
		rtk_8277c_asic_flow_config_esp_ds_spi_t path_esp_ds_spi;
#endif
	};
...
#endif
#if defined(CONFIG_FC_RTL8277C_SERIES) || defined(CONFIG_FC_RTL9607F_SERIES)
		rtk_8277c_asic_flow_config_key_pathVxlan_up_extra_tx_t pathVxlan_up_extra_tx_key;
#endif
#if defined(CONFIG_RTK_FC_IPSEC_FASTFWD)
		rtk_8277c_asic_flow_config_key_esp_ds_spi_t path_esp_ds_spi_key;
#endif
	};
...
//__LITTLE_ENDIAN
	...
	uint32 in_tos:8;
	/* word 1 */
	uint32 in_ethertype_lsb3_0:4;							// RTK_ASIC_FLOW_PATH1_IN_ETHTYPE_PTR()
	uint32 in_smac_lut_idx: ASIC_TABLESIZE_LUT_BITS;		// G3 l2 table size is 4K+32
	uint32 in_iphdrif:1;
	uint32 in_len_encoded:1;
	uint32 in_dmac_lut_idx: ASIC_TABLESIZE_LUT_BITS;
	/* word 2 */
	uint32 in_ethertype_lsb7_4:4;							// RTK_ASIC_FLOW_PATH1_IN_ETHTYPE_PTR()
	...
	uint32 in_ethertype_msb:8;							// RTK_ASIC_FLOW_PATH1_IN_ETHTYPE_PTR()
	uint32 flow_cache_mib_idx_or_in_outerVlan:ASIC_FLOW_CACHE_MIB_SIZE_BITS;
	/* word 8 */
...
//__LITTLE_ENDIAN
	...
	uint32 in_tos:8;
	/* word 1 */
	uint32 in_ethertype_lsb3_0:4;
	uint32 in_smac_lut_idx: ASIC_TABLESIZE_LUT_BITS;		// G3 l2 table size is 4K+32
	uint32 reserved4:1;
	uint32 in_len_encoded:1;
	uint32 in_dmac_lut_idx: ASIC_TABLESIZE_LUT_BITS;
	/* word 2 */
	uint32 in_ethertype_lsb7_4:4;
	uint32 in_svlan_id:12;
	uint32 reserved6:4;
	uint32 in_cvlan_id:12;
	/* word 3 */
	...
	uint32 in_cvlan_pri:3;
	/* word 7 */
	uint32 reserved14:12;
	uint32 in_ethertype_msb:8;
	uint32 flow_cache_mib_idx:ASIC_FLOW_CACHE_MIB_SIZE_BITS;
	/* word 8 */
	uint32 reserved16:32;
#if defined(CONFIG_RTK_FC_WFO_PER_HW_FLOW_MIB)
	/* word 9 */
...
#if defined(CONFIG_FC_RTL8277C_SERIES) || defined(CONFIG_FC_RTL9607F_SERIES)
typedef struct rtk_8277c_asic_pathVxlan_up_extra_tx_entry_s
{
//__LITTLE_ENDIAN
	/* word 0 */
	uint32 valid:1;
	...
	uint32 reserved17: 32;
#endif
}rtk_8277c_asic_pathVxlan_up_extra_tx_entry_t;
#endif
...
typedef struct rtk_8277c_asic_esp_ds_spi_entry_s
{
...
}rtk_8277c_asic_esp_ds_spi_entry_t;
