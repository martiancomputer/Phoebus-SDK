...
_phy_8218e_gphy_perPort_init(uint32 unit, rtk_port_t port)
{
    ...
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 30, 0x8);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x322);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 15, 12, 0x7);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x13, 15, 12, 0x7);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x16, 15, 12, 0x7);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x323);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x11, 15, 12, 0x7);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x324);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 15, 12, 0x7);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x13, 15, 12, 0x7);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x16, 15, 12, 0x7);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x325);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x11, 15, 12, 0x7);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x322);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 8, 6, 0x3);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x13, 8, 6, 0x3);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x16, 8, 6, 0x3);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x323);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x11, 8, 6, 0x3);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x324);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 8, 6, 0x3);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x13, 8, 6, 0x3);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x16, 8, 6, 0x3);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x325);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x11, 8, 6, 0x3);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 30, 0x0);

    hal_miim_park_write(unit, port, maxPage, fix_page, 31, 0xA43);
    hal_miim_parkBits_write(unit, port, maxPage, fix_page, 25, 6, 6, 0);

    hal_miim_park_write(unit, port, maxPage, fix_page, 31, 0xbc1);
    hal_miim_park_write(unit, port, maxPage, fix_page, 18, 0x8804);

    hal_miim_park_write(unit, basePort, maxPage, fix_page, 30, 0x8);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x361);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 15, 12, 0x1);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 11, 8, 0x2);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 7, 4, 0x1);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x10, 3, 0, 0x1);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 31, 0x361);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x11, 7, 4, 0x1);
    hal_miim_parkBits_write(unit, basePort, maxPage, fix_page, 0x11, 3, 0, 0x1);
    hal_miim_park_write(unit, basePort, maxPage, fix_page, 30, 0x0);
}
...
_phy_8218e_uc_nctl_perPort_init(uint32 unit, rtk_port_t port)
{
    ...
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1b64);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xab04);
    ...
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x8018);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x801b);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x802e);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x802e);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x802e);
    ...
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0daf);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xc114);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0673);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x416e);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1000);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0652);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1000);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0699);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xd501);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xa103);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x8203);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xd500);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0097);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1000);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x069f);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xd501);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x8103);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xa203);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0xd500);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x1800);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0097);
    ...
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0000);
    hal_miim_park_write(unit, port, maxPage, fix_page, 27, 0xa006);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x008e);
    hal_miim_park_write(unit, port, maxPage, fix_page, 27, 0xa004);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0672);
    hal_miim_park_write(unit, port, maxPage, fix_page, 27, 0xa002);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0dad);
    hal_miim_park_write(unit, port, maxPage, fix_page, 27, 0xa000);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0d43);
    hal_miim_park_write(unit, port, maxPage, fix_page, 27, 0xa008);
    hal_miim_park_write(unit, port, maxPage, fix_page, 28, 0x0f00);
