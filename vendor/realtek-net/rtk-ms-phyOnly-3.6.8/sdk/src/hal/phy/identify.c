...
#if (defined(CONFIG_SDK_RTL8208D) || defined(CONFIG_SDK_RTL8208G) || defined(CONFIG_SDK_RTL8208L) || defined(CONFIG_SDK_RTL8208L_VB))
...
static int32 _phy_identify_8208L_VB(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id);
#endif
...
static int32 _phy_identify_8224QF(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id);
...
#if defined(CONFIG_SDK_RTL826XB)
static int32 _phy_identify_8261BE(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id);
...
static int32 _phy_identify_8251Lrev3(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id);
static int32 _phy_identify_8254B(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id);
#endif
...
static int32 _phy_identify_8224N(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id);
#endif
...
static rt_phyctrl_t supported_phys[] =
{
...
#endif
#if defined(CONFIG_SDK_RTL8208L_VB)
    {_phy_identify_8208L_VB, PHY_MODEL_ID_RTL8208L_VB, PHY_REV_NO_C, RTK_PHYTYPE_RTL8208L_VB, NULL, phy_8208Ddrv_fe_mapperInit, 1, &phy_8208_info, NULL},
#endif
#if defined(CONFIG_SDK_RTL8218B)
...
#endif
#if defined(CONFIG_SDK_RTL8224QF)
    {_phy_identify_8224QF,    PHY_MODEL_ID_RTL8224QF, PHY_REV_NO_A, RTK_PHYTYPE_RTL8224QF,      NULL, phy_8224QFdrv_mapperInit, 1, &phy_8224QF_info},
#endif
#if defined(CONFIG_SDK_RTL8226)
...
#endif
#if defined(CONFIG_SDK_RTL826XB)
    {_phy_identify_8261BE, PHY_MODEL_ID_RTL826X, PHY_REV_NO_D, RTK_PHYTYPE_RTL8261BE, NULL, phy_826XBdrv_mapperInit, 0, &phy_8261B_info},
    ...
    {_phy_identify_8251Lrev3, PHY_MODEL_ID_RTL826X, PHY_REV_NO_D, RTK_PHYTYPE_RTL8251L_REV3, NULL, phy_825XLrev3drv_mapperInit, 0, &phy_8251Lrev3_info},
    {_phy_identify_8254B, PHY_MODEL_ID_RTL8264B, PHY_REV_NO_D, RTK_PHYTYPE_RTL8254B, NULL, phy_825XBdrv_mapperInit, 0, &phy_8254B_info},
#endif
#if (defined(CONFIG_SDK_RTL826X) || defined(CONFIG_SDK_RTL826XI))
...
#endif
#if defined(CONFIG_SDK_RTL8224)
    {_phy_identify_8224, PHY_MODEL_ID_RTL8224, PHY_REV_NO_A, RTK_PHYTYPE_RTL8224, NULL, phy_8224drv_mapperInit, 0, &phy_8224_info},
    {_phy_identify_8224N, PHY_MODEL_ID_RTL8224, PHY_REV_NO_A, RTK_PHYTYPE_RTL8224N, NULL, phy_8224drv_mapperInit, 0, &phy_8224_info},
#endif
...
#if defined(CONFIG_SDK_RTL8208L_VB)
/* Function Name:
 *      _phy_identify_8208L_VB
 * Description:
 *      Identify the port is 8208L_VB PHY or not?
 * Input:
 *      unit     - unit id
 *      port     - port id
 *      model_id - model id
 ...
 *      None
 * Return:
 *      RT_ERR_OK               - is 8208L_VB PHY
 *      RT_ERR_FAILED           - access failure or others
 *      RT_ERR_PHY_NOT_MATCH    - is not 8208L_VB PHY
 * Note:
 *      None
 */
static int32
_phy_identify_8208L_VB(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    uint32 real_model_id, real_rev_id;
    uint32 base_port = 0, data;
    ...
    if (hal_miim_read(unit, base_port, 68, 16, &data) != RT_ERR_OK)
    {
        return RT_ERR_FAILED;
    }
    ...
    if (hal_miim_read(unit, base_port, 68, 17, &data) != RT_ERR_OK)
    {
        return RT_ERR_FAILED;
    }
...
#if defined(CONFIG_SDK_RTL8224QF)
/* Function Name:
 *      _phy_identify_8224QF
 * Description:
 *      Identify the port is 8224QF PHY or not?
 * Input:
 *      unit     - unit id
 *      port     - port id
 *      model_id - model id
 ...
 */
static int32
_phy_identify_8224QF(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    hal_control_t   *pHalCtrl = NULL;
    uint32      id = 0, c1 = 0, c2 = 0, data = 0, blk;
    int32           ret;
...
_phy_identify_8251L(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    ...
    {
        if ((ret = MACDRV(pHalCtrl)->fMdrv_miim_mmd_read(unit, port, 1, 3, &reg_data1)) != RT_ERR_OK)
            return ret;

        if (PHY_IDENT_REV_NUM(reg_data1) != 2)
        {
            return RT_ERR_PHY_NOT_MATCH;
        }
        return RT_ERR_OK;
...
static int32
_phy_identify_8224N(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    hal_control_t   *pHalCtrl = NULL;
    int32           ret;
    uint32          reg_data1 = 0;
    ...
    if (reg_data1 == 0x7000 && reg_data2 == 0x8224)
    {
        return RT_ERR_OK;
    }
    else
...
#if defined(CONFIG_SDK_RTL826XB)
static int32
_phy_identify_8261BE(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    int32           ret;
    uint32          reg_data1 = 0;
...
static int32
_phy_identify_8254B(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    hal_control_t   *pHalCtrl = NULL;
    int32           ret;
    uint32          reg_data1 = 0;
...
static int32
_phy_identify_8251Lrev3(uint32 unit, rtk_port_t port, uint32 model_id, uint32 rev_id)
{
    int32           ret;
    uint32          reg_data1 = 0;
    uint32          reg_data2 = 0, model_c1 = 0, model_c2 = 0;
