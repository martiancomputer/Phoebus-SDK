...
{
    HWP_RTL8382M_8218D_INTPHY_8218D_2FIB_1G_POE   = 8380501,
    ...
    HWP_RTL9303_2x8264_DEMO,
    HWP_RTL9303_8264_4x8261_DEMO,
    HWP_RTL9303_8264B_4x8261B_DEMO,
    HWP_RTL9302D_1X8224_QA,
    HWP_RTL9310_FPGA_L3                           = 9310501,
    HWP_RTL9310_FPGA,
    HWP_RTL9310_48GE_4XGE_FPGA,
    HWP_RTL9311_FT,
    HWP_RTL9311_4x9301_SPI_SIMU,
    HWP_RTL9311_9303_3x9301_SPI_SIMU,
    HWP_RTL9313_4x8221B_8XGE,
    HWP_RTL9313_2x8261N_HW,
}hwp_id_internal_t;
...
#include <common/rt_autoconf.h>
    ...
    #include <hwp/hw_profiles/internel_profiles/rtl9311_4x9301_spi_simu.c>
    #include <hwp/hw_profiles/internel_profiles/rtl9311_9303_3x9301_spi_simu.c>
    #include <hwp/hw_profiles/internel_profiles/rtl9313_4x8221b_8xge.c>
    #include <hwp/hw_profiles/internel_profiles/rtl9313_2x8261n_hw.c>
    ...
    #include <hwp/hw_profiles/internel_profiles/rtl9303_2x8264_demo.c>
    #include <hwp/hw_profiles/internel_profiles/rtl9303_8264_4x8261_demo.c>
    #include <hwp/hw_profiles/internel_profiles/rtl9303_8264b_4x8261b_demo.c>
    #include <hwp/hw_profiles/internel_profiles/rtl9302d_1x8224_qa.c>
#endif/* CONFIG_SDK_RTL9300 */

#if defined(CONFIG_SDK_RTL8380)
  #include <hwp/hw_profiles/internel_profiles/rtl8382m_8218d_intphy_8218d_2fib_1g_poe.c>
#endif
  ...
  #include <hwp/hw_profiles/internel_profiles/rtl8391m_rtl9310_fpga_l3.c>
    ...
    #define RTL9310_INTERNAL_PROFILE\
        ...
        &rtl9310_fpga_l3,\
        &rtl9311_ft, \
        &rtl9311_4x9301_spi_simu, \
        &rtl9311_9303_3x9301_spi_simu, \
        &rtl9313_4x8221b_8xge, \
        &rtl9313_2x8261n_hw, \
        &rtl9311_2x8214qf_1x8224qf_2x8295r,
#else
    #define RTL9310_INTERNAL_PROFILE
#endif
    ...
    #define RTL9300_INTERNAL_PROFILE\
        ...
        &rtl9303_8xge_qa1,\
        &rtl9303_2x8264_demo,\
        &rtl9303_8264_4x8261_demo,\
        &rtl9303_8264b_4x8261b_demo, \
        &rtl9302d_1x8224_qa,
#else
    #define RTL9300_INTERNAL_PROFILE
#endif
...
#if defined(CONFIG_SDK_RTL8380)
    #define RTL8380_INTERNAL_PROFILE\
        &rtl8382m_8218d_intphy_8218d_2fib_1g_poe,
#else
    #define RTL8380_INTERNAL_PROFILE
#endif
