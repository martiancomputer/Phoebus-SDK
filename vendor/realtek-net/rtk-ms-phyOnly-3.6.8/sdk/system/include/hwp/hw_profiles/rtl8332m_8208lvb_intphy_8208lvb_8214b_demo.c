 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8332M_8208L_INTPHY_8208L_8214B demo board.
 *
 * Feature : RTL8332M_8208L_INTPHY_8208L_8214B demo board database.
 *
 */

static hwp_swDescp_t rtl8332m_8208lvb_intphy_8208lvb_8214b_demo_swDescp= {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 24,       .led_c = 1,        .led_f = HWP_NONE, .led_layout = DOUBLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 25,       .led_c = 1,        .led_f = HWP_NONE, .led_layout = DOUBLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 5,        .phy_idx = 3,        .smi = 0, .phy_addr = 26,       .led_c = 1,        .led_f = HWP_NONE, .led_layout = DOUBLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 5,        .phy_idx = 3,        .smi = 0, .phy_addr = 27,       .led_c = 1,        .led_f = HWP_NONE, .led_layout = DOUBLE_SET,},
    ...
    .phy.descp = {
        [0] =   { .chip = RTK_PHYTYPE_RTL8208L_VB,  .mac_id = 0,   .phy_max = 8 },
        [1] =   { .chip = RTK_PHYTYPE_RTL8208L_INT, .mac_id = 8,   .phy_max = 8 },
        [2] =   { .chip = RTK_PHYTYPE_RTL8208L_VB,  .mac_id = 16,  .phy_max = 8 },
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8332m_8208lvb_intphy_8208lvb_8214b_demo = {

    .identifier.name        = "RTL8332M_8208LVB_INTPHY_8208LVB_8214B_DEMO",
    .identifier.id          = HWP_RTL8332M_8208LVB_INTPHY_8208LVB_8214B_DEMO,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8332m_8208lvb_intphy_8208lvb_8214b_demo_swDescp,
    }
