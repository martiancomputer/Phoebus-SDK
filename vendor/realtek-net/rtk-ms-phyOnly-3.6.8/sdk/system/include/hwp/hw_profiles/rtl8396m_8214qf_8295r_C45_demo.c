...
static hwp_swDescp_t rtl8396m_8214qf_8295r_c45_demo_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id =  8, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_FIBER,              .sds_idx =  2,       .phy_idx = 1,        .smi = 0,        .phy_addr =  8,       .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
        { .mac_id =  9, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_FIBER,              .sds_idx =  2,       .phy_idx = 1,        .smi = 0,        .phy_addr =  9,       .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
        { .mac_id = 10, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_FIBER,              .sds_idx =  2,       .phy_idx = 1,        .smi = 0,        .phy_addr = 10,       .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
        { .mac_id = 11, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_FIBER,              .sds_idx =  2,       .phy_idx = 1,        .smi = 0,        .phy_addr = 11,       .led_c = 0,        .led_f = 0,       .led_layout = SINGLE_SET,},
#if defined(CONFIG_SDK_RTL8295R)
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_FIBER,              .sds_idx =  6,       .phy_idx = 2,        .smi = 2,        .phy_addr = 0,        .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
        { .mac_id = 36, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_FIBER,              .sds_idx =  7,       .phy_idx = 3,        .smi = 2,        .phy_addr = 1,        .led_c = 1,        .led_f = 1,       .led_layout = SINGLE_SET,},
#else
    ...
    .phy.descp = {
        ...
        [1] = { .chip = RTK_PHYTYPE_RTL8214QF,  .mac_id = 8 , .phy_max = 4 },
#if defined(CONFIG_SDK_RTL8295R) && (USE_8295R == 1)
        [2] = { .chip = RTK_PHYTYPE_RTL8295R,  .mac_id = 24, .phy_max = 1 },
        [3] = { .chip = RTK_PHYTYPE_RTL8295R,  .mac_id = 36, .phy_max = 1 },
        [4] = { .chip = HWP_END },
#else
        [2] = { .chip = HWP_END },
#endif
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8396m_8214qf_8295r_c45_demo = {

    .identifier.name    = "RTL8396M_8214QF_8295R_C45_DEMO",
    .identifier.id      = HWP_RTL8396M_8214QF_8295R_C45_DEMO,

    .soc.swDescp_index  = 0,

    .sw_count           = 1,
    .swDescp = {
        [0]             = &rtl8396m_8214qf_8295r_c45_demo_swDescp,
    }
};
