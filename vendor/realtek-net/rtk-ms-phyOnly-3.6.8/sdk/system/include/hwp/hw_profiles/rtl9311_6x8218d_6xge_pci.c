 ...
 * 48 + 6*10G mode
 */
static hwp_swDescp_t rtl9311_6x8218d_6xge_pci_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311_6x8218d_6xge_pci = {
    .identifier.name        = "RTL9311_6x8218D_6XGE_PCI",
    .identifier.id          = HWP_RTL9311_6x8218D_6XGE_PCI,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9311_6x8218d_6xge_pci_swDescp,
    }
