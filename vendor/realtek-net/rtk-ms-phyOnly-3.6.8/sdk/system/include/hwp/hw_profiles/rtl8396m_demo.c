 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8393M DEMO board.
 *
 * Feature : RTL8393M DEMO board database
 *
 */
static hwp_swDescp_t rtl8396m_demo_swDescp = {
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[2] = HWP_LED_END,

        .led_definition_set[1].led[0] = 0xA,        /* 1000Mbps link/act */
        .led_definition_set[1].led[1] = 0x15,       /* 10G link/act */
        .led_definition_set[1].led[2] = HWP_LED_END,
    }, /* led.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8396m_demo = {

    .identifier.name        = "RTL8396M2_DEMO",
    .identifier.id          = HWP_RTL8396M2_DEMO,
