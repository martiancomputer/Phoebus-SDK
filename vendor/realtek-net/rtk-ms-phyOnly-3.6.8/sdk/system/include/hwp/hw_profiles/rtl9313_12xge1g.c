 ...
 * 12*10G mode
 */
static hwp_swDescp_t rtl9313_12xge1g_swDescp = {
    ...
    .serdes.descp = {
        [0] = { .sds_id = 2, .mode = RTK_MII_10GR1000BX_AUTO,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_CHANGE },
        [1] = { .sds_id = 3, .mode = RTK_MII_10GR1000BX_AUTO,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_CHANGE },
        [2] = { .sds_id = 4, .mode = RTK_MII_10GR1000BX_AUTO,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_CHANGE },
        [3] = { .sds_id = 5, .mode = RTK_MII_10GR1000BX_AUTO,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_CHANGE },
        [4] = { .sds_id = 6, .mode = RTK_MII_10GR1000BX_AUTO,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_CHANGE },
        [5] = { .sds_id = 7, .mode = RTK_MII_10GR1000BX_AUTO,  .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_CHANGE },
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9313_12xge1g = {

    .identifier.name        = "RTL9313_12XGE1G",
    .identifier.id          = HWP_RTL9313_12XGE1G,
