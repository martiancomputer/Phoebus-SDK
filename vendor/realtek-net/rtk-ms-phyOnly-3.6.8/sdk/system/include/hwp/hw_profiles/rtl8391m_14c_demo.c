 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8391M_8214C DEMO board.
 *
 * Feature : RTL8391M_8214C DEMO board database
 *
 */
static hwp_swDescp_t rtl8391m_14c_demo_swDescp = {

    .chip_id                    = RTL8391M_CHIP_ID,
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr =  0,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET,},
        { .mac_id = 25, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr =  1,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr =  2,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr =  3,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET,},
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8391m_14c_demo = {

    .identifier.name        = "RTL8391M_14C_DEMO",
    .identifier.id          = HWP_RTL8391M_14C_DEMO,
