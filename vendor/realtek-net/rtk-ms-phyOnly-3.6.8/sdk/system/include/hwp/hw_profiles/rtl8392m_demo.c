 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8392M DEMO board.
 *
 * Feature : RTL8392M DEMO board database
 *
 */

static hwp_swDescp_t rtl8392m_demo_swDescp = {

    .chip_id                    = RTL8392M_CHIP_ID,
    ...
    .port.descp = {
        ...
        { .mac_id = 48, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr = 24,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET, },
        { .mac_id = 49, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr = 25,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET, },
        { .mac_id = 50, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr = 26,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET, },
        { .mac_id = 51, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx =  6,       .phy_idx = 3,        .smi = 1, .phy_addr = 27,       .led_c = 0,        .led_f = 0,        .led_layout = DOUBLE_SET, },
    ...
    .serdes.descp = {
        ...
        [6]  = { .sds_id = 12, .mode = RTK_MII_QSGMII, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL },
        [7]  = { .sds_id = HWP_END},
    },  /* serdes.descp */
    ...
    .phy.descp = {
        ...
        [3] = { .chip = RTK_PHYTYPE_RTL8214FC, .mac_id = 48, .phy_max = 4 },
        [4] = { .chip = HWP_END},
    },   /* .phy.descp */
};
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8392m_demo = {

    .identifier.name        = "RTL8392M_DEMO",
    .identifier.id          = HWP_RTL8392M_DEMO,
