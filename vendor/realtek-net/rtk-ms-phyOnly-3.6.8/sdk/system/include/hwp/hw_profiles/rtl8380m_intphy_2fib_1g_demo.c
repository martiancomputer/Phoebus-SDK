 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8380M_INTPHY_2FIB_1G_DEMO demo board.
 *
 * Feature : RTL8380M_INTPHY_2FIB_1G_DEMO demo board database
 *
 */


static hwp_swDescp_t rtl8380m_intphy_2fib_1g_demo_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8380m_intphy_2fib_1g_demo = {

    .identifier.name        = "RTL8380M_INTPHY_2FIB_1G_DEMO",
    .identifier.id          = HWP_RTL8380M_INTPHY_2FIB_1G_DEMO,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8380m_intphy_2fib_1g_demo_swDescp,
    }
