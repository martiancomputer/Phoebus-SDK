 ...
 * 24 + 4*10G mode
 */
static hwp_swDescp_t rtl9301_3x8218d_4xge_swDescp = {
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9301_3x8218d_4xge = {

    .identifier.name        = "RTL9301_3x8218D_4XGE",
    .identifier.id          = HWP_RTL9301_3x8218D_4XGE,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9301_3x8218d_4xge_swDescp,
    }
