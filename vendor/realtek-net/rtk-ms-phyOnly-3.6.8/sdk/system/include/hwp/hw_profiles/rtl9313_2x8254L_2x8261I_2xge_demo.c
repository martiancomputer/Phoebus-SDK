...
static hwp_swDescp_t rtl9313_2x8254L_2x8261I_2xge_demo_swDescp = {
    ...
    .port.descp =
    {
        { .mac_id =  0, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 0,       .phy_idx = 0,        .smi = 0,               .phy_addr = 0,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0b0100},
        { .mac_id =  8, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 1,       .phy_idx = 0,        .smi = 0,               .phy_addr = 1,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0},
        { .mac_id = 16, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 2,       .phy_idx = 0,        .smi = 0,               .phy_addr = 2,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0},
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 3,       .phy_idx = 0,        .smi = 0,               .phy_addr = 3,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0},
        { .mac_id = 32, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 4,       .phy_idx = 1,        .smi = 1,               .phy_addr = 4,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0},
        { .mac_id = 40, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 5,       .phy_idx = 1,        .smi = 1,               .phy_addr = 5,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0},
        { .mac_id = 48, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 6,       .phy_idx = 1,        .smi = 1,               .phy_addr = 6,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0},
        { .mac_id = 50, .attr = HWP_ETH,   .eth = HWP_5GE,  .medi = HWP_COPPER,  .sds_idx = 7,       .phy_idx = 1,        .smi = 1,               .phy_addr = 7,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0},
    ...
    .phy.descp =
    {
        ...
        [1] = {.chip = RTK_PHYTYPE_RTL8254,.mac_id = 32,.phy_max = 4},
        [2] = {.chip = RTK_PHYTYPE_RTL8261I,.mac_id = 52,.phy_max = 1},
        [3] = {.chip = RTK_PHYTYPE_RTL8261I,.mac_id = 53,.phy_max = 1},
        [4] = { .chip = HWP_END },
    },   /* .phy.descp */
};
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9313_2x8254L_2x8261I_2xge_demo = {

    .identifier.name        = "RTL9313_2x8254L_2x8261I_2XGE_DEMO",
    .identifier.id          = HWP_RTL9313_2x8254L_2x8261I_2XGE_DEMO,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9313_2x8254L_2x8261I_2xge_demo_swDescp,
    }
