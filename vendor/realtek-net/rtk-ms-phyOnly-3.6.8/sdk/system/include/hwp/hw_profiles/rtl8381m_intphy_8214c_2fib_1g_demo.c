...
static hwp_swDescp_t rtl8381m_intphy_8214c_2fib_1g_demo_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 16, .attr = HWP_ETH, .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx = 2,        .phy_idx = 1,        .smi = 0,        .phy_addr = 16,       .led_c = 0,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 17, .attr = HWP_ETH, .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx = 2,        .phy_idx = 1,        .smi = 0,        .phy_addr = 17,       .led_c = 0,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 18, .attr = HWP_ETH, .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx = 2,        .phy_idx = 1,        .smi = 0,        .phy_addr = 18,       .led_c = 0,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 19, .attr = HWP_ETH, .eth = HWP_GE,   .medi = HWP_COPPER, .sds_idx = 2,        .phy_idx = 1,        .smi = 0,        .phy_addr = 19,       .led_c = 0,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
    ...
    .phy.descp = {
        ...
        [1] =   { .chip = RTK_PHYTYPE_RTL8214C,     .mac_id = 16,  .phy_max = 4 },
        [2] =   { .chip = HWP_END},
    }   /* .phy.descp */
};
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8381m_intphy_8214c_2fib_1g_demo = {

    .identifier.name        = "RTL8381M_INTPHY_8214C_2FIB_1G_DEMO",
    .identifier.id          = HWP_RTL8381M_INTPHY_8214C_2FIB_1G_DEMO,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8381m_intphy_8214c_2fib_1g_demo_swDescp,
    }
