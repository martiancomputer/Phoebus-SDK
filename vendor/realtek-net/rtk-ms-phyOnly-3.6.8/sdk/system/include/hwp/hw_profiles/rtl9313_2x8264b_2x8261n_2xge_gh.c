...
static hwp_swDescp_t rtl9313_2x8264B_2x8261N_2xge_gh_swDescp = {
    ...
    .port.descp =
    {
        { .mac_id =  0, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 0,        .phy_idx = 0,        .smi = 0,               .phy_addr = 0,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0b0100 },
        { .mac_id =  8, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 1,        .phy_idx = 0,        .smi = 0,               .phy_addr = 1,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0b0100 },
        { .mac_id = 16, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 2,        .phy_idx = 0,        .smi = 0,               .phy_addr = 2,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0b0100 },
        { .mac_id = 24, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 3,        .phy_idx = 0,        .smi = 0,               .phy_addr = 3,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
        { .mac_id = 32, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 4,        .phy_idx = 1,        .smi = 1,               .phy_addr = 4,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0b0100 },
        { .mac_id = 40, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 5,        .phy_idx = 1,        .smi = 1,               .phy_addr = 5,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0b0100 },
        { .mac_id = 48, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 6,        .phy_idx = 1,        .smi = 1,               .phy_addr = 6,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0b0100 },
        { .mac_id = 50, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 7,        .phy_idx = 1,        .smi = 1,               .phy_addr = 7,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
    ...
    .serdes.descp = {
        ...
        [8] =  { .sds_id = 10, .mode = RTK_MII_USXGMII_10GSXGMII,   .rx_polarity = SERDES_POLARITY_CHANGE, .tx_polarity = SERDES_POLARITY_CHANGE },
        [9] =  { .sds_id = 11, .mode = RTK_MII_USXGMII_10GSXGMII,   .rx_polarity = SERDES_POLARITY_CHANGE, .tx_polarity = SERDES_POLARITY_CHANGE },
    ...
    .phy.descp =
    {
        [0] = { .chip = RTK_PHYTYPE_RTL8264B, .mac_id =  0, .phy_max = 4 },
        [1] = { .chip = RTK_PHYTYPE_RTL8264B, .mac_id = 32, .phy_max = 4 },
        [2] = { .chip = RTK_PHYTYPE_RTL8261B, .mac_id = 52, .phy_max = 1 },
        [3] = { .chip = RTK_PHYTYPE_RTL8261B, .mac_id = 53, .phy_max = 1 },
        [4] = { .chip = HWP_END },
    },   /* .phy.descp */
};
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9313_2x8264b_2x8261n_2xge_gh = {

    .identifier.name        = "RTL9313_2x8264B_2x8261N_2XGE_GH",
    .identifier.id          = HWP_RTL9313_2x8264B_2x8261N_2XGE_GH,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9313_2x8264B_2x8261N_2xge_gh_swDescp,
    }
