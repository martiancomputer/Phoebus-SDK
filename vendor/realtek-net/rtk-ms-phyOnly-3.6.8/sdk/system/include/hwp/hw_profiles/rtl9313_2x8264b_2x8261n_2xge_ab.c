...
static hwp_swDescp_t rtl9313_2x8264B_2x8261N_2xge_ab_swDescp = {
    ...
    .port.descp =
    {
        { .mac_id =  0, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 0,        .phy_idx = 0,        .smi = 0,               .phy_addr = 0,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
        ...
        { .mac_id = 32, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 4,        .phy_idx = 1,        .smi = 1,               .phy_addr = 4,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9313_2x8264b_2x8261n_2xge_ab = {

    .identifier.name        = "RTL9313_2x8264B_2x8261N_2XGE_AB",
    .identifier.id          = HWP_RTL9313_2x8264B_2x8261N_2XGE_AB,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9313_2x8264B_2x8261N_2xge_ab_swDescp,
    }
