...
static hwp_swDescp_t rtl9311_6x8218d_6xFib1g100_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 48, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES,  .sds_idx = 6,       .phy_idx = HWP_NONE, .smi = 3,        .phy_addr = 0,        .led_c = HWP_NONE, .led_f = 2,       .led_layout = SINGLE_SET,},
        { .mac_id = 50, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES,  .sds_idx = 7,       .phy_idx = HWP_NONE, .smi = 3,        .phy_addr = 1,        .led_c = HWP_NONE, .led_f = 2,       .led_layout = SINGLE_SET,},
        { .mac_id = 52, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES,  .sds_idx = 8,       .phy_idx = HWP_NONE, .smi = 3,        .phy_addr = 2,        .led_c = HWP_NONE, .led_f = 2,       .led_layout = SINGLE_SET,},
        { .mac_id = 53, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES,  .sds_idx = 9,       .phy_idx = HWP_NONE, .smi = 3,        .phy_addr = 3,        .led_c = HWP_NONE, .led_f = 2,       .led_layout = SINGLE_SET,},
        { .mac_id = 54, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES,  .sds_idx = 10,      .phy_idx = HWP_NONE, .smi = 3,        .phy_addr = 4,        .led_c = HWP_NONE, .led_f = 2,       .led_layout = SINGLE_SET,},
        { .mac_id = 55, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_SERDES,  .sds_idx = 11,      .phy_idx = HWP_NONE, .smi = 3,        .phy_addr = 5,        .led_c = HWP_NONE, .led_f = 2,       .led_layout = SINGLE_SET,},
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9311_6x8218d_6xFib1g100 = {
    .identifier.name        = "RTL9311_6x8218D_6xFib1g100",
    .identifier.id          = HWP_RTL9311_6x8218D_6xFib1g100,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9311_6x8218d_6xFib1g100_swDescp,
    }
