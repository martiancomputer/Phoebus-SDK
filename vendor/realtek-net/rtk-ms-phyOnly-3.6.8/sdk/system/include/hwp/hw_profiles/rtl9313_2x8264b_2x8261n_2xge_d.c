...
static hwp_swDescp_t rtl9313_2x8264B_2x8261N_2xge_d_swDescp = {
    ...
    .port.descp =
    {
        ...
        { .mac_id =  8, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 1,        .phy_idx = 0,        .smi = 0,               .phy_addr = 1,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
        { .mac_id = 16, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 2,        .phy_idx = 0,        .smi = 0,               .phy_addr = 2,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
        ...
        { .mac_id = 40, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 5,        .phy_idx = 1,        .smi = 1,               .phy_addr = 5,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
        { .mac_id = 48, .attr = HWP_ETH,   .eth = HWP_XGE,  .medi = HWP_COPPER,  .sds_idx = 6,        .phy_idx = 1,        .smi = 1,               .phy_addr = 6,        .led_c = HWP_NONE, .led_f = HWP_NONE, .led_layout = SINGLE_SET, .phy_mdi_pin_swap = 0, .phy_mdi_pair_swap = 0 },
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl9313_2x8264b_2x8261n_2xge_d = {

    .identifier.name        = "RTL9313_2x8264B_2x8261N_2XGE_D",
    .identifier.id          = HWP_RTL9313_2x8264B_2x8261N_2XGE_D,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl9313_2x8264B_2x8261N_2xge_d_swDescp,
    }
