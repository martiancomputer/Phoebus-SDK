 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8391M DEMO board.
 *
 * Feature : RTL8391M DEMO board database
 *
 */
static hwp_swDescp_t rtl8391m_demo_swDescp = {
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[1] = 0xF,    /* 1000Mbps link/act */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8391m_demo = {

    .identifier.name        = "RTL8391M_DEMO",
    .identifier.id          = HWP_RTL8391M_DEMO,
