 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the HWP_RTL8382M_8218D_INTPHY_8218D_8214FC_DEMO demo board.
 *
 * Feature : HWP_RTL8382M_8218D_INTPHY_8218D_8214FC_DEMO demo board database
 *
 */

static hwp_swDescp_t rtl8382m_8218d_intphy_8218d_8214fc_demo_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 26, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 26,       .led_c = 1,       .led_f = HWP_NONE, .led_layout = DOUBLE_SET,},
        { .mac_id = 27, .attr = HWP_ETH,   .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = 3,        .smi = 0, .phy_addr = 27,       .led_c = 1,       .led_f = HWP_NONE, .led_layout = DOUBLE_SET,},
    ...
    .phy.descp = {
        ...
        [3] =   { .chip = RTK_PHYTYPE_RTL8214FC, .mac_id = 24,  .phy_max = 4 },
        [4] =   { .chip = HWP_END },
    }   /* .phy.descp */
};
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8382m_8218d_intphy_8218d_8214fc_demo = {

    .identifier.name        = "RTL8382M_8218D_INTPHY_8218D_8214FC_DEMO",
    .identifier.id          = HWP_RTL8382M_8218D_INTPHY_8218D_8214FC_DEMO,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8382m_8218d_intphy_8218d_8214fc_demo_swDescp,
    }
