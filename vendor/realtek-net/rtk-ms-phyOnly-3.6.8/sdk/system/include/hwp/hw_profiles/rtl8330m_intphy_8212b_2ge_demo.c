 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8330M_INTPHY_8212B_2GE_DEMO demo board.
 *
 * Feature : RTL8330M_INTPHY_8212B_2GE_DEMO demo board database
 *
 */

 static hwp_swDescp_t rtl8330m_intphy_8212b_2ge_demo_swDescp = {
    ...
    .port.descp = {
        ...
        { .mac_id = 24, .attr = HWP_ETH, .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 4,        .phy_idx = HWP_NONE, .smi = 0, .phy_addr = HWP_NONE, .led_c = 1,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 26, .attr = HWP_ETH, .eth = HWP_GE,   .medi = HWP_COMBO,  .sds_idx = 5,        .phy_idx = HWP_NONE, .smi = 0, .phy_addr = HWP_NONE, .led_c = 1,       .led_f = HWP_NONE, .led_layout = SINGLE_SET,},
        { .mac_id = 28, .attr = HWP_CPU, .eth = HWP_NONE, .medi = HWP_NONE,   .sds_idx = HWP_NONE, .phy_idx = HWP_NONE, .smi = 0, .phy_addr = HWP_NONE, .led_c = HWP_NONE,.led_f = HWP_NONE, .led_layout = HWP_NONE,},
        { .mac_id = HWP_END },
    },  /* port.descp */
    ...
    .led.descp = {
        ...
        .led_definition_set[0].led[0] = 0xB,          /* 100M Link/Act */
        .led_definition_set[0].led[1] = HWP_LED_END,      /* none */
        /* LED definition - set 1 */
        .led_definition_set[1].led[0] = 0xC,          /* 10M Link/Act */
        .led_definition_set[1].led[1] = 0xB,          /* 100M Link/Act */
    ...
    .serdes.descp = {
        ...
        [4] = { .sds_id = 4, .mode = RTK_MII_SGMII, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL},
        [5] = { .sds_id = 5, .mode = RTK_MII_SGMII, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL},
        [6] = { .sds_id = HWP_END },
    }, /* serdes.descp */
 ...
 * hardware profile
 */
static hwp_hwProfile_t rtl8330m_intphy_8212b_2ge_demo = {

    .identifier.name        = "RTL8330M_INTPHY_8212B_SGMII_DEMO",
    .identifier.id          = HWP_RTL8330M_INTPHY_8212B_SGMII_DEMO,
    ...
    .sw_count               = 1,
    .swDescp = {
        [0]                 = &rtl8330m_intphy_8212b_2ge_demo_swDescp,
    }
