...
#define RT_UTIL_TIME_TC_ID          TC_ID1
...
typedef struct rt_hpt_s {
    rt_timeval_t    record_tv[RT_UTIL_TIME_RECORD_MAX];
    int32           write_ptr;
    uint32          sec;
} rt_hpt_t;
...
int rt_util_hpt_record(const char *func_name, int line);
