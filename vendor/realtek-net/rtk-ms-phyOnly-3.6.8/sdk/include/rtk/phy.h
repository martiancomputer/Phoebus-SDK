...
typedef enum rtk_phy_ctrl_e {
    ...
    RTK_PHY_CTRL_SERDES_RX_RESET,                /* Reset SerDes RX, W */
    RTK_PHY_CTRL_SERDES_TX_RESET,                /* Reset SerDes TX, W */
    RTK_PHY_CTRL_FORCE_PBO,                      /* force TX power back-off, RW */
    RTK_PHY_CTRL_AN_ARBITRATION,                 /* Auto-nego arbitration enable(1)/disable(0), turn it on for some AN XNP compatibility issue, RW */
...
/* value for RTK_PHY_CTRL_FORCE_PBO */
#define RTK_PHY_CTRL_FORCE_PBO_OFF   0xFFFF  /* auto mode */
#define RTK_PHY_CTRL_FORCE_PBO_0     0x0
#define RTK_PHY_CTRL_FORCE_PBO_1     0x1
#define RTK_PHY_CTRL_FORCE_PBO_2     0x2
#define RTK_PHY_CTRL_FORCE_PBO_3     0x3
#define RTK_PHY_CTRL_FORCE_PBO_4     0x4
#define RTK_PHY_CTRL_FORCE_PBO_5     0x5
#define RTK_PHY_CTRL_FORCE_PBO_6     0x6
#define RTK_PHY_CTRL_FORCE_PBO_7     0x7
 ...
 */
extern int32
rtk_time_portPtpBcastOper_set(uint32 unit, rtk_portmask_t portmask,
 ...
 */
extern int32
rtk_phy_debug_patch_check(uint32 unit, rtk_port_t port);
