 ...
 */
extern int32
dal_longan_pie_templateFieldLocation_get(uint32 unit, rtk_pie_templateFieldType_t field_type, uint32 *field_location);
...
extern int32
dal_longan_pie_physical_index_to_logic(uint32 unit, uint32 phyIdx, rtk_pie_phase_t *phase, uint32 *logicIdx);
