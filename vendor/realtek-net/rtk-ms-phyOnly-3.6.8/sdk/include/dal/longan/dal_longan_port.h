...
/* Function Name:
 *      _dal_longan_port_macForceSpeed_set
 * Description:
 *      configure mac force speed
 * Input:
 *      unit   - unit id
 *      port   - port ID
 *      speed  - port speed
 ...
 */
extern int32
_dal_longan_port_macForceSpeed_set(uint32 unit, rtk_port_t port, rtk_port_speed_t speed);

/* Function Name:
 *      _dal_longan_port_macForceMedia_set
 * Description:
 *      configure mac force media
 * Input:
 *      unit   - unit id
 *      port   - port ID
 * Output:
 ...
 */
extern int32
_dal_longan_port_macForceMedia_set(uint32 unit, rtk_port_t port);
 ...
 */
extern int32
dal_longan_port_miscCtrl_get(uint32 unit, rtk_port_t port, rtk_portMiscCtrl_t ctrl_type, uint32 *pValue);
 ...
 */
extern int32
dal_longan_port_miscCtrl_set(uint32 unit, rtk_port_t port, rtk_portMiscCtrl_t ctrl_type, uint32 value);
